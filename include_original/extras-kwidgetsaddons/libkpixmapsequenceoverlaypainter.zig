...
pub const kpixmapsequenceoverlaypainter = struct {
    ...
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32, i32, ?*anyopaque) callconv(.c) i32) void {
        qtc.KPixmapSequenceOverlayPainter_OnMetacall(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, obj: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    ...
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KPixmapSequenceOverlayPainter_OnEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, event: QtC.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KPixmapSequenceOverlayPainter_OnTimerEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, event: QtC.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KPixmapSequenceOverlayPainter_OnChildEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, event: QtC.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KPixmapSequenceOverlayPainter_OnCustomEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, signal: QtC.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KPixmapSequenceOverlayPainter_OnConnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KPixmapSequenceOverlayPainter_OnDisconnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn () callconv(.c) QtC.QObject ```
    pub fn OnSender(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QObject) void {
        qtc.KPixmapSequenceOverlayPainter_OnSender(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, callback: *const fn () callconv(.c) i32) void {
        qtc.KPixmapSequenceOverlayPainter_OnSenderSignalIndex(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, signal: [*:0]const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.KPixmapSequenceOverlayPainter_OnReceivers(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, signal: QtC.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KPixmapSequenceOverlayPainter_OnIsSignalConnected(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    ///
    /// ``` self: QtC.KPixmapSequenceOverlayPainter, callback: *const fn (self: QtC.KPixmapSequenceOverlayPainter, objectName: [*:0]const u8) callconv(.c) void ```
