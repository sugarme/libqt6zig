...
pub const ktwofingerswipe = struct {
    ...
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, event: QtC.QTimerEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, event: QtC.QChildEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, event: QtC.QEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, signal: QtC.QMetaMethod) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn () callconv(.c) QtC.QObject ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn () callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, signal: QtC.QMetaMethod) callconv(.c) bool ```
    ...
    ///
    /// ``` self: QtC.KTwoFingerSwipe, callback: *const fn (self: QtC.KTwoFingerSwipe, objectName: [*:0]const u8) callconv(.c) void ```
...
pub const ktwofingerswiperecognizer = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KTwoFingerSwipeRecognizer, callback: *const fn (self: QtC.KTwoFingerSwipeRecognizer, target: QtC.QObject) callconv(.c) QtC.QGesture ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KTwoFingerSwipeRecognizer, callback: *const fn (self: QtC.KTwoFingerSwipeRecognizer, gesture: QtC.QGesture, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KTwoFingerSwipeRecognizer, callback: *const fn (self: QtC.KTwoFingerSwipeRecognizer, state: QtC.QGesture) callconv(.c) void ```
