...
pub const kactionmenu = struct {
    ...
    /// ``` self: QtC.KActionMenu, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KActionMenu_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KActionMenu, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KActionMenu_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32, i32, ?*anyopaque) callconv(.c) i32) void {
        qtc.KActionMenu_OnMetacall(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KActionMenu_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KActionMenu_Tr(s_Cstring);
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, parent: QtC.QWidget) callconv(.c) QtC.QWidget ```
    pub fn OnCreateWidget(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) QtC.QWidget) void {
        qtc.KActionMenu_OnCreateWidget(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseCreateWidget(self: ?*anyopaque, parent: ?*anyopaque) QtC.QWidget {
        return qtc.KActionMenu_QBaseCreateWidget(@ptrCast(self), @ptrCast(parent));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KActionMenu_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KActionMenu_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.KActionMenu, w: QtC.QWidget ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, widget: QtC.QWidget ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, group: QtC.QActionGroup ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, icon: QtC.QIcon ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, text: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, tip: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, statusTip: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, what: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, priority: qaction_enums.Priority ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, shortcut: QtC.QKeySequence ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, shortcuts: []QtC.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#setShortcuts)
    ///
    /// ``` self: QtC.KActionMenu, shortcuts: qkeysequence_enums.StandardKey ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, context: qnamespace_enums.ShortcutContext ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, autoRepeat: bool ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, font: QtC.QFont ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, checkable: bool ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, varVal: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, event: qaction_enums.ActionEvent ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, menuRole: qaction_enums.MenuRole ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, visible: bool ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, show: bool ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, checked: bool ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, enabled: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#changed)
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#enabledChanged)
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, enabled: bool) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#checkableChanged)
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, checkable: bool) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, param1: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#toggled)
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, param1: bool) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#showStatusText)
    ///
    /// ``` self: QtC.KActionMenu, object: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#triggered)
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, checked: bool) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, interval: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KActionMenu, id: qnamespace_enums.TimerId ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KActionMenu, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, name: []const u8, value: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KActionMenu, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KActionMenu, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KActionMenu, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KActionMenu, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KActionMenu, param1: QtC.QEvent ```
    ...
    pub fn QBaseEvent(self: ?*anyopaque, param1: ?*anyopaque) bool {
        return qtc.KActionMenu_QBaseEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, param1: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KActionMenu_OnEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, param1: QtC.QObject, param2: QtC.QEvent ```
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, param1: ?*anyopaque, param2: ?*anyopaque) bool {
        return qtc.KActionMenu_QBaseEventFilter(@ptrCast(self), @ptrCast(param1), @ptrCast(param2));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, param1: QtC.QObject, param2: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KActionMenu_OnEventFilter(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseDeleteWidget(self: ?*anyopaque, widget: ?*anyopaque) void {
        qtc.KActionMenu_QBaseDeleteWidget(@ptrCast(self), @ptrCast(widget));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, widget: QtC.QWidget) callconv(.c) void ```
    pub fn OnDeleteWidget(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KActionMenu_OnDeleteWidget(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, event: QtC.QTimerEvent ```
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KActionMenu_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, event: QtC.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KActionMenu_OnTimerEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, event: QtC.QChildEvent ```
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KActionMenu_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, event: QtC.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KActionMenu_OnChildEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, event: QtC.QEvent ```
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KActionMenu_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, event: QtC.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KActionMenu_OnCustomEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, signal: QtC.QMetaMethod ```
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KActionMenu_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, signal: QtC.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KActionMenu_OnConnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KActionMenu_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KActionMenu_OnDisconnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseCreatedWidgets(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QWidget {
        const _arr: qtc.libqt_list = qtc.KActionMenu_QBaseCreatedWidgets(@ptrCast(self));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QWidget, _arr.len) catch @panic("kactionmenu.CreatedWidgets: Memory allocation failed");
        const _data: [*]QtC.QWidget = @ptrCast(@alignCast(_arr.data));
        @memcpy(_ret, _data[0.._arr.len]);
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn () callconv(.c) [*:null]QtC.QWidget ```
    pub fn OnCreatedWidgets(self: ?*anyopaque, callback: *const fn () callconv(.c) [*:null]QtC.QWidget) void {
        qtc.KActionMenu_OnCreatedWidgets(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.KActionMenu_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn () callconv(.c) QtC.QObject ```
    pub fn OnSender(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QObject) void {
        qtc.KActionMenu_OnSender(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KActionMenu_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, callback: *const fn () callconv(.c) i32) void {
        qtc.KActionMenu_OnSenderSignalIndex(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, signal: []const u8 ```
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KActionMenu_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, signal: [*:0]const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.KActionMenu_OnReceivers(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KActionMenu_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, signal: QtC.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KActionMenu_OnIsSignalConnected(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    ///
    /// ``` self: QtC.KActionMenu, callback: *const fn (self: QtC.KActionMenu, objectName: [*:0]const u8) callconv(.c) void ```
