...
pub const qpieseries = struct {
    ...
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn () callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, event: QtC.QTimerEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, event: QtC.QChildEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, event: QtC.QEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, signal: QtC.QMetaMethod) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn () callconv(.c) QtC.QObject ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, signal: QtC.QMetaMethod) callconv(.c) bool ```
    ...
    ///
    /// ``` self: QtC.QPieSeries, callback: *const fn (self: QtC.QPieSeries, objectName: [*:0]const u8) callconv(.c) void ```
