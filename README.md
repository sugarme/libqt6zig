...
```bash
sudo pacman -S qt6-base qt6-charts qt6-multimedia qt6-svg qt6-webchannel qt6-webengine kcodecs kcolorscheme kcompletion kconfig kconfigwidgets kcoreaddons kcrash kguiaddons ki18n kitemviews kwidgetsaddons qscintilla-qt6 qtermwidget kplotting sonnet zig
```
