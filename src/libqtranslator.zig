...
pub const qtranslator = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QTranslator, slot: fn (self: QtC.QTranslator) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QTranslator, slot: fn (self: QtC.QTranslator, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTranslator, slot: fn (self: QtC.QTranslator, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QTranslator, slot: fn (self: QtC.QTranslator, objectName: [*:0]const u8) callconv(.c) void ```
