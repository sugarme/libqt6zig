...
pub const qtabbar = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QTabBar, slot: fn (self: QtC.QTabBar, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QTabBar, slot: fn (self: QtC.QTabBar, iconText: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QTabBar, slot: fn (self: QtC.QTabBar, objectName: []const u8) callconv(.c) void ```
