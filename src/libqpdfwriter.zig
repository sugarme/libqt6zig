...
pub const qpdfwriter = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPdfWriter, slot: fn (self: QtC.QPdfWriter, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QPdfWriter, slot: fn (self: QtC.QPdfWriter, objectName: [*:0]const u8) callconv(.c) void ```
