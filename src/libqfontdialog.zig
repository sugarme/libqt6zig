...
pub const qfontdialog = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QFontDialog, slot: fn (self: QtC.QFontDialog, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QFontDialog, slot: fn (self: QtC.QFontDialog, iconText: []const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFontDialog, slot: fn (self: QtC.QFontDialog, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QFontDialog, slot: fn (self: QtC.QFontDialog, objectName: []const u8) callconv(.c) void ```
