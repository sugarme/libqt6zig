...
pub const qsystemtrayicon = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QSystemTrayIcon, slot: fn (self: QtC.QSystemTrayIcon, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QSystemTrayIcon, slot: fn (self: QtC.QSystemTrayIcon, objectName: []const u8) callconv(.c) void ```
