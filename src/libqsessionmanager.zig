...
pub const qsessionmanager = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QSessionManager_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QSessionManager, slot: fn (self: QtC.QSessionManager) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QSessionManager, slot: fn (self: QtC.QSessionManager, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QSessionManager, slot: fn (self: QtC.QSessionManager, objectName: []const u8) callconv(.c) void ```
