...
pub const qtablewidget = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QTableWidget, slot: fn (self: QtC.QTableWidget, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QTableWidget, slot: fn (self: QtC.QTableWidget, iconText: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QTableWidget, slot: fn (self: QtC.QTableWidget, objectName: []const u8) callconv(.c) void ```
