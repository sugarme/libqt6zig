...
pub const qthreadpool = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QThreadPool, slot: fn (self: QtC.QThreadPool, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QThreadPool, slot: fn (self: QtC.QThreadPool, objectName: [*:0]const u8) callconv(.c) void ```
