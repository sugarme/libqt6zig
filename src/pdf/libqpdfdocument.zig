...
pub const qpdfdocument = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QPdfDocument, slot: fn (self: QtC.QPdfDocument, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPdfDocument, slot: fn (self: QtC.QPdfDocument, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QPdfDocument, slot: fn (self: QtC.QPdfDocument, objectName: [*:0]const u8) callconv(.c) void ```
