...
pub const qpdfsearchmodel = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QPdfSearchModel, callback: *const fn () callconv(.c) map_i32_u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPdfSearchModel, callback: *const fn (self: QtC.QPdfSearchModel, index: QtC.QModelIndex) callconv(.c) map_i32_qtcqvariant ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPdfSearchModel, callback: *const fn (self: QtC.QPdfSearchModel, index: QtC.QModelIndex, roles: map_i32_qtcqvariant) callconv(.c) bool ```
