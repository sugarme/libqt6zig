...
pub const qpdfsearchmodel = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractitemmodel.html#dataChanged)
    ///
    /// ``` self: QtC.QPdfSearchModel, slot: fn (self: QtC.QPdfSearchModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPdfSearchModel, slot: fn () callconv(.c) [*][*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPdfSearchModel, slot: fn () callconv(.c) [*:null]QtC.QModelIndex ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPdfSearchModel, slot: fn (self: QtC.QPdfSearchModel, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QPdfSearchModel, slot: fn (self: QtC.QPdfSearchModel, objectName: [*:0]const u8) callconv(.c) void ```
