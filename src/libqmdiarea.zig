...
pub const qmdiarea = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QMdiArea, slot: fn (self: QtC.QMdiArea, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QMdiArea, slot: fn (self: QtC.QMdiArea, iconText: []const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QMdiArea, slot: fn (self: QtC.QMdiArea, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QMdiArea, slot: fn (self: QtC.QMdiArea, objectName: []const u8) callconv(.c) void ```
