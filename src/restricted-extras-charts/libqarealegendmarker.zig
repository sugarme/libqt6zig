...
pub const qarealegendmarker = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAreaLegendMarker, slot: fn (self: QtC.QAreaLegendMarker, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QAreaLegendMarker, slot: fn (self: QtC.QAreaLegendMarker, objectName: [*:0]const u8) callconv(.c) void ```
