...
pub const qchartview = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QChartView, slot: fn (self: QtC.QChartView, title: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QChartView, slot: fn (self: QtC.QChartView, iconText: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QChartView, slot: fn (self: QtC.QChartView, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QChartView, slot: fn (self: QtC.QChartView, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QChartView, slot: fn (self: QtC.QChartView, objectName: [*:0]const u8) callconv(.c) void ```
