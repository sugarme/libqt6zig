...
pub const qhbarmodelmapper = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QHBarModelMapper, slot: fn () callconv(.c) i64 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QHBarModelMapper, slot: fn (self: QtC.QHBarModelMapper, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QHBarModelMapper, slot: fn (self: QtC.QHBarModelMapper, objectName: []const u8) callconv(.c) void ```
