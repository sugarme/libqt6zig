...
pub const qcandlesticklegendmarker = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qlegendmarker.html#clicked)
    ///
    /// ``` self: QtC.QCandlestickLegendMarker, slot: fn (self: QtC.QCandlestickLegendMarker) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qlegendmarker.html#hovered)
    ///
    /// ``` self: QtC.QCandlestickLegendMarker, slot: fn (self: QtC.QCandlestickLegendMarker, status: bool) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QCandlestickLegendMarker, slot: fn (self: QtC.QCandlestickLegendMarker, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QCandlestickLegendMarker, slot: fn (self: QtC.QCandlestickLegendMarker, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QCandlestickLegendMarker, slot: fn (self: QtC.QCandlestickLegendMarker, objectName: [*:0]const u8) callconv(.c) void ```
