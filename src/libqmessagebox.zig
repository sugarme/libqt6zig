...
pub const qmessagebox = struct {
    ...
    pub fn AddButtonWithButton(self: ?*anyopaque, button: i64) QtC.QPushButton {
        return qtc.QMessageBox_AddButtonWithButton(@ptrCast(self), @intCast(button));
    }
    ...
    pub fn SetDefaultButtonWithButton(self: ?*anyopaque, button: i64) void {
        qtc.QMessageBox_SetDefaultButtonWithButton(@ptrCast(self), @intCast(button));
    }
    ...
    pub fn SetEscapeButtonWithButton(self: ?*anyopaque, button: i64) void {
        qtc.QMessageBox_SetEscapeButtonWithButton(@ptrCast(self), @intCast(button));
    }
    ...
    ///
    /// ``` self: QtC.QMessageBox, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
