...
pub const qmessagebox = struct {
    ...
    ///
    /// ``` parent: ?*C.QWidget ```
    pub fn New(parent: ?*anyopaque) ?*C.QMessageBox {
        return C.QMessageBox_new(@ptrCast(parent));
    }

    /// New2 constructs a new QMessageBox object.
    ///
    ///
    pub fn New2() ?*C.QMessageBox {
        return C.QMessageBox_new2();
    }

    /// New3 constructs a new QMessageBox object.
    ///
    /// ``` icon: qmessagebox_enums.Icon, title: []const u8, text: []const u8 ```
    pub fn New3(icon: i64, title: []const u8, text: []const u8) ?*C.QMessageBox {
        ...
        return C.QMessageBox_new3(@intCast(icon), title_str, text_str);
    }
    ...
    pub fn New4(title: []const u8, text: []const u8, icon: i64, button0: i32, button1: i32, button2: i32) ?*C.QMessageBox {
        const title_str = C.struct_libqt_string{
            .len = title.len,
            .data = @constCast(title.ptr),
        };
        ...
        return C.QMessageBox_new4(title_str, text_str, @intCast(icon), @intCast(button0), @intCast(button1), @intCast(button2));
    }

    /// New5 constructs a new QMessageBox object.
    ///
    /// ``` icon: qmessagebox_enums.Icon, title: []const u8, text: []const u8, buttons: i32 ```
    pub fn New5(icon: i64, title: []const u8, text: []const u8, buttons: i64) ?*C.QMessageBox {
        const title_str = C.struct_libqt_string{
            .len = title.len,
            .data = @constCast(title.ptr),
        };
        ...
        return C.QMessageBox_new5(@intCast(icon), title_str, text_str, @intCast(buttons));
    }

    /// New6 constructs a new QMessageBox object.
    ///
    /// ``` icon: qmessagebox_enums.Icon, title: []const u8, text: []const u8, buttons: i32, parent: ?*C.QWidget ```
    pub fn New6(icon: i64, title: []const u8, text: []const u8, buttons: i64, parent: ?*anyopaque) ?*C.QMessageBox {
        const title_str = C.struct_libqt_string{
            .len = title.len,
            .data = @constCast(title.ptr),
        };
        ...
        return C.QMessageBox_new6(@intCast(icon), title_str, text_str, @intCast(buttons), @ptrCast(parent));
    }

    /// New7 constructs a new QMessageBox object.
    ///
    /// ``` icon: qmessagebox_enums.Icon, title: []const u8, text: []const u8, buttons: i32, parent: ?*C.QWidget, flags: i32 ```
    pub fn New7(icon: i64, title: []const u8, text: []const u8, buttons: i64, parent: ?*anyopaque, flags: i64) ?*C.QMessageBox {
        const title_str = C.struct_libqt_string{
            .len = title.len,
            .data = @constCast(title.ptr),
        };
        ...
        return C.QMessageBox_new7(@intCast(icon), title_str, text_str, @intCast(buttons), @ptrCast(parent), @intCast(flags));
    }

    /// New8 constructs a new QMessageBox object.
    ///
    /// ``` title: []const u8, text: []const u8, icon: qmessagebox_enums.Icon, button0: i32, button1: i32, button2: i32, parent: ?*C.QWidget ```
    pub fn New8(title: []const u8, text: []const u8, icon: i64, button0: i32, button1: i32, button2: i32, parent: ?*anyopaque) ?*C.QMessageBox {
        const title_str = C.struct_libqt_string{
            .len = title.len,
            .data = @constCast(title.ptr),
        };
        ...
        return C.QMessageBox_new8(title_str, text_str, @intCast(icon), @intCast(button0), @intCast(button1), @intCast(button2), @ptrCast(parent));
    }

    /// New9 constructs a new QMessageBox object.
    ///
    /// ``` title: []const u8, text: []const u8, icon: qmessagebox_enums.Icon, button0: i32, button1: i32, button2: i32, parent: ?*C.QWidget, f: i32 ```
    pub fn New9(title: []const u8, text: []const u8, icon: i64, button0: i32, button1: i32, button2: i32, parent: ?*anyopaque, f: i64) ?*C.QMessageBox {
        const title_str = C.struct_libqt_string{
            .len = title.len,
            .data = @constCast(title.ptr),
        };
        ...
        return C.QMessageBox_new9(title_str, text_str, @intCast(icon), @intCast(button0), @intCast(button1), @intCast(button2), @ptrCast(parent), @intCast(f));
    }
    ...
    pub fn MetaObject(self: ?*anyopaque) ?*C.QMetaObject {
        return C.QMessageBox_MetaObject(@ptrCast(self));
    }

    /// ``` self: ?*C.QMessageBox, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = @constCast(param1.ptr);
        return C.QMessageBox_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: ?*C.QMessageBox, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QMessageBox_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, qobjectdefs_enums.Call, i32, ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, slot: fn (?*anyopaque, i64, i32, ?*anyopaque) callconv(.c) i32) void {
        C.QMessageBox_OnMetacall(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QMessageBox_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QMessageBox_Tr(s_Cstring);
    ...
    ///
    /// ``` self: ?*C.QMessageBox, button: ?*C.QAbstractButton, role: qmessagebox_enums.ButtonRole ```
    pub fn AddButton(self: ?*anyopaque, button: ?*anyopaque, role: i64) void {
        C.QMessageBox_AddButton(@ptrCast(self), @ptrCast(button), @intCast(role));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#addButton)
    ///
    /// ``` self: ?*C.QMessageBox, text: []const u8, role: qmessagebox_enums.ButtonRole ```
    pub fn AddButton2(self: ?*anyopaque, text: []const u8, role: i64) ?*C.QPushButton {
        const text_str = C.struct_libqt_string{
            .len = text.len,
            .data = @constCast(text.ptr),
        };
        return C.QMessageBox_AddButton2(@ptrCast(self), text_str, @intCast(role));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#addButton)
    ///
    /// ``` self: ?*C.QMessageBox, button: qmessagebox_enums.StandardButton ```
    pub fn AddButtonWithButton(self: ?*anyopaque, button: i64) ?*C.QPushButton {
        return C.QMessageBox_AddButtonWithButton(@ptrCast(self), @intCast(button));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#removeButton)
    ///
    /// ``` self: ?*C.QMessageBox, button: ?*C.QAbstractButton ```
    pub fn RemoveButton(self: ?*anyopaque, button: ?*anyopaque) void {
        C.QMessageBox_RemoveButton(@ptrCast(self), @ptrCast(button));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#buttons)
    ///
    /// ``` self: ?*C.QMessageBox, allocator: std.mem.Allocator ```
    pub fn Buttons(self: ?*anyopaque, allocator: std.mem.Allocator) []?*C.QAbstractButton {
        const _arr: C.struct_libqt_list = C.QMessageBox_Buttons(@ptrCast(self));
        defer C.libqt_free(_arr.data);
        const _ret = allocator.alloc(?*C.QAbstractButton, _arr.len) catch @panic("Memory allocation failed");
        const _data: [*]?*C.QAbstractButton = @ptrCast(@alignCast(_arr.data));
        for (0.._arr.len) |_i| {
            _ret[_i] = _data[_i];
        }
        return _ret;
    ...
    pub fn ButtonRole(self: ?*anyopaque, button: ?*anyopaque) i64 {
        return C.QMessageBox_ButtonRole(@ptrCast(self), @ptrCast(button));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setStandardButtons)
    ///
    /// ``` self: ?*C.QMessageBox, buttons: i32 ```
    pub fn SetStandardButtons(self: ?*anyopaque, buttons: i64) void {
        C.QMessageBox_SetStandardButtons(@ptrCast(self), @intCast(buttons));
    }
    ...
    pub fn StandardButtons(self: ?*anyopaque) i64 {
        return C.QMessageBox_StandardButtons(@ptrCast(self));
    }
    ...
    pub fn StandardButton(self: ?*anyopaque, button: ?*anyopaque) i64 {
        return C.QMessageBox_StandardButton(@ptrCast(self), @ptrCast(button));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#button)
    ///
    /// ``` self: ?*C.QMessageBox, which: qmessagebox_enums.StandardButton ```
    pub fn Button(self: ?*anyopaque, which: i64) ?*C.QAbstractButton {
        return C.QMessageBox_Button(@ptrCast(self), @intCast(which));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#defaultButton)
    ///
    /// ``` self: ?*C.QMessageBox ```
    pub fn DefaultButton(self: ?*anyopaque) ?*C.QPushButton {
        return C.QMessageBox_DefaultButton(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setDefaultButton)
    ///
    /// ``` self: ?*C.QMessageBox, button: ?*C.QPushButton ```
    pub fn SetDefaultButton(self: ?*anyopaque, button: ?*anyopaque) void {
        C.QMessageBox_SetDefaultButton(@ptrCast(self), @ptrCast(button));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setDefaultButton)
    ///
    /// ``` self: ?*C.QMessageBox, button: qmessagebox_enums.StandardButton ```
    pub fn SetDefaultButtonWithButton(self: ?*anyopaque, button: i64) void {
        C.QMessageBox_SetDefaultButtonWithButton(@ptrCast(self), @intCast(button));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#escapeButton)
    ///
    /// ``` self: ?*C.QMessageBox ```
    pub fn EscapeButton(self: ?*anyopaque) ?*C.QAbstractButton {
        return C.QMessageBox_EscapeButton(@ptrCast(self));
    }
    ...
    pub fn SetEscapeButton(self: ?*anyopaque, button: ?*anyopaque) void {
        C.QMessageBox_SetEscapeButton(@ptrCast(self), @ptrCast(button));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setEscapeButton)
    ///
    /// ``` self: ?*C.QMessageBox, button: qmessagebox_enums.StandardButton ```
    pub fn SetEscapeButtonWithButton(self: ?*anyopaque, button: i64) void {
        C.QMessageBox_SetEscapeButtonWithButton(@ptrCast(self), @intCast(button));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#clickedButton)
    ///
    /// ``` self: ?*C.QMessageBox ```
    pub fn ClickedButton(self: ?*anyopaque) ?*C.QAbstractButton {
        return C.QMessageBox_ClickedButton(@ptrCast(self));
    }
    ...
    pub fn Text(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = C.QMessageBox_Text(@ptrCast(self));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QMessageBox, text: []const u8 ```
    pub fn SetText(self: ?*anyopaque, text: []const u8) void {
        const text_str = C.struct_libqt_string{
            .len = text.len,
            .data = @constCast(text.ptr),
        };
        C.QMessageBox_SetText(@ptrCast(self), text_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#icon)
    ///
    /// ``` self: ?*C.QMessageBox ```
    pub fn Icon(self: ?*anyopaque) i64 {
        return C.QMessageBox_Icon(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setIcon)
    ///
    /// ``` self: ?*C.QMessageBox, icon: qmessagebox_enums.Icon ```
    pub fn SetIcon(self: ?*anyopaque, icon: i64) void {
        C.QMessageBox_SetIcon(@ptrCast(self), @intCast(icon));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#iconPixmap)
    ///
    /// ``` self: ?*C.QMessageBox ```
    pub fn IconPixmap(self: ?*anyopaque) ?*C.QPixmap {
        return C.QMessageBox_IconPixmap(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setIconPixmap)
    ///
    /// ``` self: ?*C.QMessageBox, pixmap: ?*C.QPixmap ```
    pub fn SetIconPixmap(self: ?*anyopaque, pixmap: ?*anyopaque) void {
        C.QMessageBox_SetIconPixmap(@ptrCast(self), @ptrCast(pixmap));
    }
    ...
    pub fn TextFormat(self: ?*anyopaque) i64 {
        return C.QMessageBox_TextFormat(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setTextFormat)
    ///
    /// ``` self: ?*C.QMessageBox, format: qnamespace_enums.TextFormat ```
    pub fn SetTextFormat(self: ?*anyopaque, format: i64) void {
        C.QMessageBox_SetTextFormat(@ptrCast(self), @intCast(format));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setTextInteractionFlags)
    ///
    /// ``` self: ?*C.QMessageBox, flags: i32 ```
    pub fn SetTextInteractionFlags(self: ?*anyopaque, flags: i64) void {
        C.QMessageBox_SetTextInteractionFlags(@ptrCast(self), @intCast(flags));
    }
    ...
    pub fn TextInteractionFlags(self: ?*anyopaque) i64 {
        return C.QMessageBox_TextInteractionFlags(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#setCheckBox)
    ///
    /// ``` self: ?*C.QMessageBox, cb: ?*C.QCheckBox ```
    pub fn SetCheckBox(self: ?*anyopaque, cb: ?*anyopaque) void {
        C.QMessageBox_SetCheckBox(@ptrCast(self), @ptrCast(cb));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#checkBox)
    ///
    /// ``` self: ?*C.QMessageBox ```
    pub fn CheckBox(self: ?*anyopaque) ?*C.QCheckBox {
        return C.QMessageBox_CheckBox(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8 ```
    pub fn Information(parent: ?*anyopaque, title: []const u8, text: []const u8) i64 {
        ...
        return C.QMessageBox_Information(@ptrCast(parent), title_str, text_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0: qmessagebox_enums.StandardButton ```
    pub fn Information2(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i64) i64 {
        ...
        return C.QMessageBox_Information2(@ptrCast(parent), title_str, text_str, @intCast(button0));
    }
    ...
    pub fn Question(parent: ?*anyopaque, title: []const u8, text: []const u8) i64 {
        ...
        return C.QMessageBox_Question(@ptrCast(parent), title_str, text_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#question)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0: qmessagebox_enums.StandardButton, button1: qmessagebox_enums.StandardButton ```
    pub fn Question2(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i64, button1: i64) i32 {
        ...
        return C.QMessageBox_Question2(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1));
    }
    ...
    pub fn Warning(parent: ?*anyopaque, title: []const u8, text: []const u8) i64 {
        ...
        return C.QMessageBox_Warning(@ptrCast(parent), title_str, text_str);
    }
    ...
    pub fn Warning2(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i64, button1: i64) i32 {
        ...
        return C.QMessageBox_Warning2(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1));
    }
    ...
    pub fn Critical(parent: ?*anyopaque, title: []const u8, text: []const u8) i64 {
        ...
        return C.QMessageBox_Critical(@ptrCast(parent), title_str, text_str);
    }
    ...
    pub fn Critical2(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i64, button1: i64) i32 {
        ...
        return C.QMessageBox_Critical2(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1));
    }
    ...
    pub fn About(parent: ?*anyopaque, title: []const u8, text: []const u8) void {
        ...
        C.QMessageBox_About(@ptrCast(parent), title_str, text_str);
    }
    ...
    pub fn AboutQt(parent: ?*anyopaque) void {
        C.QMessageBox_AboutQt(@ptrCast(parent));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0: i32 ```
    pub fn Information3(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32) i32 {
        ...
        return C.QMessageBox_Information3(@ptrCast(parent), title_str, text_str, @intCast(button0));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0Text: []const u8 ```
    pub fn Information4(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8) i32 {
        ...
        const button0Text_str = C.struct_libqt_string{
            .len = button0Text.len,
            .data = @constCast(button0Text.ptr),
        };
        return C.QMessageBox_Information4(@ptrCast(parent), title_str, text_str, button0Text_str);
    }
    ...
    pub fn Question3(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32) i32 {
        ...
        return C.QMessageBox_Question3(@ptrCast(parent), title_str, text_str, @intCast(button0));
    }
    ...
    pub fn Question4(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8) i32 {
        ...
        return C.QMessageBox_Question4(@ptrCast(parent), title_str, text_str, button0Text_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#warning)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0: i32, button1: i32 ```
    pub fn Warning3(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32, button1: i32) i32 {
        ...
        return C.QMessageBox_Warning3(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1));
    }
    ...
    pub fn Warning4(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8) i32 {
        ...
        return C.QMessageBox_Warning4(@ptrCast(parent), title_str, text_str, button0Text_str);
    }
    ...
    pub fn Critical3(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32, button1: i32) i32 {
        ...
        return C.QMessageBox_Critical3(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1));
    }
    ...
    pub fn Critical4(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8) i32 {
        ...
        return C.QMessageBox_Critical4(@ptrCast(parent), title_str, text_str, button0Text_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#buttonText)
    ///
    /// ``` self: ?*C.QMessageBox, button: i32, allocator: std.mem.Allocator ```
    pub fn ButtonText(self: ?*anyopaque, button: i32, allocator: std.mem.Allocator) []const u8 {
        const _str = C.QMessageBox_ButtonText(@ptrCast(self), @intCast(button));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QMessageBox, button: i32, text: []const u8 ```
    pub fn SetButtonText(self: ?*anyopaque, button: i32, text: []const u8) void {
        const text_str = C.struct_libqt_string{
            .len = text.len,
            .data = @constCast(text.ptr),
        };
        C.QMessageBox_SetButtonText(@ptrCast(self), @intCast(button), text_str);
    }
    ...
    pub fn InformativeText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = C.QMessageBox_InformativeText(@ptrCast(self));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn SetInformativeText(self: ?*anyopaque, text: []const u8) void {
        ...
        C.QMessageBox_SetInformativeText(@ptrCast(self), text_str);
    }
    ...
    pub fn DetailedText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = C.QMessageBox_DetailedText(@ptrCast(self));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn ButtonClicked(self: ?*anyopaque, button: ?*anyopaque) void {
        C.QMessageBox_ButtonClicked(@ptrCast(self), @ptrCast(button));
    }

    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QAbstractButton) callconv(.c) void ```
    pub fn OnButtonClicked(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_Connect_ButtonClicked(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#event)
    ///
    /// ``` self: ?*C.QMessageBox, e: ?*C.QEvent ```
    pub fn Event(self: ?*anyopaque, e: ?*anyopaque) bool {
        return C.QMessageBox_Event(@ptrCast(self), @ptrCast(e));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QMessageBox_OnEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, e: ?*anyopaque) bool {
        return C.QMessageBox_QBaseEvent(@ptrCast(self), @ptrCast(e));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#resizeEvent)
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QResizeEvent ```
    pub fn ResizeEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_ResizeEvent(@ptrCast(self), @ptrCast(event));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QResizeEvent) callconv(.c) void ```
    pub fn OnResizeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnResizeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseResizeEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseResizeEvent(@ptrCast(self), @ptrCast(event));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#showEvent)
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QShowEvent ```
    pub fn ShowEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_ShowEvent(@ptrCast(self), @ptrCast(event));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QShowEvent) callconv(.c) void ```
    pub fn OnShowEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnShowEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseShowEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseShowEvent(@ptrCast(self), @ptrCast(event));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#closeEvent)
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QCloseEvent ```
    pub fn CloseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_CloseEvent(@ptrCast(self), @ptrCast(event));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QCloseEvent) callconv(.c) void ```
    pub fn OnCloseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnCloseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseCloseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseCloseEvent(@ptrCast(self), @ptrCast(event));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#keyPressEvent)
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QKeyEvent ```
    pub fn KeyPressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_KeyPressEvent(@ptrCast(self), @ptrCast(event));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QKeyEvent) callconv(.c) void ```
    pub fn OnKeyPressEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnKeyPressEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseKeyPressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseKeyPressEvent(@ptrCast(self), @ptrCast(event));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#changeEvent)
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QEvent ```
    pub fn ChangeEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_ChangeEvent(@ptrCast(self), @ptrCast(event));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QEvent) callconv(.c) void ```
    pub fn OnChangeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnChangeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseChangeEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseChangeEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QMessageBox_Tr2(s_Cstring, c_Cstring);
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = @constCast(s.ptr);
        const c_Cstring = @constCast(c.ptr);
        const _str = C.QMessageBox_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, buttons: i32 ```
    pub fn Information42(parent: ?*anyopaque, title: []const u8, text: []const u8, buttons: i64) i64 {
        ...
        return C.QMessageBox_Information42(@ptrCast(parent), title_str, text_str, @intCast(buttons));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, buttons: i32, defaultButton: qmessagebox_enums.StandardButton ```
    pub fn Information5(parent: ?*anyopaque, title: []const u8, text: []const u8, buttons: i64, defaultButton: i64) i64 {
        ...
        return C.QMessageBox_Information5(@ptrCast(parent), title_str, text_str, @intCast(buttons), @intCast(defaultButton));
    }
    ...
    pub fn Information52(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i64, button1: i64) i64 {
        ...
        return C.QMessageBox_Information52(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1));
    }
    ...
    pub fn Question42(parent: ?*anyopaque, title: []const u8, text: []const u8, buttons: i64) i64 {
        ...
        return C.QMessageBox_Question42(@ptrCast(parent), title_str, text_str, @intCast(buttons));
    }
    ...
    pub fn Question5(parent: ?*anyopaque, title: []const u8, text: []const u8, buttons: i64, defaultButton: i64) i64 {
        ...
        return C.QMessageBox_Question5(@ptrCast(parent), title_str, text_str, @intCast(buttons), @intCast(defaultButton));
    }
    ...
    pub fn Warning42(parent: ?*anyopaque, title: []const u8, text: []const u8, buttons: i64) i64 {
        ...
        return C.QMessageBox_Warning42(@ptrCast(parent), title_str, text_str, @intCast(buttons));
    }
    ...
    pub fn Warning5(parent: ?*anyopaque, title: []const u8, text: []const u8, buttons: i64, defaultButton: i64) i64 {
        ...
        return C.QMessageBox_Warning5(@ptrCast(parent), title_str, text_str, @intCast(buttons), @intCast(defaultButton));
    }
    ...
    pub fn Critical42(parent: ?*anyopaque, title: []const u8, text: []const u8, buttons: i64) i64 {
        ...
        return C.QMessageBox_Critical42(@ptrCast(parent), title_str, text_str, @intCast(buttons));
    }
    ...
    pub fn Critical5(parent: ?*anyopaque, title: []const u8, text: []const u8, buttons: i64, defaultButton: i64) i64 {
        ...
        return C.QMessageBox_Critical5(@ptrCast(parent), title_str, text_str, @intCast(buttons), @intCast(defaultButton));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#aboutQt)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8 ```
    pub fn AboutQt2(parent: ?*anyopaque, title: []const u8) void {
        const title_str = C.struct_libqt_string{
            .len = title.len,
            .data = @constCast(title.ptr),
        };
        C.QMessageBox_AboutQt2(@ptrCast(parent), title_str);
    }
    ...
    pub fn Information53(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32, button1: i32) i32 {
        ...
        return C.QMessageBox_Information53(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0: i32, button1: i32, button2: i32 ```
    pub fn Information6(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32, button1: i32, button2: i32) i32 {
        ...
        return C.QMessageBox_Information6(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1), @intCast(button2));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8 ```
    pub fn Information54(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8) i32 {
        ...
        const button1Text_str = C.struct_libqt_string{
            .len = button1Text.len,
            .data = @constCast(button1Text.ptr),
        };
        return C.QMessageBox_Information54(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8 ```
    pub fn Information62(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8) i32 {
        ...
        const button2Text_str = C.struct_libqt_string{
            .len = button2Text.len,
            .data = @constCast(button2Text.ptr),
        };
        return C.QMessageBox_Information62(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32 ```
    pub fn Information7(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32) i32 {
        ...
        return C.QMessageBox_Information7(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str, @intCast(defaultButtonNumber));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qmessagebox.html#information)
    ///
    /// ``` parent: ?*C.QWidget, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32, escapeButtonNumber: i32 ```
    pub fn Information8(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32, escapeButtonNumber: i32) i32 {
        ...
        return C.QMessageBox_Information8(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str, @intCast(defaultButtonNumber), @intCast(escapeButtonNumber));
    }
    ...
    pub fn Question52(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32, button1: i32) i32 {
        ...
        return C.QMessageBox_Question52(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1));
    }
    ...
    pub fn Question6(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32, button1: i32, button2: i32) i32 {
        ...
        return C.QMessageBox_Question6(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1), @intCast(button2));
    }
    ...
    pub fn Question53(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8) i32 {
        ...
        return C.QMessageBox_Question53(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str);
    }
    ...
    pub fn Question62(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8) i32 {
        ...
        return C.QMessageBox_Question62(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str);
    }
    ...
    pub fn Question7(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32) i32 {
        ...
        return C.QMessageBox_Question7(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str, @intCast(defaultButtonNumber));
    }
    ...
    pub fn Question8(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32, escapeButtonNumber: i32) i32 {
        ...
        return C.QMessageBox_Question8(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str, @intCast(defaultButtonNumber), @intCast(escapeButtonNumber));
    }
    ...
    pub fn Warning6(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32, button1: i32, button2: i32) i32 {
        ...
        return C.QMessageBox_Warning6(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1), @intCast(button2));
    }
    ...
    pub fn Warning52(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8) i32 {
        ...
        return C.QMessageBox_Warning52(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str);
    }
    ...
    pub fn Warning62(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8) i32 {
        ...
        return C.QMessageBox_Warning62(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str);
    }
    ...
    pub fn Warning7(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32) i32 {
        ...
        return C.QMessageBox_Warning7(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str, @intCast(defaultButtonNumber));
    }
    ...
    pub fn Warning8(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32, escapeButtonNumber: i32) i32 {
        ...
        return C.QMessageBox_Warning8(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str, @intCast(defaultButtonNumber), @intCast(escapeButtonNumber));
    }
    ...
    pub fn Critical6(parent: ?*anyopaque, title: []const u8, text: []const u8, button0: i32, button1: i32, button2: i32) i32 {
        ...
        return C.QMessageBox_Critical6(@ptrCast(parent), title_str, text_str, @intCast(button0), @intCast(button1), @intCast(button2));
    }
    ...
    pub fn Critical52(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8) i32 {
        ...
        return C.QMessageBox_Critical52(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str);
    }
    ...
    pub fn Critical62(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8) i32 {
        ...
        return C.QMessageBox_Critical62(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str);
    }
    ...
    pub fn Critical7(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32) i32 {
        ...
        return C.QMessageBox_Critical7(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str, @intCast(defaultButtonNumber));
    }
    ...
    pub fn Critical8(parent: ?*anyopaque, title: []const u8, text: []const u8, button0Text: []const u8, button1Text: []const u8, button2Text: []const u8, defaultButtonNumber: i32, escapeButtonNumber: i32) i32 {
        ...
        return C.QMessageBox_Critical8(@ptrCast(parent), title_str, text_str, button0Text_str, button1Text_str, button2Text_str, @intCast(defaultButtonNumber), @intCast(escapeButtonNumber));
    }
    ...
    ///
    /// ``` self: ?*C.QMessageBox, sizeGripEnabled: bool ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, style: ?*C.QStyle ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, enabled: bool ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, disabled: bool ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, windowModified: bool ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, minimumSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMinimumSize)
    ///
    /// ``` self: ?*C.QMessageBox, minw: i32, minh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, maximumSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMaximumSize)
    ///
    /// ``` self: ?*C.QMessageBox, maxw: i32, maxh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, sizeIncrement: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setSizeIncrement)
    ///
    /// ``` self: ?*C.QMessageBox, w: i32, h: i32 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, baseSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setBaseSize)
    ///
    /// ``` self: ?*C.QMessageBox, basew: i32, baseh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, fixedSize: ?*C.QSize ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QPointF ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#mapToGlobal)
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QPoint ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QWidget, param2: ?*C.QPointF ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#mapTo)
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QWidget, param2: ?*C.QPoint ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, palette: ?*C.QPalette ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, backgroundRole: qpalette_enums.ColorRole ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, foregroundRole: qpalette_enums.ColorRole ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, font: ?*C.QFont ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, cursor: ?*C.QCursor ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, enable: bool ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, mask: ?*C.QBitmap ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMask)
    ///
    /// ``` self: ?*C.QMessageBox, mask: ?*C.QRegion ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, target: ?*C.QPaintDevice ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QMessageBox, painter: ?*C.QPainter ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, effect: ?*C.QGraphicsEffect ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, typeVal: qnamespace_enums.GestureType ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, styleSheet: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, icon: ?*C.QIcon ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, windowIconText: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, windowRole: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, filePath: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, toolTip: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, statusTip: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, whatsThis: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, name: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, description: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, direction: qnamespace_enums.LayoutDirection ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, locale: ?*C.QLocale ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setFocus)
    ///
    /// ``` self: ?*C.QMessageBox, reason: qnamespace_enums.FocusReason ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, policy: qnamespace_enums.FocusPolicy ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, focusProxy: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, policy: qnamespace_enums.ContextMenuPolicy ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabMouse)
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QCursor ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, key: ?*C.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QMessageBox, x: i32, y: i32, w: i32, h: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QRect ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QRegion ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, hidden: bool ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, x: i32, y: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#resize)
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setGeometry)
    ///
    /// ``` self: ?*C.QMessageBox, geometry: ?*C.QRect ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, geometry: []u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, sizePolicy: ?*C.QSizePolicy ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setSizePolicy)
    ///
    /// ``` self: ?*C.QMessageBox, horizontal: qsizepolicy_enums.Policy, vertical: qsizepolicy_enums.Policy ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, left: i32, top: i32, right: i32, bottom: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setContentsMargins)
    ///
    /// ``` self: ?*C.QMessageBox, margins: ?*C.QMargins ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, layout: ?*C.QLayout ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, parent: ?*C.QWidget ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setParent)
    ///
    /// ``` self: ?*C.QMessageBox, parent: ?*C.QWidget, f: i32 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, dx: i32, dy: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#scroll)
    ///
    /// ``` self: ?*C.QMessageBox, dx: i32, dy: i32, param3: ?*C.QRect ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, action: ?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, actions: []?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, before: ?*C.QAction, actions: []?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, before: ?*C.QAction, action: ?*C.QAction ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QMessageBox, icon: ?*C.QIcon, text: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QMessageBox, text: []const u8, shortcut: ?*C.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QMessageBox, icon: ?*C.QIcon, text: []const u8, shortcut: ?*C.QKeySequence ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, typeVal: i32 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, param1: qnamespace_enums.WindowType ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, param1: qnamespace_enums.WidgetAttribute ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, child: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, screen: ?*C.QScreen ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, iconText: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, pos: ?*C.QPoint ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QMessageBox, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QMessageBox, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QMessageBox, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QMessageBox, painter: ?*C.QPainter, targetOffset: ?*C.QPoint ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QMessageBox, painter: ?*C.QPainter, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QMessageBox, painter: ?*C.QPainter, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grab)
    ///
    /// ``` self: ?*C.QMessageBox, rectangle: ?*C.QRect ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabGesture)
    ///
    /// ``` self: ?*C.QMessageBox, typeVal: qnamespace_enums.GestureType, flags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabShortcut)
    ///
    /// ``` self: ?*C.QMessageBox, key: ?*C.QKeySequence, context: qnamespace_enums.ShortcutContext ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setShortcutEnabled)
    ///
    /// ``` self: ?*C.QMessageBox, id: i32, enable: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setWindowFlag)
    ///
    /// ``` self: ?*C.QMessageBox, param1: qnamespace_enums.WindowType, on: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setAttribute)
    ///
    /// ``` self: ?*C.QMessageBox, param1: qnamespace_enums.WidgetAttribute, on: bool ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, thread: ?*C.QThread ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, interval: i32 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, filterObj: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, obj: ?*C.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QMessageBox, sender: ?*C.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, name: []const u8, value: ?*C.QVariant ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: ?*C.QMessageBox, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QMessageBox, sender: ?*C.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QMessageBox, visible: bool ```
    pub fn SetVisible(self: ?*anyopaque, visible: bool) void {
        C.QMessageBox_SetVisible(@ptrCast(self), visible);
    }
    ...
    pub fn QBaseSetVisible(self: ?*anyopaque, visible: bool) void {
        C.QMessageBox_QBaseSetVisible(@ptrCast(self), visible);
    }
    ...
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, bool) callconv(.c) void ```
    pub fn OnSetVisible(self: ?*anyopaque, slot: fn (?*anyopaque, bool) callconv(.c) void) void {
        C.QMessageBox_OnSetVisible(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QMessageBox_SizeHint(@ptrCast(self));
    }
    ...
    pub fn QBaseSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QMessageBox_QBaseSizeHint(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn () callconv(.c) ?*C.QSize ```
    pub fn OnSizeHint(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QSize) void {
        C.QMessageBox_OnSizeHint(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MinimumSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QMessageBox_MinimumSizeHint(@ptrCast(self));
    }
    ...
    pub fn QBaseMinimumSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QMessageBox_QBaseMinimumSizeHint(@ptrCast(self));
    }
    ...
    pub fn OnMinimumSizeHint(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QSize) void {
        C.QMessageBox_OnMinimumSizeHint(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Open(self: ?*anyopaque) void {
        C.QMessageBox_Open(@ptrCast(self));
    }
    ...
    pub fn QBaseOpen(self: ?*anyopaque) void {
        C.QMessageBox_QBaseOpen(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn () callconv(.c) void ```
    pub fn OnOpen(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QMessageBox_OnOpen(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Exec(self: ?*anyopaque) i32 {
        return C.QMessageBox_Exec(@ptrCast(self));
    }
    ...
    pub fn QBaseExec(self: ?*anyopaque) i32 {
        return C.QMessageBox_QBaseExec(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn () callconv(.c) i32 ```
    pub fn OnExec(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QMessageBox_OnExec(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, param1: i32 ```
    pub fn Done(self: ?*anyopaque, param1: i32) void {
        C.QMessageBox_Done(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseDone(self: ?*anyopaque, param1: i32) void {
        C.QMessageBox_QBaseDone(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, i32) callconv(.c) void ```
    pub fn OnDone(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) void) void {
        C.QMessageBox_OnDone(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Accept(self: ?*anyopaque) void {
        C.QMessageBox_Accept(@ptrCast(self));
    }
    ...
    pub fn QBaseAccept(self: ?*anyopaque) void {
        C.QMessageBox_QBaseAccept(@ptrCast(self));
    }
    ...
    pub fn OnAccept(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QMessageBox_OnAccept(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Reject(self: ?*anyopaque) void {
        C.QMessageBox_Reject(@ptrCast(self));
    }
    ...
    pub fn QBaseReject(self: ?*anyopaque) void {
        C.QMessageBox_QBaseReject(@ptrCast(self));
    }
    ...
    pub fn OnReject(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QMessageBox_OnReject(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QContextMenuEvent ```
    pub fn ContextMenuEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QMessageBox_ContextMenuEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseContextMenuEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QMessageBox_QBaseContextMenuEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QContextMenuEvent) callconv(.c) void ```
    pub fn OnContextMenuEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnContextMenuEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QObject, param2: ?*C.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, param1: ?*anyopaque, param2: ?*anyopaque) bool {
        return C.QMessageBox_EventFilter(@ptrCast(self), @ptrCast(param1), @ptrCast(param2));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, param1: ?*anyopaque, param2: ?*anyopaque) bool {
        return C.QMessageBox_QBaseEventFilter(@ptrCast(self), @ptrCast(param1), @ptrCast(param2));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QObject, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QMessageBox_OnEventFilter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DevType(self: ?*anyopaque) i32 {
        return C.QMessageBox_DevType(@ptrCast(self));
    }
    ...
    pub fn QBaseDevType(self: ?*anyopaque) i32 {
        return C.QMessageBox_QBaseDevType(@ptrCast(self));
    }
    ...
    pub fn OnDevType(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QMessageBox_OnDevType(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn HeightForWidth(self: ?*anyopaque, param1: i32) i32 {
        return C.QMessageBox_HeightForWidth(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseHeightForWidth(self: ?*anyopaque, param1: i32) i32 {
        return C.QMessageBox_QBaseHeightForWidth(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, i32) callconv(.c) i32 ```
    pub fn OnHeightForWidth(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) i32) void {
        C.QMessageBox_OnHeightForWidth(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn HasHeightForWidth(self: ?*anyopaque) bool {
        return C.QMessageBox_HasHeightForWidth(@ptrCast(self));
    }
    ...
    pub fn QBaseHasHeightForWidth(self: ?*anyopaque) bool {
        return C.QMessageBox_QBaseHasHeightForWidth(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn () callconv(.c) bool ```
    pub fn OnHasHeightForWidth(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QMessageBox_OnHasHeightForWidth(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn PaintEngine(self: ?*anyopaque) ?*C.QPaintEngine {
        return C.QMessageBox_PaintEngine(@ptrCast(self));
    }
    ...
    pub fn QBasePaintEngine(self: ?*anyopaque) ?*C.QPaintEngine {
        return C.QMessageBox_QBasePaintEngine(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn () callconv(.c) ?*C.QPaintEngine ```
    pub fn OnPaintEngine(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QPaintEngine) void {
        C.QMessageBox_OnPaintEngine(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QMouseEvent ```
    pub fn MousePressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_MousePressEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMousePressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseMousePressEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QMouseEvent) callconv(.c) void ```
    pub fn OnMousePressEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnMousePressEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_MouseReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseMouseReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseReleaseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnMouseReleaseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseDoubleClickEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_MouseDoubleClickEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseDoubleClickEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseMouseDoubleClickEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseDoubleClickEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnMouseDoubleClickEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_MouseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseMouseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnMouseMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QWheelEvent ```
    pub fn WheelEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_WheelEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseWheelEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseWheelEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QWheelEvent) callconv(.c) void ```
    pub fn OnWheelEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnWheelEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn KeyReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_KeyReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseKeyReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseKeyReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnKeyReleaseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnKeyReleaseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QFocusEvent ```
    pub fn FocusInEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_FocusInEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseFocusInEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseFocusInEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QFocusEvent) callconv(.c) void ```
    pub fn OnFocusInEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnFocusInEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusOutEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_FocusOutEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseFocusOutEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseFocusOutEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnFocusOutEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnFocusOutEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QEnterEvent ```
    pub fn EnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_EnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QEnterEvent) callconv(.c) void ```
    pub fn OnEnterEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnEnterEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn LeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_LeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnLeaveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnLeaveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QPaintEvent ```
    pub fn PaintEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_PaintEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBasePaintEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBasePaintEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QPaintEvent) callconv(.c) void ```
    pub fn OnPaintEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnPaintEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QMoveEvent ```
    pub fn MoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_MoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QMoveEvent) callconv(.c) void ```
    pub fn OnMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QTabletEvent ```
    pub fn TabletEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_TabletEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTabletEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseTabletEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QTabletEvent) callconv(.c) void ```
    pub fn OnTabletEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnTabletEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QActionEvent ```
    pub fn ActionEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_ActionEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseActionEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseActionEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QActionEvent) callconv(.c) void ```
    pub fn OnActionEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnActionEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QDragEnterEvent ```
    pub fn DragEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_DragEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseDragEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QDragEnterEvent) callconv(.c) void ```
    pub fn OnDragEnterEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnDragEnterEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QDragMoveEvent ```
    pub fn DragMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_DragMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseDragMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QDragMoveEvent) callconv(.c) void ```
    pub fn OnDragMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnDragMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QDragLeaveEvent ```
    pub fn DragLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_DragLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseDragLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QDragLeaveEvent) callconv(.c) void ```
    pub fn OnDragLeaveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnDragLeaveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QDropEvent ```
    pub fn DropEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_DropEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDropEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseDropEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QDropEvent) callconv(.c) void ```
    pub fn OnDropEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnDropEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QHideEvent ```
    pub fn HideEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_HideEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseHideEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseHideEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QHideEvent) callconv(.c) void ```
    pub fn OnHideEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnHideEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, eventType: []u8, message: ?*anyopaque, result: ?*isize ```
    pub fn NativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return C.QMessageBox_NativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return C.QMessageBox_QBaseNativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, []u8, ?*anyopaque, ?*isize) callconv(.c) bool ```
    pub fn OnNativeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, []u8, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QMessageBox_OnNativeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, param1: qpaintdevice_enums.PaintDeviceMetric ```
    pub fn Metric(self: ?*anyopaque, param1: i64) i32 {
        return C.QMessageBox_Metric(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseMetric(self: ?*anyopaque, param1: i64) i32 {
        return C.QMessageBox_QBaseMetric(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, qpaintdevice_enums.PaintDeviceMetric) callconv(.c) i32 ```
    pub fn OnMetric(self: ?*anyopaque, slot: fn (?*anyopaque, i64) callconv(.c) i32) void {
        C.QMessageBox_OnMetric(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn InitPainter(self: ?*anyopaque, painter: ?*anyopaque) void {
        C.QMessageBox_InitPainter(@ptrCast(self), @ptrCast(painter));
    }
    ...
    pub fn QBaseInitPainter(self: ?*anyopaque, painter: ?*anyopaque) void {
        C.QMessageBox_QBaseInitPainter(@ptrCast(self), @ptrCast(painter));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QPainter) callconv(.c) void ```
    pub fn OnInitPainter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnInitPainter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, offset: ?*C.QPoint ```
    pub fn Redirected(self: ?*anyopaque, offset: ?*anyopaque) ?*C.QPaintDevice {
        return C.QMessageBox_Redirected(@ptrCast(self), @ptrCast(offset));
    }
    ...
    pub fn QBaseRedirected(self: ?*anyopaque, offset: ?*anyopaque) ?*C.QPaintDevice {
        return C.QMessageBox_QBaseRedirected(@ptrCast(self), @ptrCast(offset));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QPoint) callconv(.c) ?*C.QPaintDevice ```
    pub fn OnRedirected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) ?*C.QPaintDevice) void {
        C.QMessageBox_OnRedirected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SharedPainter(self: ?*anyopaque) ?*C.QPainter {
        return C.QMessageBox_SharedPainter(@ptrCast(self));
    }
    ...
    pub fn QBaseSharedPainter(self: ?*anyopaque) ?*C.QPainter {
        return C.QMessageBox_QBaseSharedPainter(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn () callconv(.c) ?*C.QPainter ```
    pub fn OnSharedPainter(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QPainter) void {
        C.QMessageBox_OnSharedPainter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, param1: ?*C.QInputMethodEvent ```
    pub fn InputMethodEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QMessageBox_InputMethodEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseInputMethodEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QMessageBox_QBaseInputMethodEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QInputMethodEvent) callconv(.c) void ```
    pub fn OnInputMethodEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnInputMethodEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, param1: qnamespace_enums.InputMethodQuery ```
    pub fn InputMethodQuery(self: ?*anyopaque, param1: i64) ?*C.QVariant {
        return C.QMessageBox_InputMethodQuery(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseInputMethodQuery(self: ?*anyopaque, param1: i64) ?*C.QVariant {
        return C.QMessageBox_QBaseInputMethodQuery(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, qnamespace_enums.InputMethodQuery) callconv(.c) ?*C.QVariant ```
    pub fn OnInputMethodQuery(self: ?*anyopaque, slot: fn (?*anyopaque, i64) callconv(.c) ?*C.QVariant) void {
        C.QMessageBox_OnInputMethodQuery(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, next: bool ```
    pub fn FocusNextPrevChild(self: ?*anyopaque, next: bool) bool {
        return C.QMessageBox_FocusNextPrevChild(@ptrCast(self), next);
    }
    ...
    pub fn QBaseFocusNextPrevChild(self: ?*anyopaque, next: bool) bool {
        return C.QMessageBox_QBaseFocusNextPrevChild(@ptrCast(self), next);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, bool) callconv(.c) bool ```
    pub fn OnFocusNextPrevChild(self: ?*anyopaque, slot: fn (?*anyopaque, bool) callconv(.c) bool) void {
        C.QMessageBox_OnFocusNextPrevChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QTimerEvent ```
    pub fn TimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_TimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnTimerEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, event: ?*C.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnChildEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QMessageBox_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnCustomEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnCustomEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, signal: ?*C.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QMessageBox_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QMessageBox_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnConnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QMessageBox_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QMessageBox_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnDisconnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn AdjustPosition(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QMessageBox_AdjustPosition(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseAdjustPosition(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QMessageBox_QBaseAdjustPosition(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QWidget) callconv(.c) void ```
    pub fn OnAdjustPosition(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QMessageBox_OnAdjustPosition(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn UpdateMicroFocus(self: ?*anyopaque) void {
        C.QMessageBox_UpdateMicroFocus(@ptrCast(self));
    }
    ...
    pub fn QBaseUpdateMicroFocus(self: ?*anyopaque) void {
        C.QMessageBox_QBaseUpdateMicroFocus(@ptrCast(self));
    }
    ...
    pub fn OnUpdateMicroFocus(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QMessageBox_OnUpdateMicroFocus(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Create(self: ?*anyopaque) void {
        C.QMessageBox_Create(@ptrCast(self));
    }
    ...
    pub fn QBaseCreate(self: ?*anyopaque) void {
        C.QMessageBox_QBaseCreate(@ptrCast(self));
    }
    ...
    pub fn OnCreate(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QMessageBox_OnCreate(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Destroy(self: ?*anyopaque) void {
        C.QMessageBox_Destroy(@ptrCast(self));
    }
    ...
    pub fn QBaseDestroy(self: ?*anyopaque) void {
        C.QMessageBox_QBaseDestroy(@ptrCast(self));
    }
    ...
    pub fn OnDestroy(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QMessageBox_OnDestroy(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusNextChild(self: ?*anyopaque) bool {
        return C.QMessageBox_FocusNextChild(@ptrCast(self));
    }
    ...
    pub fn QBaseFocusNextChild(self: ?*anyopaque) bool {
        return C.QMessageBox_QBaseFocusNextChild(@ptrCast(self));
    }
    ...
    pub fn OnFocusNextChild(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QMessageBox_OnFocusNextChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusPreviousChild(self: ?*anyopaque) bool {
        return C.QMessageBox_FocusPreviousChild(@ptrCast(self));
    }
    ...
    pub fn QBaseFocusPreviousChild(self: ?*anyopaque) bool {
        return C.QMessageBox_QBaseFocusPreviousChild(@ptrCast(self));
    }
    ...
    pub fn OnFocusPreviousChild(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QMessageBox_OnFocusPreviousChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Sender(self: ?*anyopaque) ?*C.QObject {
        return C.QMessageBox_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) ?*C.QObject {
        return C.QMessageBox_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn () callconv(.c) ?*C.QObject ```
    pub fn OnSender(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QObject) void {
        C.QMessageBox_OnSender(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QMessageBox_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QMessageBox_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn OnSenderSignalIndex(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QMessageBox_OnSenderSignalIndex(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QMessageBox_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QMessageBox_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, []const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, slot: fn (?*anyopaque, []const u8) callconv(.c) i32) void {
        C.QMessageBox_OnReceivers(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QMessageBox_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QMessageBox_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QMessageBox, slot: fn (?*C.QMessageBox, ?*C.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QMessageBox_OnIsSignalConnected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        C.QMessageBox_Delete(@ptrCast(self));
    }
};
