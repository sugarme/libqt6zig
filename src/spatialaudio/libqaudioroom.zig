...
pub const qaudioroom = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QAudioRoom, slot: fn (self: QtC.QAudioRoom, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAudioRoom, slot: fn (self: QtC.QAudioRoom, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QAudioRoom, slot: fn (self: QtC.QAudioRoom, objectName: [*:0]const u8) callconv(.c) void ```
