...
pub const qlistview = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QListView, slot: fn (self: QtC.QListView, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QListView, slot: fn () callconv(.c) [*:null]QtC.QModelIndex ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QListView, slot: fn (self: QtC.QListView, title: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QListView, slot: fn (self: QtC.QListView, iconText: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QListView, slot: fn (self: QtC.QListView, search: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QListView, slot: fn (self: QtC.QListView, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QListView, slot: fn (self: QtC.QListView, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QListView, slot: fn (self: QtC.QListView, objectName: [*:0]const u8) callconv(.c) void ```
