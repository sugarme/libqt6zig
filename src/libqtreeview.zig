...
pub const qtreeview = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, iconText: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, objectName: []const u8) callconv(.c) void ```
