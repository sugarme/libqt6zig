...
pub const qwebenginecontextmenurequest = struct {
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest ```
    pub fn MetaObject(self: ?*anyopaque) ?*C.QMetaObject {
        return C.QWebEngineContextMenuRequest_MetaObject(@ptrCast(self));
    }

    /// ``` self: ?*C.QWebEngineContextMenuRequest, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = @constCast(param1.ptr);
        return C.QWebEngineContextMenuRequest_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: ?*C.QWebEngineContextMenuRequest, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QWebEngineContextMenuRequest_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QWebEngineContextMenuRequest_Tr(s_Cstring);
    ...
    pub fn Position(self: ?*anyopaque) ?*C.QPoint {
        return C.QWebEngineContextMenuRequest_Position(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qwebenginecontextmenurequest.html#selectedText)
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, allocator: std.mem.Allocator ```
    pub fn SelectedText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = C.QWebEngineContextMenuRequest_SelectedText(@ptrCast(self));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn LinkText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = C.QWebEngineContextMenuRequest_LinkText(@ptrCast(self));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest ```
    pub fn LinkUrl(self: ?*anyopaque) ?*C.QUrl {
        return C.QWebEngineContextMenuRequest_LinkUrl(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qwebenginecontextmenurequest.html#mediaUrl)
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest ```
    pub fn MediaUrl(self: ?*anyopaque) ?*C.QUrl {
        return C.QWebEngineContextMenuRequest_MediaUrl(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qwebenginecontextmenurequest.html#mediaType)
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest ```
    pub fn MediaType(self: ?*anyopaque) i64 {
        return C.QWebEngineContextMenuRequest_MediaType(@ptrCast(self));
    }
    ...
    pub fn IsContentEditable(self: ?*anyopaque) bool {
        return C.QWebEngineContextMenuRequest_IsContentEditable(@ptrCast(self));
    }
    ...
    pub fn MisspelledWord(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = C.QWebEngineContextMenuRequest_MisspelledWord(@ptrCast(self));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn SpellCheckerSuggestions(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        const _arr: C.struct_libqt_list = C.QWebEngineContextMenuRequest_SpellCheckerSuggestions(@ptrCast(self));
    ...
    pub fn IsAccepted(self: ?*anyopaque) bool {
        return C.QWebEngineContextMenuRequest_IsAccepted(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qwebenginecontextmenurequest.html#setAccepted)
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, accepted: bool ```
    pub fn SetAccepted(self: ?*anyopaque, accepted: bool) void {
        C.QWebEngineContextMenuRequest_SetAccepted(@ptrCast(self), accepted);
    }
    ...
    pub fn MediaFlags(self: ?*anyopaque) i64 {
        return C.QWebEngineContextMenuRequest_MediaFlags(@ptrCast(self));
    }
    ...
    pub fn EditFlags(self: ?*anyopaque) i64 {
        return C.QWebEngineContextMenuRequest_EditFlags(@ptrCast(self));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QWebEngineContextMenuRequest_Tr2(s_Cstring, c_Cstring);
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = @constCast(s.ptr);
        const c_Cstring = @constCast(c.ptr);
        const _str = C.QWebEngineContextMenuRequest_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, event: ?*C.QEvent ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, watched: ?*C.QObject, event: ?*C.QEvent ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, name: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, b: bool ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, thread: ?*C.QThread ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, interval: i32 ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, id: i32 ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, parent: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, filterObj: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, obj: ?*C.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, sender: ?*C.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, name: []const u8, value: ?*C.QVariant ```
    ...
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, sender: ?*C.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: ?*C.QWebEngineContextMenuRequest, param1: ?*C.QObject ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        C.QWebEngineContextMenuRequest_Delete(@ptrCast(self));
    }
};
