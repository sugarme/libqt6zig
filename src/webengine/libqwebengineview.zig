...
pub const qwebengineview = struct {
    ...
    pub fn OnCreateWindow(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QWebEngineView) void {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineView, slot: fn (self: QtC.QWebEngineView, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool ```
