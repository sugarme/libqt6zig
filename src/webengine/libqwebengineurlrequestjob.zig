...
pub const qwebengineurlrequestjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QWebEngineUrlRequestJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineUrlRequestJob, slot: fn (self: QtC.QWebEngineUrlRequestJob) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineUrlRequestJob, slot: fn (self: QtC.QWebEngineUrlRequestJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QWebEngineUrlRequestJob, slot: fn (self: QtC.QWebEngineUrlRequestJob, objectName: [*:0]const u8) callconv(.c) void ```
