...
pub const qwebengineurlrequestinterceptor = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineUrlRequestInterceptor, slot: fn (self: QtC.QWebEngineUrlRequestInterceptor) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineUrlRequestInterceptor, slot: fn (self: QtC.QWebEngineUrlRequestInterceptor, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineUrlRequestInterceptor, slot: fn (self: QtC.QWebEngineUrlRequestInterceptor, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QWebEngineUrlRequestInterceptor, slot: fn (self: QtC.QWebEngineUrlRequestInterceptor, objectName: [*:0]const u8) callconv(.c) void ```
