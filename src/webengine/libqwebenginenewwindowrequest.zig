...
pub const qwebenginenewwindowrequest = struct {
    ...
    /// ``` self: QtC.QWebEngineNewWindowRequest, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QWebEngineNewWindowRequest_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.QWebEngineNewWindowRequest, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QWebEngineNewWindowRequest_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.QWebEngineNewWindowRequest_Tr(s_Cstring);
    ...
    /// ``` self: QtC.QWebEngineNewWindowRequest ```
    ///
    /// Returns: ``` qwebenginenewwindowrequest_enums.DestinationType ```
    pub fn Destination(self: ?*anyopaque) i64 {
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, param1: QtC.QWebEnginePage ```
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.QWebEngineNewWindowRequest_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.QWebEngineNewWindowRequest_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, b: bool ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, id: qnamespace_enums.TimerId ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, name: []const u8, value: QtC.QVariant ```
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("qwebenginenewwindowrequest.DynamicPropertyNames: Memory allocation failed");
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, slot: fn (self: QtC.QWebEngineNewWindowRequest) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, slot: fn (self: QtC.QWebEngineNewWindowRequest, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, slot: fn (self: QtC.QWebEngineNewWindowRequest, objectName: []const u8) callconv(.c) void ```
