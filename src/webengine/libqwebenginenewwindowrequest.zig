...
pub const qwebenginenewwindowrequest = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, callback: *const fn (self: QtC.QWebEngineNewWindowRequest) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, callback: *const fn (self: QtC.QWebEngineNewWindowRequest, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNewWindowRequest, callback: *const fn (self: QtC.QWebEngineNewWindowRequest, objectName: [*:0]const u8) callconv(.c) void ```
