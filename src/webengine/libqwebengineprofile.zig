...
pub const qwebengineprofile = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineProfile, slot: fn (self: QtC.QWebEngineProfile, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, slot: fn (self: QtC.QWebEngineProfile, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QWebEngineProfile, slot: fn (self: QtC.QWebEngineProfile, objectName: [*:0]const u8) callconv(.c) void ```
