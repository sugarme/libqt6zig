...
pub const qaccessiblebridgeplugin = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QAccessibleBridgePlugin, slot: fn (self: QtC.QAccessibleBridgePlugin) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QAccessibleBridgePlugin, slot: fn (self: QtC.QAccessibleBridgePlugin, param1: QtC.QObject) callconv(.c) void ```
