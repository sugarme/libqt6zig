...
pub const kio__previewjob = struct {
    ...
    ///
    /// ``` self: QtC.KIO__PreviewJob, job: QtC.KJob, title: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__PreviewJob, job: QtC.KJob, title: []const u8, field1: struct_constu8_constu8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__PreviewJob, job: QtC.KJob, title: []const u8, field1: struct_constu8_constu8, field2: struct_constu8_constu8 ```
