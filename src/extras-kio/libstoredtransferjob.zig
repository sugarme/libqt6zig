...
pub const kio__storedtransferjob = struct {
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob, title: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8, field2: struct_constu8_constu8) callconv(.c) void ```
