...
pub const kio__statjob = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KIO__StatJob_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KIO__StatJob, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KIO__StatJob_Metacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__StatJob_Tr(s_Cstring);
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, side: statjob_enums.StatSide ```
    pub fn SetSide(self: ?*anyopaque, side: i32) void {
        qtc.KIO__StatJob_SetSide(@ptrCast(self), @intCast(side));
    }
    ...
    ///
    /// ``` self: QtC.KIO__StatJob ```
    pub fn StatResult(self: ?*anyopaque) QtC.KIO__UDSEntry {
        return qtc.KIO__StatJob_StatResult(@ptrCast(self));
    }
    ...
    pub fn MostLocalUrl(self: ?*anyopaque) QtC.QUrl {
        return qtc.KIO__StatJob_MostLocalUrl(@ptrCast(self));
    }

    /// [Qt documentation](https://api.kde.org/kio-statjob.html#redirection)
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KIO__Job, url: QtC.QUrl ```
    pub fn Redirection(self: ?*anyopaque, job: ?*anyopaque, url: ?*anyopaque) void {
        qtc.KIO__StatJob_Redirection(@ptrCast(self), @ptrCast(job), @ptrCast(url));
    }

    /// [Qt documentation](https://api.kde.org/kio-statjob.html#redirection)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KIO__Job, url: QtC.QUrl) callconv(.c) void ```
    pub fn OnRedirection(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__StatJob_Connect_Redirection(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }

    /// [Qt documentation](https://api.kde.org/kio-statjob.html#permanentRedirection)
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl ```
    pub fn PermanentRedirection(self: ?*anyopaque, job: ?*anyopaque, fromUrl: ?*anyopaque, toUrl: ?*anyopaque) void {
        qtc.KIO__StatJob_PermanentRedirection(@ptrCast(self), @ptrCast(job), @ptrCast(fromUrl), @ptrCast(toUrl));
    }

    /// [Qt documentation](https://api.kde.org/kio-statjob.html#permanentRedirection)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl) callconv(.c) void ```
    pub fn OnPermanentRedirection(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__StatJob_Connect_PermanentRedirection(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__StatJob_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KIO__StatJob_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, handle: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, param1: i32, param2: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, extension: QtC.KIO__JobUiDelegateExtension ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, parentJob: QtC.KIO__Job ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, metaData: QtC.KIO__MetaData ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, key: []const u8, value: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#addMetaData)
    ///
    /// ``` self: QtC.KIO__StatJob, values: map_constu8_constu8, allocator: std.mem.Allocator ```
    pub fn AddMetaData2(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        ...
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::statjob.AddMetaData2: Memory allocation failed");
    ...
    pub fn MergeMetaData(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        ...
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::statjob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_values);
        var i: usize = 0;
        var values_it = values.iterator();
        while (values_it.next()) |entry| {
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, key: []const u8, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KIO__Job ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#connected)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KIO__Job) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__StatJob, reqUrl: QtC.QUrl, allocator: std.mem.Allocator ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__StatJob, reqUrl: QtC.QUrl, method: i32, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, delegate: QtC.KJobUiDelegate ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, unit: kjob_enums.Unit ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, autodelete: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KJob, title: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, title: [*:0]const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KJob, message: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#infoMessage)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KJob, size: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#totalSize)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, size: u64) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KJob, speed: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#speed)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#kill)
    ///
    /// ``` self: QtC.KIO__StatJob, verbosity: kjob_enums.KillVerbosity ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#setFinishedNotificationHidden)
    ///
    /// ``` self: QtC.KIO__StatJob, hide: bool ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KJob, title: []const u8, field1: struct_constu8_constu8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__StatJob, job: QtC.KJob, title: []const u8, field1: struct_constu8_constu8, field2: struct_constu8_constu8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8, field2: struct_constu8_constu8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, interval: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KIO__StatJob, id: qnamespace_enums.TimerId ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__StatJob, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, name: []const u8, value: QtC.QVariant ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KIO__StatJob, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KIO__StatJob, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__StatJob, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__StatJob, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, percent: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__StatJob, callback: *const fn (self: QtC.KIO__StatJob, objectName: [*:0]const u8) callconv(.c) void ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.KIO__StatJob_Delete(@ptrCast(self));
    }
};
