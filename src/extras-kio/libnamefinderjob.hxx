#pragma once
#ifndef SRC_EXTRAS_KIOC_LIBVIRTUALNAMEFINDERJOB_H
#define SRC_EXTRAS_KIOC_LIBVIRTUALNAMEFINDERJOB_H
...
class VirtualKIONameFinderJob final : public KIO::NameFinderJob {
  ...
  public:
    ...
    using KIO__NameFinderJob_SlotInfoMessage_Callback = void (*)(KIO__NameFinderJob*, KJob*, libqt_string);
    ...
    using KIO__NameFinderJob_Subjobs_Callback = KJob** (*)();
    ...
    using KIO__NameFinderJob_SetErrorText_Callback = void (*)(KIO__NameFinderJob*, libqt_string);
  ...
  public:
    ...
    const QList<KJob*>& subjobs() const {
        if (kio__namefinderjob_subjobs_isbase) {
            ...
            KJob** callback_ret = kio__namefinderjob_subjobs_callback();
    ...
    friend bool KIO__NameFinderJob_QBaseAddSubjob(KIO::NameFinderJob* self, KJob* job);
    friend bool KIO__NameFinderJob_RemoveSubjob(KIO::NameFinderJob* self, KJob* job);
    friend bool KIO__NameFinderJob_QBaseRemoveSubjob(KIO::NameFinderJob* self, KJob* job);
    friend void KIO__NameFinderJob_SlotResult(KIO::NameFinderJob* self, KJob* job);
    friend void KIO__NameFinderJob_QBaseSlotResult(KIO::NameFinderJob* self, KJob* job);
    friend void KIO__NameFinderJob_SlotInfoMessage(KIO::NameFinderJob* self, KJob* job, const libqt_string message);
    friend void KIO__NameFinderJob_QBaseSlotInfoMessage(KIO::NameFinderJob* self, KJob* job, const libqt_string message);
    friend bool KIO__NameFinderJob_DoKill(KIO::NameFinderJob* self);
    friend bool KIO__NameFinderJob_QBaseDoKill(KIO::NameFinderJob* self);
    friend bool KIO__NameFinderJob_DoSuspend(KIO::NameFinderJob* self);
    friend bool KIO__NameFinderJob_QBaseDoSuspend(KIO::NameFinderJob* self);
    friend bool KIO__NameFinderJob_DoResume(KIO::NameFinderJob* self);
    friend bool KIO__NameFinderJob_QBaseDoResume(KIO::NameFinderJob* self);
    friend void KIO__NameFinderJob_TimerEvent(KIO::NameFinderJob* self, QTimerEvent* event);
    friend void KIO__NameFinderJob_QBaseTimerEvent(KIO::NameFinderJob* self, QTimerEvent* event);
    friend void KIO__NameFinderJob_ChildEvent(KIO::NameFinderJob* self, QChildEvent* event);
    friend void KIO__NameFinderJob_QBaseChildEvent(KIO::NameFinderJob* self, QChildEvent* event);
    friend void KIO__NameFinderJob_CustomEvent(KIO::NameFinderJob* self, QEvent* event);
    friend void KIO__NameFinderJob_QBaseCustomEvent(KIO::NameFinderJob* self, QEvent* event);
    friend void KIO__NameFinderJob_ConnectNotify(KIO::NameFinderJob* self, const QMetaMethod* signal);
    friend void KIO__NameFinderJob_QBaseConnectNotify(KIO::NameFinderJob* self, const QMetaMethod* signal);
    friend void KIO__NameFinderJob_DisconnectNotify(KIO::NameFinderJob* self, const QMetaMethod* signal);
    friend void KIO__NameFinderJob_QBaseDisconnectNotify(KIO::NameFinderJob* self, const QMetaMethod* signal);
    friend bool KIO__NameFinderJob_HasSubjobs(const KIO::NameFinderJob* self);
    friend bool KIO__NameFinderJob_QBaseHasSubjobs(const KIO::NameFinderJob* self);
    friend libqt_list /* of KJob* */ KIO__NameFinderJob_Subjobs(const KIO::NameFinderJob* self);
    friend libqt_list /* of KJob* */ KIO__NameFinderJob_QBaseSubjobs(const KIO::NameFinderJob* self);
    friend void KIO__NameFinderJob_ClearSubjobs(KIO::NameFinderJob* self);
    friend void KIO__NameFinderJob_QBaseClearSubjobs(KIO::NameFinderJob* self);
    friend void KIO__NameFinderJob_SetCapabilities(KIO::NameFinderJob* self, int capabilities);
    friend void KIO__NameFinderJob_QBaseSetCapabilities(KIO::NameFinderJob* self, int capabilities);
    friend bool KIO__NameFinderJob_IsFinished(const KIO::NameFinderJob* self);
    friend bool KIO__NameFinderJob_QBaseIsFinished(const KIO::NameFinderJob* self);
    friend void KIO__NameFinderJob_SetError(KIO::NameFinderJob* self, int errorCode);
    friend void KIO__NameFinderJob_QBaseSetError(KIO::NameFinderJob* self, int errorCode);
    friend void KIO__NameFinderJob_SetErrorText(KIO::NameFinderJob* self, const libqt_string errorText);
    friend void KIO__NameFinderJob_QBaseSetErrorText(KIO::NameFinderJob* self, const libqt_string errorText);
    friend void KIO__NameFinderJob_SetProcessedAmount(KIO::NameFinderJob* self, int unit, unsigned long long amount);
    friend void KIO__NameFinderJob_QBaseSetProcessedAmount(KIO::NameFinderJob* self, int unit, unsigned long long amount);
    friend void KIO__NameFinderJob_SetTotalAmount(KIO::NameFinderJob* self, int unit, unsigned long long amount);
    friend void KIO__NameFinderJob_QBaseSetTotalAmount(KIO::NameFinderJob* self, int unit, unsigned long long amount);
    friend void KIO__NameFinderJob_SetProgressUnit(KIO::NameFinderJob* self, int unit);
    friend void KIO__NameFinderJob_QBaseSetProgressUnit(KIO::NameFinderJob* self, int unit);
    friend void KIO__NameFinderJob_SetPercent(KIO::NameFinderJob* self, unsigned long percentage);
    friend void KIO__NameFinderJob_QBaseSetPercent(KIO::NameFinderJob* self, unsigned long percentage);
    friend void KIO__NameFinderJob_EmitResult(KIO::NameFinderJob* self);
    friend void KIO__NameFinderJob_QBaseEmitResult(KIO::NameFinderJob* self);
    ...
    friend void KIO__NameFinderJob_QBaseEmitPercent(KIO::NameFinderJob* self, unsigned long long processedAmount, unsigned long long totalAmount);
    friend void KIO__NameFinderJob_EmitSpeed(KIO::NameFinderJob* self, unsigned long speed);
    friend void KIO__NameFinderJob_QBaseEmitSpeed(KIO::NameFinderJob* self, unsigned long speed);
    friend void KIO__NameFinderJob_StartElapsedTimer(KIO::NameFinderJob* self);
    friend void KIO__NameFinderJob_QBaseStartElapsedTimer(KIO::NameFinderJob* self);
    friend QObject* KIO__NameFinderJob_Sender(const KIO::NameFinderJob* self);
    friend QObject* KIO__NameFinderJob_QBaseSender(const KIO::NameFinderJob* self);
    friend int KIO__NameFinderJob_SenderSignalIndex(const KIO::NameFinderJob* self);
    friend int KIO__NameFinderJob_QBaseSenderSignalIndex(const KIO::NameFinderJob* self);
    friend int KIO__NameFinderJob_Receivers(const KIO::NameFinderJob* self, const char* signal);
    friend int KIO__NameFinderJob_QBaseReceivers(const KIO::NameFinderJob* self, const char* signal);
    friend bool KIO__NameFinderJob_IsSignalConnected(const KIO::NameFinderJob* self, const QMetaMethod* signal);
    friend bool KIO__NameFinderJob_QBaseIsSignalConnected(const KIO::NameFinderJob* self, const QMetaMethod* signal);
};
