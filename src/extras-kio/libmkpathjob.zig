...
pub const kio__mkpathjob = struct {
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, title: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8, field2: struct_constu8_constu8) callconv(.c) void ```
