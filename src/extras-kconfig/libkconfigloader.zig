...
/// https://api-staging.kde.org/kconfigloader.html
pub const kconfigloader = struct {
    ...
    /// [Qt documentation](https://api-staging.kde.org/kconfigloader.html#findItem)
    ///
    ...
    /// [Qt documentation](https://api-staging.kde.org/kconfigloader.html#findItemByName)
    ///
    ...
    /// [Qt documentation](https://api-staging.kde.org/kconfigloader.html#property)
    ///
    /// ``` self: QtC.KConfigLoader, name: []const u8 ```
    ...
    /// [Qt documentation](https://api-staging.kde.org/kconfigloader.html#hasGroup)
    ///
    ...
    /// [Qt documentation](https://api-staging.kde.org/kconfigloader.html#groupList)
    ///
    ...
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn () callconv(.c) bool ```
    pub fn OnUsrSave(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        qtc.KConfigLoader_OnUsrSave(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// [Qt documentation](https://api-staging.kde.org/kcoreconfigskeleton.html#configChanged)
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Inherited from KConfigSkeleton
    ///
    /// [Qt documentation](https://api-staging.kde.org/kconfigskeleton.html#qt_metacall)
    ///
    ...
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, slot: fn (?*anyopaque, i32, i32, ?*anyopaque) callconv(.c) i32) void {
        qtc.KConfigLoader_OnMetacall(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn () callconv(.c) void ```
    pub fn OnSetDefaults(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        qtc.KConfigLoader_OnSetDefaults(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, b: bool) callconv(.c) bool ```
    pub fn OnUseDefaults(self: ?*anyopaque, slot: fn (?*anyopaque, bool) callconv(.c) bool) void {
        qtc.KConfigLoader_OnUseDefaults(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn OnUsrUseDefaults(self: ?*anyopaque, slot: fn (?*anyopaque, bool) callconv(.c) bool) void {
        qtc.KConfigLoader_OnUsrUseDefaults(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn OnUsrSetDefaults(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        qtc.KConfigLoader_OnUsrSetDefaults(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn OnUsrRead(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        qtc.KConfigLoader_OnUsrRead(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KConfigLoader_OnEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KConfigLoader_OnEventFilter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, event: QtC.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KConfigLoader_OnTimerEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, event: QtC.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KConfigLoader_OnChildEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, event: QtC.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KConfigLoader_OnCustomEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, signal: QtC.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KConfigLoader_OnConnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KConfigLoader_OnDisconnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn () callconv(.c) QtC.QObject ```
    pub fn OnSender(self: ?*anyopaque, slot: fn () callconv(.c) QtC.QObject) void {
        qtc.KConfigLoader_OnSender(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        qtc.KConfigLoader_OnSenderSignalIndex(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, signal: [*:0]const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, slot: fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.KConfigLoader_OnReceivers(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, signal: QtC.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KConfigLoader_OnIsSignalConnected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    ///
    /// ``` self: QtC.KConfigLoader, slot: fn (self: QtC.KConfigLoader, objectName: [*:0]const u8) callconv(.c) void ```
