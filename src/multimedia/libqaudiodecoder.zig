...
pub const qaudiodecoder = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAudioDecoder, slot: fn (self: QtC.QAudioDecoder, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QAudioDecoder, slot: fn (self: QtC.QAudioDecoder, objectName: [*:0]const u8) callconv(.c) void ```
