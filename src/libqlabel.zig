...
pub const qlabel = struct {
    ...
    pub fn SetNumWithNum(self: ?*anyopaque, num: f64) void {
        qtc.QLabel_SetNumWithNum(@ptrCast(self), @floatCast(num));
    }
    ...
    pub fn NativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return qtc.QLabel_NativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return qtc.QLabel_QBaseNativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    ///
    /// ``` self: QtC.QLabel, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
