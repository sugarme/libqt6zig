...
class VirtualQOpenGLFunctions_1_4 final : public QOpenGLFunctions_1_4 {
  ...
  public:
    ...
    ~VirtualQOpenGLFunctions_1_4() {
        ...
        qopenglfunctions_1_4_isinitialized_callback = nullptr;
        qopenglfunctions_1_4_setowningcontext_callback = nullptr;
        qopenglfunctions_1_4_owningcontext_callback = nullptr;
    }
    ...
    bool isInitialized() const {
        ...
        } else if (qopenglfunctions_1_4_isinitialized_callback != nullptr) {
            bool callback_ret = qopenglfunctions_1_4_isinitialized_callback();
            return callback_ret;
        } else {
            return QOpenGLFunctions_1_4::isInitialized();
        }
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        } else if (qopenglfunctions_1_4_setowningcontext_callback != nullptr) {
            QOpenGLContext* cbval1 = (QOpenGLContext*)context;

            qopenglfunctions_1_4_setowningcontext_callback(this, cbval1);
        } else {
            QOpenGLFunctions_1_4::setOwningContext(context);
        }
    }
    ...
    QOpenGLContext* owningContext() const {
        ...
        } else if (qopenglfunctions_1_4_owningcontext_callback != nullptr) {
            QOpenGLContext* callback_ret = qopenglfunctions_1_4_owningcontext_callback();
            return callback_ret;
        } else {
            return QOpenGLFunctions_1_4::owningContext();
        }
    ...
    friend bool QOpenGLFunctions_1_4_QBaseIsInitialized(const QOpenGLFunctions_1_4* self);
    friend void QOpenGLFunctions_1_4_SetOwningContext(QOpenGLFunctions_1_4* self, const QOpenGLContext* context);
    friend void QOpenGLFunctions_1_4_QBaseSetOwningContext(QOpenGLFunctions_1_4* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_1_4_OwningContext(const QOpenGLFunctions_1_4* self);
    friend QOpenGLContext* QOpenGLFunctions_1_4_QBaseOwningContext(const QOpenGLFunctions_1_4* self);
};
