...
pub const qheaderview = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QHeaderView, slot: fn (self: QtC.QHeaderView, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QHeaderView, slot: fn (self: QtC.QHeaderView, iconText: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QHeaderView, slot: fn (self: QtC.QHeaderView, objectName: []const u8) callconv(.c) void ```
