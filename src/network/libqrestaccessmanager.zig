...
pub const qrestaccessmanager = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QRestAccessManager, slot: fn (self: QtC.QRestAccessManager, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QRestAccessManager, slot: fn (self: QtC.QRestAccessManager, objectName: []const u8) callconv(.c) void ```
