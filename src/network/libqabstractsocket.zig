...
pub const qabstractsocket = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QAbstractSocket, slot: fn (self: QtC.QAbstractSocket, data: [*:0]const u8, maxlen: i64) callconv(.c) i64 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QAbstractSocket, slot: fn (self: QtC.QAbstractSocket, data: [*:0]const u8, lenVal: i64) callconv(.c) i64 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QAbstractSocket, slot: fn (self: QtC.QAbstractSocket, name: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAbstractSocket, slot: fn (self: QtC.QAbstractSocket, errorString: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAbstractSocket, slot: fn (self: QtC.QAbstractSocket, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QAbstractSocket, slot: fn (self: QtC.QAbstractSocket, objectName: [*:0]const u8) callconv(.c) void ```
