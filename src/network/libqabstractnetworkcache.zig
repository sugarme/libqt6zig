...
pub const qabstractnetworkcache = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QAbstractNetworkCache, slot: fn (self: QtC.QAbstractNetworkCache) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QAbstractNetworkCache, slot: fn (self: QtC.QAbstractNetworkCache, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QAbstractNetworkCache, slot: fn (self: QtC.QAbstractNetworkCache, objectName: [*:0]const u8) callconv(.c) void ```
