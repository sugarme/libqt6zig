...
pub const qlocalserver = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QLocalServer, slot: fn (self: QtC.QLocalServer, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QLocalServer, slot: fn (self: QtC.QLocalServer, objectName: [*:0]const u8) callconv(.c) void ```
