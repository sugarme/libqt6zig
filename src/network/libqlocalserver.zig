...
pub const qlocalserver = struct {
    ...
    pub fn ListenWithSocketDescriptor(self: ?*anyopaque, socketDescriptor: isize) bool {
        return qtc.QLocalServer_ListenWithSocketDescriptor(@ptrCast(self), @intCast(socketDescriptor));
    }
    ...
    ///
    /// ``` self: QtC.QLocalServer, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
