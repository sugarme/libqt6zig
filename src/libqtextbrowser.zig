...
pub const qtextbrowser = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QTextBrowser, slot: fn (self: QtC.QTextBrowser, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QTextBrowser, slot: fn (self: QtC.QTextBrowser, iconText: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QTextBrowser, slot: fn (self: QtC.QTextBrowser, objectName: []const u8) callconv(.c) void ```
