...
class VirtualQsciLexerIntelHex final : public QsciLexerIntelHex {
  ...
  public:
    ...
    using QsciLexerIntelHex_AutoCompletionWordSeparators_Callback = libqt_list /* of libqt_string */ (*)();
    ...
    using QsciLexerIntelHex_BytesAsText_Callback = libqt_string (*)(const QsciLexerIntelHex*, const char*, int);
  ...
  public:
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexerintelhex_autocompletionwordseparators_isbase) {
            ...
            libqt_list /* of libqt_string */ callback_ret = qscilexerintelhex_autocompletionwordseparators_callback();
    ...
    virtual QString description(int style) const override {
        if (qscilexerintelhex_description_callback != nullptr) {
            ...
            libqt_string callback_ret = qscilexerintelhex_description_callback(this, cbval1);
    ...
    QString bytesAsText(const char* bytes, int size) const {
        if (qscilexerintelhex_bytesastext_isbase) {
            ...
            libqt_string callback_ret = qscilexerintelhex_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret.data, callback_ret.len);
            return callback_ret_QString;
        } else {
            return QsciLexerIntelHex::bytesAsText(bytes, size);
