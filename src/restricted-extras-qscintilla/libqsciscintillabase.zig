...
pub const qsciscintillabase = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QsciScintillaBase, slot: fn (self: QtC.QsciScintillaBase, title: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QsciScintillaBase, slot: fn (self: QtC.QsciScintillaBase, iconText: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciScintillaBase, slot: fn (self: QtC.QsciScintillaBase, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QsciScintillaBase, slot: fn (self: QtC.QsciScintillaBase, objectName: [*:0]const u8) callconv(.c) void ```
