...
pub const qscilexeryaml = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerYAML, slot: fn (self: QtC.QsciLexerYAML, prop: []const u8, val: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QsciLexerYAML, slot: fn (self: QtC.QsciLexerYAML, objectName: []const u8) callconv(.c) void ```
