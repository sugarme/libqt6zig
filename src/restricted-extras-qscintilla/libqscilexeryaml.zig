...
pub const qscilexeryaml = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerYAML, slot: fn (self: QtC.QsciLexerYAML, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerYAML, slot: fn (self: QtC.QsciLexerYAML, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
