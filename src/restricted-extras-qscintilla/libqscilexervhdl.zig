...
pub const qscilexervhdl = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerVHDL, slot: fn (self: QtC.QsciLexerVHDL, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerVHDL, slot: fn (self: QtC.QsciLexerVHDL, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
