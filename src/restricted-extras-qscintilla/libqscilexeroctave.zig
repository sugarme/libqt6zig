...
pub const qscilexeroctave = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerOctave, slot: fn (self: QtC.QsciLexerOctave, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerOctave, slot: fn (self: QtC.QsciLexerOctave, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
