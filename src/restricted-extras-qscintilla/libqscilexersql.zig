...
pub const qscilexersql = struct {
    ...
    pub fn DefaultColorWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerSQL_DefaultColorWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultColorWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerSQL_QBaseDefaultColorWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultColorWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerSQL_OnDefaultColorWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DefaultFontWithStyle(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerSQL_DefaultFontWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultFontWithStyle(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerSQL_QBaseDefaultFontWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultFontWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QFont) void {
        qtc.QsciLexerSQL_OnDefaultFontWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DefaultPaperWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerSQL_DefaultPaperWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultPaperWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerSQL_QBaseDefaultPaperWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultPaperWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerSQL_OnDefaultPaperWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
