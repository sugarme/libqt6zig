...
pub const qscilexerintelhex = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerIntelHex, slot: fn (self: QtC.QsciLexerIntelHex, prop: []const u8, val: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QsciLexerIntelHex, slot: fn (self: QtC.QsciLexerIntelHex, objectName: []const u8) callconv(.c) void ```
