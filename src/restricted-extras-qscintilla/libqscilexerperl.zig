...
pub const qscilexerperl = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerPerl, slot: fn (self: QtC.QsciLexerPerl, prop: []const u8, val: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QsciLexerPerl, slot: fn (self: QtC.QsciLexerPerl, objectName: []const u8) callconv(.c) void ```
