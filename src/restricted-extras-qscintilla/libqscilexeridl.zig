...
pub const qscilexeridl = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, eolfilled: bool, style: i32) callconv(.c) void ```
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, prop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn () callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, style: *i32) callconv(.c) [*:0]const u8 ```
    ...
    pub fn OnDefaultColor2(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerIDL_OnDefaultColor2(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn OnDefaultFont2(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QFont) void {
        qtc.QsciLexerIDL_OnDefaultFont2(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn OnDefaultPaper2(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerIDL_OnDefaultPaper2(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, qs: QtC.QSettings, prefix: [*:0]const u8) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, text: [*:0]const u8) callconv(.c) [*:0]u8 ```
    pub fn OnTextAsBytes(self: ?*anyopaque, slot: fn (?*anyopaque, [*:0]const u8) callconv(.c) [*:0]u8) void {
        qtc.QsciLexerIDL_OnTextAsBytes(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, bytes: [*:0]const u8, size: i32) callconv(.c) [*:0]const u8 ```
    pub fn OnBytesAsText(self: ?*anyopaque, slot: fn (?*anyopaque, [*:0]const u8, i32) callconv(.c) [*:0]const u8) void {
        qtc.QsciLexerIDL_OnBytesAsText(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, objectName: [*:0]const u8) callconv(.c) void ```
