...
pub const qscilexerspice = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerSpice, slot: fn (self: QtC.QsciLexerSpice, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerSpice, slot: fn (self: QtC.QsciLexerSpice, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
