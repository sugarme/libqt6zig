...
pub const qscilexerspice = struct {
    ...
    pub fn BlockEnd(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerSpice_BlockEnd(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn QBaseBlockEnd(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerSpice_QBaseBlockEnd(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn BlockStart(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerSpice_BlockStart(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn QBaseBlockStart(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerSpice_QBaseBlockStart(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn BlockStartKeyword(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerSpice_BlockStartKeyword(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn QBaseBlockStartKeyword(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerSpice_QBaseBlockStartKeyword(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn DefaultColorWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerSpice_DefaultColorWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultColorWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerSpice_QBaseDefaultColorWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultColorWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerSpice_OnDefaultColorWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DefaultFontWithStyle(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerSpice_DefaultFontWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultFontWithStyle(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerSpice_QBaseDefaultFontWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultFontWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QFont) void {
        qtc.QsciLexerSpice_OnDefaultFontWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DefaultPaperWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerSpice_DefaultPaperWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultPaperWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerSpice_QBaseDefaultPaperWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultPaperWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerSpice_OnDefaultPaperWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    ///
    /// ``` self: QtC.QsciLexerSpice, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
