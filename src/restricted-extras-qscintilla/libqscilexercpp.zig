...
pub const qscilexercpp = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerCPP, slot: fn (self: QtC.QsciLexerCPP, prop: []const u8, val: []const u8) callconv(.c) void ```
    ...
    pub fn TextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        const _bytearray: qtc.struct_libqt_string = qtc.QsciLexerCPP_TextAsBytes(@ptrCast(self), text_str);
    ...
    pub fn QBaseTextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        const _bytearray: qtc.struct_libqt_string = qtc.QsciLexerCPP_QBaseTextAsBytes(@ptrCast(self), text_str);
        defer qtc.libqt_string_free(&_bytearray);
        const _ret = allocator.alloc(u8, _bytearray.len) catch @panic("qscilexercpp.TextAsBytes: Memory allocation failed");
        @memcpy(_ret, _bytearray.data[0.._bytearray.len]);
        return _ret;
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCPP, slot: fn (self: QtC.QsciLexerCPP, text: []const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCPP, slot: fn (self: QtC.QsciLexerCPP, bytes: []const u8, size: i32) callconv(.c) []const u8 ```
    ...
    ///
    /// ``` self: QtC.QsciLexerCPP, slot: fn (self: QtC.QsciLexerCPP, objectName: []const u8) callconv(.c) void ```
