...
pub const qscilexercmake = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
