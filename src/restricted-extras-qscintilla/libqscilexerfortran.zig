...
pub const qscilexerfortran = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, prop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn () callconv(.c) [*:0]const u8 ```
    ...
    pub fn AutoCompletionWordSeparators(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        const _arr: qtc.libqt_list = qtc.QsciLexerFortran_AutoCompletionWordSeparators(@ptrCast(self));
        const _str: [*]qtc.libqt_string = @ptrCast(@alignCast(_arr.data));
        defer {
            for (0.._arr.len) |i| {
                qtc.libqt_string_free(@ptrCast(&_str[i]));
    ...
    pub fn QBaseAutoCompletionWordSeparators(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        const _arr: qtc.libqt_list = qtc.QsciLexerFortran_QBaseAutoCompletionWordSeparators(@ptrCast(self));
        const _str: [*]qtc.libqt_string = @ptrCast(@alignCast(_arr.data));
        defer {
            for (0.._arr.len) |i| {
                qtc.libqt_string_free(@ptrCast(&_str[i]));
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, style: *i32) callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, qs: QtC.QSettings, prefix: [*:0]const u8) callconv(.c) bool ```
    ...
    pub fn TextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        const _bytearray: qtc.libqt_string = qtc.QsciLexerFortran_TextAsBytes(@ptrCast(self), text_str);
    ...
    pub fn QBaseTextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        const _bytearray: qtc.libqt_string = qtc.QsciLexerFortran_QBaseTextAsBytes(@ptrCast(self), text_str);
        defer qtc.libqt_string_free(&_bytearray);
        const _ret = allocator.alloc(u8, _bytearray.len) catch @panic("qscilexerfortran.TextAsBytes: Memory allocation failed");
        @memcpy(_ret, _bytearray.data[0.._bytearray.len]);
        return _ret;
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, text: [*:0]const u8) callconv(.c) [*:0]u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, bytes: [*:0]const u8, size: i32) callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, objectName: [*:0]const u8) callconv(.c) void ```
