...
libqt_list /* of libqt_string */ QsciLexerBatch_AutoCompletionWordSeparators(const QsciLexerBatch* self) {
    auto* vqscilexerbatch = const_cast<VirtualQsciLexerBatch*>(dynamic_cast<const VirtualQsciLexerBatch*>(self));
    if (vqscilexerbatch && vqscilexerbatch->isVirtualQsciLexerBatch) {
        QList<QString> _ret = vqscilexerbatch->autoCompletionWordSeparators();
        ...
        QList<QString> _ret = ((VirtualQsciLexerBatch*)self)->autoCompletionWordSeparators();
        // Convert QList<> from C++ memory to manually-managed C memory
        libqt_string* _arr = static_cast<libqt_string*>(malloc(sizeof(libqt_string) * _ret.size()));
        for (size_t i = 0; i < _ret.size(); ++i) {
            QString _lv_ret = _ret[i];
...
libqt_string QsciLexerBatch_TextAsBytes(const QsciLexerBatch* self, const libqt_string text) {
    ...
    if (vqscilexerbatch && vqscilexerbatch->isVirtualQsciLexerBatch) {
        QByteArray _qb = vqscilexerbatch->textAsBytes(text_QString);
        libqt_string _str;
        _str.len = _qb.length();
        _str.data = static_cast<const char*>(malloc((_str.len + 1) * sizeof(char)));
        ...
        QByteArray _qb = ((VirtualQsciLexerBatch*)self)->textAsBytes(text_QString);
        libqt_string _str;
        _str.len = _qb.length();
        _str.data = static_cast<const char*>(malloc((_str.len + 1) * sizeof(char)));
        memcpy((void*)_str.data, _qb.data(), _str.len);
...
libqt_string QsciLexerBatch_QBaseTextAsBytes(const QsciLexerBatch* self, const libqt_string text) {
    ...
    QString text_QString = QString::fromUtf8(text.data, text.len);
    if (vqscilexerbatch && vqscilexerbatch->isVirtualQsciLexerBatch) {
        vqscilexerbatch->setQsciLexerBatch_TextAsBytes_IsBase(true);
        QByteArray _qb = vqscilexerbatch->textAsBytes(text_QString);
        libqt_string _str;
        _str.len = _qb.length();
        _str.data = static_cast<const char*>(malloc((_str.len + 1) * sizeof(char)));
...
void QsciLexerBatch_OnTextAsBytes(const QsciLexerBatch* self, intptr_t slot) {
    auto* vqscilexerbatch = const_cast<VirtualQsciLexerBatch*>(dynamic_cast<const VirtualQsciLexerBatch*>(self));
    if (vqscilexerbatch && vqscilexerbatch->isVirtualQsciLexerBatch) {
        vqscilexerbatch->setQsciLexerBatch_TextAsBytes_Callback(reinterpret_cast<VirtualQsciLexerBatch::QsciLexerBatch_TextAsBytes_Callback>(slot));
    }
}
...
libqt_string QsciLexerBatch_BytesAsText(const QsciLexerBatch* self, const char* bytes, int size) {
    auto* vqscilexerbatch = const_cast<VirtualQsciLexerBatch*>(dynamic_cast<const VirtualQsciLexerBatch*>(self));
    if (vqscilexerbatch && vqscilexerbatch->isVirtualQsciLexerBatch) {
        QString _ret = vqscilexerbatch->bytesAsText(bytes, static_cast<int>(size));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
        ...
        QString _ret = ((VirtualQsciLexerBatch*)self)->bytesAsText(bytes, static_cast<int>(size));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
...
void QsciLexerBatch_OnBytesAsText(const QsciLexerBatch* self, intptr_t slot) {
    auto* vqscilexerbatch = const_cast<VirtualQsciLexerBatch*>(dynamic_cast<const VirtualQsciLexerBatch*>(self));
    if (vqscilexerbatch && vqscilexerbatch->isVirtualQsciLexerBatch) {
        vqscilexerbatch->setQsciLexerBatch_BytesAsText_Callback(reinterpret_cast<VirtualQsciLexerBatch::QsciLexerBatch_BytesAsText_Callback>(slot));
    }
}
