...
pub const qthread = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QThread, slot: fn (self: QtC.QThread, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QThread, slot: fn (self: QtC.QThread, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QThread, slot: fn (self: QtC.QThread, objectName: [*:0]const u8) callconv(.c) void ```
