...
pub const qlistwidgetitem = struct {
    ...
    pub fn SetTextAlignmentWithAlignment(self: ?*anyopaque, alignment: i64) void {
        qtc.QListWidgetItem_SetTextAlignmentWithAlignment(@ptrCast(self), @intCast(alignment));
    }
...
pub const qlistwidget = struct {
    ...
    pub fn AddItemWithItem(self: ?*anyopaque, item: ?*anyopaque) void {
        qtc.QListWidget_AddItemWithItem(@ptrCast(self), @ptrCast(item));
    }
    ...
    pub fn NativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return qtc.QListWidget_NativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return qtc.QListWidget_QBaseNativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    ///
    /// ``` self: QtC.QListWidget, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
