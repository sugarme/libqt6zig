...
pub const qguiapplication = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QGuiApplication, slot: fn (self: QtC.QGuiApplication, name: [*:0]const u8, revision: i32) callconv(.c) ?*anyopaque ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qcoreapplication.html#installNativeEventFilter)
    ///
    /// ``` self: QtC.QGuiApplication, slot: fn (self: QtC.QGuiApplication, filterObj: QtC.QAbstractNativeEventFilter) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QGuiApplication, slot: fn (self: QtC.QGuiApplication, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QGuiApplication, slot: fn (self: QtC.QGuiApplication, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QGuiApplication, slot: fn (self: QtC.QGuiApplication, objectName: [*:0]const u8) callconv(.c) void ```
