...
pub const sonnet__dialog = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.Sonnet__Dialog_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn NativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: *isize) bool {
        ...
        return qtc.Sonnet__Dialog_NativeEvent(@ptrCast(self), eventType_str, message, @ptrCast(result));
    }
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: *isize) bool {
        ...
        return qtc.Sonnet__Dialog_QBaseNativeEvent(@ptrCast(self), eventType_str, message, @ptrCast(result));
    }
