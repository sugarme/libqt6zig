...
#include <cstring>
#include <QVariant>
#define WORKAROUND_INNER_CLASS_DEFINITION_Solid__Camera
#define WORKAROUND_INNER_CLASS_DEFINITION_Solid__DeviceInterface
#include <camera.h>
#include "libcamera.h"
#include "libcamera.hxx"
...
libqt_string Solid__Camera_Tr(const char* s) {
    QString _ret = Solid::Camera::tr(s);
...
int Solid__Camera_DeviceInterfaceType() {
    return static_cast<int>(Solid::Camera::deviceInterfaceType());
}
...
libqt_string Solid__Camera_Tr2(const char* s, const char* c) {
    QString _ret = Solid::Camera::tr(s, c);
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string Solid__Camera_Tr3(const char* s, const char* c, int n) {
    QString _ret = Solid::Camera::tr(s, c, static_cast<int>(n));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
