...
pub const solid__genericinterface = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.Solid__GenericInterface_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.Solid__GenericInterface, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.Solid__GenericInterface_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.Solid__GenericInterface, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.Solid__GenericInterface_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.Solid__GenericInterface_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::genericinterface.Tr: Memory allocation failed");
    ...
    pub fn PropertyChanged(self: ?*anyopaque, changes: map_constu8_i32, allocator: std.mem.Allocator) void {
        const changes_keys = allocator.alloc(qtc.libqt_string, changes.count()) catch @panic("solid::genericinterface.PropertyChanged: Memory allocation failed");
        defer allocator.free(changes_keys);
        const changes_values = allocator.alloc(i32, changes.count()) catch @panic("solid::genericinterface.PropertyChanged: Memory allocation failed");
    ...
    /// [Qt documentation](https://api.kde.org/solid-genericinterface.html#propertyChanged)
    ///
    /// ``` self: QtC.Solid__GenericInterface, slot: fn (self: QtC.Solid__GenericInterface, changes: map_constu8_i32) callconv(.c) void ```
    pub fn OnPropertyChanged(self: ?*anyopaque, slot: fn (?*anyopaque, map_constu8_i32) callconv(.c) void) void {
        qtc.Solid__GenericInterface_Connect_PropertyChanged(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// [Qt documentation](https://api.kde.org/solid-genericinterface.html#conditionRaised)
    ///
    /// ``` self: QtC.Solid__GenericInterface, slot: fn (self: QtC.Solid__GenericInterface, condition: [*:0]const u8, reason: [*:0]const u8) callconv(.c) void ```
    pub fn OnConditionRaised(self: ?*anyopaque, slot: fn (?*anyopaque, [*:0]const u8, [*:0]const u8) callconv(.c) void) void {
        qtc.Solid__GenericInterface_Connect_ConditionRaised(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.Solid__GenericInterface_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::genericinterface.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.Solid__GenericInterface_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::genericinterface.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn TypeToString(typeVal: i32, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::genericinterface.TypeToString: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn TypeDescription(typeVal: i32, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::genericinterface.TypeDescription: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::genericinterface.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("solid::genericinterface.Children: Memory allocation failed");
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("solid::genericinterface.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("solid::genericinterface.DynamicPropertyNames: Memory allocation failed");
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.Solid__GenericInterface, slot: fn (self: QtC.Solid__GenericInterface) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.Solid__GenericInterface, slot: fn (self: QtC.Solid__GenericInterface, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.Solid__GenericInterface, slot: fn (self: QtC.Solid__GenericInterface, objectName: [*:0]const u8) callconv(.c) void ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.Solid__GenericInterface_Delete(@ptrCast(self));
    }
};
