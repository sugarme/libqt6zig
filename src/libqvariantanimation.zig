...
pub const qvariantanimation = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractanimation.html#finished)
    ///
    /// ``` self: QtC.QVariantAnimation, slot: fn (self: QtC.QVariantAnimation) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractanimation.html#currentLoopChanged)
    ///
    /// ``` self: QtC.QVariantAnimation, slot: fn (self: QtC.QVariantAnimation, currentLoop: i32) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractanimation.html#directionChanged)
    ///
    /// ``` self: QtC.QVariantAnimation, slot: fn (self: QtC.QVariantAnimation, param1: qabstractanimation_enums.Direction) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QVariantAnimation, slot: fn (self: QtC.QVariantAnimation, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QVariantAnimation, slot: fn (self: QtC.QVariantAnimation, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QVariantAnimation, slot: fn (self: QtC.QVariantAnimation, objectName: [*:0]const u8) callconv(.c) void ```
