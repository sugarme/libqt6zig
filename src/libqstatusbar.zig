...
pub const qstatusbar = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QStatusBar, slot: fn (self: QtC.QStatusBar, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QStatusBar, slot: fn (self: QtC.QStatusBar, iconText: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QStatusBar, slot: fn (self: QtC.QStatusBar, objectName: []const u8) callconv(.c) void ```
