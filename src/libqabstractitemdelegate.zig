...
pub const qabstractitemdelegate = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QAbstractItemDelegate, slot: fn () callconv(.c) [*:-1]i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAbstractItemDelegate, slot: fn (self: QtC.QAbstractItemDelegate, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QAbstractItemDelegate, slot: fn (self: QtC.QAbstractItemDelegate, objectName: [*:0]const u8) callconv(.c) void ```
