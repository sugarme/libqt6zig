...
pub const kjob = struct {
    ...
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn () callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn () callconv(.c) bool ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, capabilities: flag of kjob_enums.Capability) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn () callconv(.c) [*:0]const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#infoMessage)
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#totalSize)
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, job: QtC.KJob, size: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#speed)
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, job: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, errorCode: i32) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, errorText: [*:0]const u8) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, unit: kjob_enums.Unit) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, percentage: u64) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, processedAmount: u64, totalAmount: u64) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, event: QtC.QTimerEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, event: QtC.QChildEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, event: QtC.QEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, signal: QtC.QMetaMethod) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn () callconv(.c) QtC.QObject ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn () callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, signal: QtC.QMetaMethod) callconv(.c) bool ```
    ...
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, job: QtC.KJob) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, job: QtC.KJob, percent: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KJob, callback: *const fn (self: QtC.KJob, objectName: [*:0]const u8) callconv(.c) void ```
