...
pub const qsvgrenderer = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QSvgRenderer, slot: fn (self: QtC.QSvgRenderer, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QSvgRenderer, slot: fn (self: QtC.QSvgRenderer, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QSvgRenderer, slot: fn (self: QtC.QSvgRenderer, objectName: [*:0]const u8) callconv(.c) void ```
