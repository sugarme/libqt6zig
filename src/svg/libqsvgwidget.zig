...
pub const qsvgwidget = struct {
    ...
    ///
    /// ``` parent: ?*C.QWidget ```
    pub fn New(parent: ?*anyopaque) ?*C.QSvgWidget {
        return C.QSvgWidget_new(@ptrCast(parent));
    }

    /// New2 constructs a new QSvgWidget object.
    ///
    ///
    pub fn New2() ?*C.QSvgWidget {
        return C.QSvgWidget_new2();
    }

    /// New3 constructs a new QSvgWidget object.
    ///
    /// ``` file: []const u8 ```
    pub fn New3(file: []const u8) ?*C.QSvgWidget {
        const file_str = C.struct_libqt_string{
            .len = file.len,
            .data = @constCast(file.ptr),
        };

        return C.QSvgWidget_new3(file_str);
    }

    /// New4 constructs a new QSvgWidget object.
    ///
    /// ``` file: []const u8, parent: ?*C.QWidget ```
    pub fn New4(file: []const u8, parent: ?*anyopaque) ?*C.QSvgWidget {
        const file_str = C.struct_libqt_string{
            .len = file.len,
            .data = @constCast(file.ptr),
        };

        return C.QSvgWidget_new4(file_str, @ptrCast(parent));
    }
    ...
    pub fn MetaObject(self: ?*anyopaque) ?*C.QMetaObject {
        return C.QSvgWidget_MetaObject(@ptrCast(self));
    }

    /// ``` self: ?*C.QSvgWidget, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = @constCast(param1.ptr);
        return C.QSvgWidget_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: ?*C.QSvgWidget, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QSvgWidget_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, qobjectdefs_enums.Call, i32, ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, slot: fn (?*anyopaque, i64, i32, ?*anyopaque) callconv(.c) i32) void {
        C.QSvgWidget_OnMetacall(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QSvgWidget_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QSvgWidget_Tr(s_Cstring);
    ...
    ///
    /// ``` self: ?*C.QSvgWidget ```
    pub fn Renderer(self: ?*anyopaque) ?*C.QSvgRenderer {
        return C.QSvgWidget_Renderer(@ptrCast(self));
    }
    ...
    pub fn SizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QSvgWidget_SizeHint(@ptrCast(self));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn () callconv(.c) ?*C.QSize ```
    pub fn OnSizeHint(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QSize) void {
        C.QSvgWidget_OnSizeHint(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QSvgWidget_QBaseSizeHint(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qsvgwidget.html#load)
    ///
    /// ``` self: ?*C.QSvgWidget, file: []const u8 ```
    pub fn Load(self: ?*anyopaque, file: []const u8) void {
        const file_str = C.struct_libqt_string{
            .len = file.len,
            .data = @constCast(file.ptr),
        };
        C.QSvgWidget_Load(@ptrCast(self), file_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qsvgwidget.html#load)
    ///
    /// ``` self: ?*C.QSvgWidget, contents: []u8 ```
    pub fn LoadWithContents(self: ?*anyopaque, contents: []u8) void {
        const contents_str = C.struct_libqt_string{
            .len = contents.len,
            .data = @constCast(contents.ptr),
        };
        C.QSvgWidget_LoadWithContents(@ptrCast(self), contents_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qsvgwidget.html#paintEvent)
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QPaintEvent ```
    pub fn PaintEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_PaintEvent(@ptrCast(self), @ptrCast(event));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QPaintEvent) callconv(.c) void ```
    pub fn OnPaintEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnPaintEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBasePaintEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBasePaintEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QSvgWidget_Tr2(s_Cstring, c_Cstring);
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = @constCast(s.ptr);
        const c_Cstring = @constCast(c.ptr);
        const _str = C.QSvgWidget_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, style: ?*C.QStyle ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, windowModality: qnamespace_enums.WindowModality ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, enabled: bool ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, disabled: bool ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, windowModified: bool ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, minimumSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMinimumSize)
    ///
    /// ``` self: ?*C.QSvgWidget, minw: i32, minh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, maximumSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMaximumSize)
    ///
    /// ``` self: ?*C.QSvgWidget, maxw: i32, maxh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, sizeIncrement: ?*C.QSize ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, baseSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setBaseSize)
    ///
    /// ``` self: ?*C.QSvgWidget, basew: i32, baseh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, fixedSize: ?*C.QSize ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QPointF ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#mapToGlobal)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QPoint ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QWidget, param2: ?*C.QPointF ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#mapTo)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QWidget, param2: ?*C.QPoint ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, palette: ?*C.QPalette ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, backgroundRole: qpalette_enums.ColorRole ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, foregroundRole: qpalette_enums.ColorRole ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, font: ?*C.QFont ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, cursor: ?*C.QCursor ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, mask: ?*C.QBitmap ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMask)
    ///
    /// ``` self: ?*C.QSvgWidget, mask: ?*C.QRegion ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, target: ?*C.QPaintDevice ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QSvgWidget, painter: ?*C.QPainter ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, effect: ?*C.QGraphicsEffect ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, typeVal: qnamespace_enums.GestureType ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, windowTitle: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, styleSheet: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, icon: ?*C.QIcon ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, windowIconText: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, windowRole: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, filePath: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, toolTip: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, statusTip: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, whatsThis: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, name: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, description: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, direction: qnamespace_enums.LayoutDirection ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, locale: ?*C.QLocale ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setFocus)
    ///
    /// ``` self: ?*C.QSvgWidget, reason: qnamespace_enums.FocusReason ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, policy: qnamespace_enums.FocusPolicy ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, focusProxy: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, policy: qnamespace_enums.ContextMenuPolicy ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabMouse)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QCursor ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, key: ?*C.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QSvgWidget, x: i32, y: i32, w: i32, h: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QRect ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QRegion ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#resize)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setGeometry)
    ///
    /// ``` self: ?*C.QSvgWidget, geometry: ?*C.QRect ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, sizePolicy: C.QSizePolicy ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setSizePolicy)
    ///
    /// ``` self: ?*C.QSvgWidget, horizontal: qsizepolicy_enums.Policy, vertical: qsizepolicy_enums.Policy ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, left: i32, top: i32, right: i32, bottom: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setContentsMargins)
    ///
    /// ``` self: ?*C.QSvgWidget, margins: ?*C.QMargins ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, layout: ?*C.QLayout ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, parent: ?*C.QWidget ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setParent)
    ///
    /// ``` self: ?*C.QSvgWidget, parent: ?*C.QWidget, f: i32 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, dx: i32, dy: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#scroll)
    ///
    /// ``` self: ?*C.QSvgWidget, dx: i32, dy: i32, param3: ?*C.QRect ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, action: ?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, actions: []?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, before: ?*C.QAction, actions: []?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, before: ?*C.QAction, action: ?*C.QAction ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QSvgWidget, text: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QSvgWidget, icon: ?*C.QIcon, text: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QSvgWidget, text: []const u8, shortcut: ?*C.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QSvgWidget, icon: ?*C.QIcon, text: []const u8, shortcut: ?*C.QKeySequence ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, param1: qnamespace_enums.WindowType ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, param1: qnamespace_enums.WidgetAttribute ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, child: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, screen: ?*C.QScreen ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, title: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, iconText: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, pos: ?*C.QPoint ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QSvgWidget, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QSvgWidget, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QSvgWidget, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QSvgWidget, painter: ?*C.QPainter, targetOffset: ?*C.QPoint ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QSvgWidget, painter: ?*C.QPainter, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QSvgWidget, painter: ?*C.QPainter, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grab)
    ///
    /// ``` self: ?*C.QSvgWidget, rectangle: ?*C.QRect ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabGesture)
    ///
    /// ``` self: ?*C.QSvgWidget, typeVal: qnamespace_enums.GestureType, flags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabShortcut)
    ///
    /// ``` self: ?*C.QSvgWidget, key: ?*C.QKeySequence, context: qnamespace_enums.ShortcutContext ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setShortcutEnabled)
    ///
    /// ``` self: ?*C.QSvgWidget, id: i32, enable: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setWindowFlag)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: qnamespace_enums.WindowType, on: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setAttribute)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: qnamespace_enums.WidgetAttribute, on: bool ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, thread: ?*C.QThread ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, interval: i32 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, filterObj: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, obj: ?*C.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QSvgWidget, sender: ?*C.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, name: []const u8, value: ?*C.QVariant ```
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: ?*C.QSvgWidget, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QSvgWidget, sender: ?*C.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QObject ```
    ...
    pub fn DevType(self: ?*anyopaque) i32 {
        return C.QSvgWidget_DevType(@ptrCast(self));
    }
    ...
    pub fn QBaseDevType(self: ?*anyopaque) i32 {
        return C.QSvgWidget_QBaseDevType(@ptrCast(self));
    }
    ...
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn () callconv(.c) i32 ```
    pub fn OnDevType(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QSvgWidget_OnDevType(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, visible: bool ```
    pub fn SetVisible(self: ?*anyopaque, visible: bool) void {
        C.QSvgWidget_SetVisible(@ptrCast(self), visible);
    }
    ...
    pub fn QBaseSetVisible(self: ?*anyopaque, visible: bool) void {
        C.QSvgWidget_QBaseSetVisible(@ptrCast(self), visible);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, bool) callconv(.c) void ```
    pub fn OnSetVisible(self: ?*anyopaque, slot: fn (?*anyopaque, bool) callconv(.c) void) void {
        C.QSvgWidget_OnSetVisible(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MinimumSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QSvgWidget_MinimumSizeHint(@ptrCast(self));
    }
    ...
    pub fn QBaseMinimumSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QSvgWidget_QBaseMinimumSizeHint(@ptrCast(self));
    }
    ...
    pub fn OnMinimumSizeHint(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QSize) void {
        C.QSvgWidget_OnMinimumSizeHint(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, param1: i32 ```
    pub fn HeightForWidth(self: ?*anyopaque, param1: i32) i32 {
        return C.QSvgWidget_HeightForWidth(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseHeightForWidth(self: ?*anyopaque, param1: i32) i32 {
        return C.QSvgWidget_QBaseHeightForWidth(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, i32) callconv(.c) i32 ```
    pub fn OnHeightForWidth(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) i32) void {
        C.QSvgWidget_OnHeightForWidth(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn HasHeightForWidth(self: ?*anyopaque) bool {
        return C.QSvgWidget_HasHeightForWidth(@ptrCast(self));
    }
    ...
    pub fn QBaseHasHeightForWidth(self: ?*anyopaque) bool {
        return C.QSvgWidget_QBaseHasHeightForWidth(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn () callconv(.c) bool ```
    pub fn OnHasHeightForWidth(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QSvgWidget_OnHasHeightForWidth(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn PaintEngine(self: ?*anyopaque) ?*C.QPaintEngine {
        return C.QSvgWidget_PaintEngine(@ptrCast(self));
    }
    ...
    pub fn QBasePaintEngine(self: ?*anyopaque) ?*C.QPaintEngine {
        return C.QSvgWidget_QBasePaintEngine(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn () callconv(.c) ?*C.QPaintEngine ```
    pub fn OnPaintEngine(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QPaintEngine) void {
        C.QSvgWidget_OnPaintEngine(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QEvent ```
    pub fn Event(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QSvgWidget_Event(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QSvgWidget_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QSvgWidget_OnEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QMouseEvent ```
    pub fn MousePressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_MousePressEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMousePressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseMousePressEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QMouseEvent) callconv(.c) void ```
    pub fn OnMousePressEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnMousePressEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_MouseReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseMouseReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseReleaseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnMouseReleaseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseDoubleClickEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_MouseDoubleClickEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseDoubleClickEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseMouseDoubleClickEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseDoubleClickEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnMouseDoubleClickEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_MouseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseMouseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnMouseMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QWheelEvent ```
    pub fn WheelEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_WheelEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseWheelEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseWheelEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QWheelEvent) callconv(.c) void ```
    pub fn OnWheelEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnWheelEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QKeyEvent ```
    pub fn KeyPressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_KeyPressEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseKeyPressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseKeyPressEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QKeyEvent) callconv(.c) void ```
    pub fn OnKeyPressEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnKeyPressEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn KeyReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_KeyReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseKeyReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseKeyReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnKeyReleaseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnKeyReleaseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QFocusEvent ```
    pub fn FocusInEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_FocusInEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseFocusInEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseFocusInEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QFocusEvent) callconv(.c) void ```
    pub fn OnFocusInEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnFocusInEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusOutEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_FocusOutEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseFocusOutEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseFocusOutEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnFocusOutEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnFocusOutEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QEnterEvent ```
    pub fn EnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_EnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QEnterEvent) callconv(.c) void ```
    pub fn OnEnterEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnEnterEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn LeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_LeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QEvent) callconv(.c) void ```
    pub fn OnLeaveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnLeaveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QMoveEvent ```
    pub fn MoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_MoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QMoveEvent) callconv(.c) void ```
    pub fn OnMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QResizeEvent ```
    pub fn ResizeEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_ResizeEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseResizeEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseResizeEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QResizeEvent) callconv(.c) void ```
    pub fn OnResizeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnResizeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QCloseEvent ```
    pub fn CloseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_CloseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCloseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseCloseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QCloseEvent) callconv(.c) void ```
    pub fn OnCloseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnCloseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QContextMenuEvent ```
    pub fn ContextMenuEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_ContextMenuEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseContextMenuEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseContextMenuEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QContextMenuEvent) callconv(.c) void ```
    pub fn OnContextMenuEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnContextMenuEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QTabletEvent ```
    pub fn TabletEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_TabletEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTabletEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseTabletEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QTabletEvent) callconv(.c) void ```
    pub fn OnTabletEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnTabletEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QActionEvent ```
    pub fn ActionEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_ActionEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseActionEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseActionEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QActionEvent) callconv(.c) void ```
    pub fn OnActionEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnActionEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QDragEnterEvent ```
    pub fn DragEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_DragEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseDragEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QDragEnterEvent) callconv(.c) void ```
    pub fn OnDragEnterEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnDragEnterEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QDragMoveEvent ```
    pub fn DragMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_DragMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseDragMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QDragMoveEvent) callconv(.c) void ```
    pub fn OnDragMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnDragMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QDragLeaveEvent ```
    pub fn DragLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_DragLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseDragLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QDragLeaveEvent) callconv(.c) void ```
    pub fn OnDragLeaveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnDragLeaveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QDropEvent ```
    pub fn DropEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_DropEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDropEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseDropEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QDropEvent) callconv(.c) void ```
    pub fn OnDropEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnDropEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QShowEvent ```
    pub fn ShowEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_ShowEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseShowEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseShowEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QShowEvent) callconv(.c) void ```
    pub fn OnShowEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnShowEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QHideEvent ```
    pub fn HideEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_HideEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseHideEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseHideEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QHideEvent) callconv(.c) void ```
    pub fn OnHideEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnHideEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, eventType: []u8, message: ?*anyopaque, result: ?*isize ```
    pub fn NativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return C.QSvgWidget_NativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return C.QSvgWidget_QBaseNativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, []u8, ?*anyopaque, ?*isize) callconv(.c) bool ```
    pub fn OnNativeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, []u8, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QSvgWidget_OnNativeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QEvent ```
    pub fn ChangeEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QSvgWidget_ChangeEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseChangeEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QSvgWidget_QBaseChangeEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn OnChangeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnChangeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, param1: qpaintdevice_enums.PaintDeviceMetric ```
    pub fn Metric(self: ?*anyopaque, param1: i64) i32 {
        return C.QSvgWidget_Metric(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseMetric(self: ?*anyopaque, param1: i64) i32 {
        return C.QSvgWidget_QBaseMetric(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, qpaintdevice_enums.PaintDeviceMetric) callconv(.c) i32 ```
    pub fn OnMetric(self: ?*anyopaque, slot: fn (?*anyopaque, i64) callconv(.c) i32) void {
        C.QSvgWidget_OnMetric(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn InitPainter(self: ?*anyopaque, painter: ?*anyopaque) void {
        C.QSvgWidget_InitPainter(@ptrCast(self), @ptrCast(painter));
    }
    ...
    pub fn QBaseInitPainter(self: ?*anyopaque, painter: ?*anyopaque) void {
        C.QSvgWidget_QBaseInitPainter(@ptrCast(self), @ptrCast(painter));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QPainter) callconv(.c) void ```
    pub fn OnInitPainter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnInitPainter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, offset: ?*C.QPoint ```
    pub fn Redirected(self: ?*anyopaque, offset: ?*anyopaque) ?*C.QPaintDevice {
        return C.QSvgWidget_Redirected(@ptrCast(self), @ptrCast(offset));
    }
    ...
    pub fn QBaseRedirected(self: ?*anyopaque, offset: ?*anyopaque) ?*C.QPaintDevice {
        return C.QSvgWidget_QBaseRedirected(@ptrCast(self), @ptrCast(offset));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QPoint) callconv(.c) ?*C.QPaintDevice ```
    pub fn OnRedirected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) ?*C.QPaintDevice) void {
        C.QSvgWidget_OnRedirected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SharedPainter(self: ?*anyopaque) ?*C.QPainter {
        return C.QSvgWidget_SharedPainter(@ptrCast(self));
    }
    ...
    pub fn QBaseSharedPainter(self: ?*anyopaque) ?*C.QPainter {
        return C.QSvgWidget_QBaseSharedPainter(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn () callconv(.c) ?*C.QPainter ```
    pub fn OnSharedPainter(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QPainter) void {
        C.QSvgWidget_OnSharedPainter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, param1: ?*C.QInputMethodEvent ```
    pub fn InputMethodEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QSvgWidget_InputMethodEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseInputMethodEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QSvgWidget_QBaseInputMethodEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QInputMethodEvent) callconv(.c) void ```
    pub fn OnInputMethodEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnInputMethodEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, param1: qnamespace_enums.InputMethodQuery ```
    pub fn InputMethodQuery(self: ?*anyopaque, param1: i64) ?*C.QVariant {
        return C.QSvgWidget_InputMethodQuery(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseInputMethodQuery(self: ?*anyopaque, param1: i64) ?*C.QVariant {
        return C.QSvgWidget_QBaseInputMethodQuery(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, qnamespace_enums.InputMethodQuery) callconv(.c) ?*C.QVariant ```
    pub fn OnInputMethodQuery(self: ?*anyopaque, slot: fn (?*anyopaque, i64) callconv(.c) ?*C.QVariant) void {
        C.QSvgWidget_OnInputMethodQuery(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, next: bool ```
    pub fn FocusNextPrevChild(self: ?*anyopaque, next: bool) bool {
        return C.QSvgWidget_FocusNextPrevChild(@ptrCast(self), next);
    }
    ...
    pub fn QBaseFocusNextPrevChild(self: ?*anyopaque, next: bool) bool {
        return C.QSvgWidget_QBaseFocusNextPrevChild(@ptrCast(self), next);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, bool) callconv(.c) bool ```
    pub fn OnFocusNextPrevChild(self: ?*anyopaque, slot: fn (?*anyopaque, bool) callconv(.c) bool) void {
        C.QSvgWidget_OnFocusNextPrevChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, watched: ?*C.QObject, event: ?*C.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QSvgWidget_EventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QSvgWidget_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QObject, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QSvgWidget_OnEventFilter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QTimerEvent ```
    pub fn TimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_TimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnTimerEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, event: ?*C.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnChildEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QSvgWidget_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnCustomEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnCustomEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, signal: ?*C.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QSvgWidget_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QSvgWidget_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnConnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QSvgWidget_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QSvgWidget_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QSvgWidget_OnDisconnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn UpdateMicroFocus(self: ?*anyopaque) void {
        C.QSvgWidget_UpdateMicroFocus(@ptrCast(self));
    }
    ...
    pub fn QBaseUpdateMicroFocus(self: ?*anyopaque) void {
        C.QSvgWidget_QBaseUpdateMicroFocus(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn () callconv(.c) void ```
    pub fn OnUpdateMicroFocus(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QSvgWidget_OnUpdateMicroFocus(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Create(self: ?*anyopaque) void {
        C.QSvgWidget_Create(@ptrCast(self));
    }
    ...
    pub fn QBaseCreate(self: ?*anyopaque) void {
        C.QSvgWidget_QBaseCreate(@ptrCast(self));
    }
    ...
    pub fn OnCreate(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QSvgWidget_OnCreate(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Destroy(self: ?*anyopaque) void {
        C.QSvgWidget_Destroy(@ptrCast(self));
    }
    ...
    pub fn QBaseDestroy(self: ?*anyopaque) void {
        C.QSvgWidget_QBaseDestroy(@ptrCast(self));
    }
    ...
    pub fn OnDestroy(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QSvgWidget_OnDestroy(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusNextChild(self: ?*anyopaque) bool {
        return C.QSvgWidget_FocusNextChild(@ptrCast(self));
    }
    ...
    pub fn QBaseFocusNextChild(self: ?*anyopaque) bool {
        return C.QSvgWidget_QBaseFocusNextChild(@ptrCast(self));
    }
    ...
    pub fn OnFocusNextChild(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QSvgWidget_OnFocusNextChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusPreviousChild(self: ?*anyopaque) bool {
        return C.QSvgWidget_FocusPreviousChild(@ptrCast(self));
    }
    ...
    pub fn QBaseFocusPreviousChild(self: ?*anyopaque) bool {
        return C.QSvgWidget_QBaseFocusPreviousChild(@ptrCast(self));
    }
    ...
    pub fn OnFocusPreviousChild(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QSvgWidget_OnFocusPreviousChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Sender(self: ?*anyopaque) ?*C.QObject {
        return C.QSvgWidget_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) ?*C.QObject {
        return C.QSvgWidget_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn () callconv(.c) ?*C.QObject ```
    pub fn OnSender(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QObject) void {
        C.QSvgWidget_OnSender(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QSvgWidget_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QSvgWidget_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn OnSenderSignalIndex(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QSvgWidget_OnSenderSignalIndex(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QSvgWidget_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QSvgWidget_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, []const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, slot: fn (?*anyopaque, []const u8) callconv(.c) i32) void {
        C.QSvgWidget_OnReceivers(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QSvgWidget_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QSvgWidget_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QSvgWidget, slot: fn (?*C.QSvgWidget, ?*C.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QSvgWidget_OnIsSignalConnected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        C.QSvgWidget_Delete(@ptrCast(self));
    }
};
