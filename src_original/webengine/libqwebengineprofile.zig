...
pub const qwebengineprofile = struct {
    ...
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, event: QtC.QTimerEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, event: QtC.QChildEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, event: QtC.QEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, signal: QtC.QMetaMethod) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn () callconv(.c) QtC.QObject ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn () callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, signal: QtC.QMetaMethod) callconv(.c) bool ```
    ...
    ///
    /// ``` self: QtC.QWebEngineProfile, callback: *const fn (self: QtC.QWebEngineProfile, objectName: [*:0]const u8) callconv(.c) void ```
