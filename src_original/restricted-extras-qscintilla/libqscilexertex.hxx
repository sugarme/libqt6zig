...
class VirtualQsciLexerTeX final : public QsciLexerTeX {
  ...
  public:
    ...
    using QsciLexerTeX_TextAsBytes_Callback = const char* (*)(const QsciLexerTeX*, libqt_string);
  ...
  public:
    ...
    ~VirtualQsciLexerTeX() {
        ...
        qscilexertex_defaultcolor2_callback = nullptr;
        qscilexertex_defaulteolfill_callback = nullptr;
        qscilexertex_defaultfont2_callback = nullptr;
        qscilexertex_defaultpaper2_callback = nullptr;
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexertex_autocompletionwordseparators_isbase) {
            ...
            const char** callback_ret = qscilexertex_autocompletionwordseparators_callback();
    ...
    virtual QColor defaultColor(int style) const override {
        ...
        } else if (qscilexertex_defaultcolor2_callback != nullptr) {
            int cbval1 = style;
    ...
    virtual QFont defaultFont(int style) const override {
        ...
        } else if (qscilexertex_defaultfont2_callback != nullptr) {
            int cbval1 = style;
    ...
    virtual QColor defaultPaper(int style) const override {
        ...
        } else if (qscilexertex_defaultpaper2_callback != nullptr) {
            int cbval1 = style;
    ...
    QByteArray textAsBytes(const QString& text) const {
        if (qscilexertex_textasbytes_isbase) {
            ...
            const char* callback_ret = qscilexertex_textasbytes_callback(this, cbval1);
    ...
    QString bytesAsText(const char* bytes, int size) const {
        if (qscilexertex_bytesastext_isbase) {
            ...
            const char* callback_ret = qscilexertex_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret);
            return callback_ret_QString;
        } else {
            return QsciLexerTeX::bytesAsText(bytes, size);
