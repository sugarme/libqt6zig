...
pub const kparts__listingfilterextension = struct {
    ...
    /// ``` self: QtC.KParts__ListingFilterExtension, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KParts__ListingFilterExtension_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KParts__ListingFilterExtension, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KParts__ListingFilterExtension_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KParts__ListingFilterExtension_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KParts__ListingFilterExtension_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kparts::listingfilterextension.Tr: Memory allocation failed");
    ...
    /// ``` self: QtC.KParts__ListingFilterExtension ```
    ///
    /// Returns: ``` flag of listingfilterextension_enums.FilterMode ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn () callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, mode: listingfilterextension_enums.FilterMode ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, mode: listingfilterextension_enums.FilterMode) callconv(.c) bool ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, mode: listingfilterextension_enums.FilterMode) callconv(.c) QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, mode: listingfilterextension_enums.FilterMode, filter: QtC.QVariant ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, mode: listingfilterextension_enums.FilterMode, filter: QtC.QVariant) callconv(.c) void ```
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KParts__ListingFilterExtension_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kparts::listingfilterextension.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KParts__ListingFilterExtension_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kparts::listingfilterextension.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, allocator: std.mem.Allocator ```
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QObject_ObjectName(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kparts::listingfilterextension.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, b: bool ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, id: qnamespace_enums.TimerId ```
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kparts::listingfilterextension.Children: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, name: []const u8, value: QtC.QVariant ```
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("kparts::listingfilterextension.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kparts::listingfilterextension.DynamicPropertyNames: Memory allocation failed");
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, event: QtC.QTimerEvent ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, event: QtC.QTimerEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, event: QtC.QChildEvent ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, event: QtC.QChildEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, event: QtC.QEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, signal: QtC.QMetaMethod ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, signal: QtC.QMetaMethod) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn () callconv(.c) QtC.QObject ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, signal: []const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, signal: QtC.QMetaMethod) callconv(.c) bool ```
    ...
    ///
    /// ``` self: QtC.KParts__ListingFilterExtension, callback: *const fn (self: QtC.KParts__ListingFilterExtension, objectName: [*:0]const u8) callconv(.c) void ```
