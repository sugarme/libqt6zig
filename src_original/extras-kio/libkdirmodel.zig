...
pub const kdirmodel = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KDirModel_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KDirModel_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KDirModel, callback: *const fn () callconv(.c) map_i32_u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KDirModel, callback: *const fn (self: QtC.KDirModel, index: QtC.QModelIndex) callconv(.c) map_i32_qtcqvariant ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KDirModel, callback: *const fn (self: QtC.KDirModel, index: QtC.QModelIndex, roles: map_i32_qtcqvariant) callconv(.c) bool ```
