...
pub const qtreeview = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, search: []const u8) callconv(.c) void ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: []i32) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QTreeView, cursorAction: qabstractitemview_enums.CursorAction, modifiers: i32 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, cursorAction: qabstractitemview_enums.CursorAction, modifiers: i32) callconv(.c) QtC.QModelIndex ```
    ...
    ///
    /// ``` self: QtC.QTreeView, rect: QtC.QRect, command: i32 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, rect: QtC.QRect, command: i32) callconv(.c) void ```
    ...
    pub fn SelectedIndexes(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QModelIndex {
        const _arr: qtc.struct_libqt_list = qtc.QTreeView_SelectedIndexes(@ptrCast(self));
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QTreeView, slot: fn () callconv(.c) []QtC.QModelIndex ```
    ...
    pub fn QBaseSelectedIndexes(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QModelIndex {
        const _arr: qtc.struct_libqt_list = qtc.QTreeView_QBaseSelectedIndexes(@ptrCast(self));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QModelIndex, _arr.len) catch @panic("qtreeview.SelectedIndexes: Memory allocation failed");
        const _data: [*]QtC.QModelIndex = @ptrCast(@alignCast(_arr.data));
        for (0.._arr.len) |_i| {
    ...
    ///
    /// ``` self: QtC.QTreeView, triggers: i32 ```
    ...
    ///
    /// ``` self: QtC.QTreeView, widget: QtC.QWidget, alignment: i32 ```
    ...
    ///
    /// ``` self: QtC.QTreeView, alignment: i32, allocator: std.mem.Allocator ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setParent)
    ///
    /// ``` self: QtC.QTreeView, parent: QtC.QWidget, f: i32 ```
    ...
    ///
    /// ``` self: QtC.QTreeView, typeVal: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: QtC.QTreeView, target: QtC.QPaintDevice, targetOffset: QtC.QPoint, sourceRegion: QtC.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: QtC.QTreeView, painter: QtC.QPainter, targetOffset: QtC.QPoint, sourceRegion: QtC.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabGesture)
    ///
    /// ``` self: QtC.QTreeView, typeVal: qnamespace_enums.GestureType, flags: i32 ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.QTreeView, supportedActions: i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, supportedActions: i32) callconv(.c) void ```
    ...
    pub fn NativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return qtc.QTreeView_NativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return qtc.QTreeView_QBaseNativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, eventType: []u8, message: ?*anyopaque, result: ?*isize) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTreeView, slot: fn () callconv(.c) i64 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QTreeView, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QTreeView, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
