...
pub const qidentityproxymodel = struct {
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QIdentityProxyModel_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QIdentityProxyModel, callback: *const fn (self: QtC.QIdentityProxyModel, index: QtC.QModelIndex) callconv(.c) map_i32_qtcqvariant ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QIdentityProxyModel, callback: *const fn (self: QtC.QIdentityProxyModel, index: QtC.QModelIndex, roles: map_i32_qtcqvariant) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QIdentityProxyModel, callback: *const fn () callconv(.c) map_i32_u8 ```
