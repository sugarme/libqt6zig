...
pub const qshortcut = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QShortcut, slot: fn (self: QtC.QShortcut, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QShortcut, slot: fn (self: QtC.QShortcut, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QShortcut, slot: fn (self: QtC.QShortcut, objectName: [*:0]const u8) callconv(.c) void ```
