...
pub const qscilexersrec = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerSRec, slot: fn (self: QtC.QsciLexerSRec, prop: []const u8, val: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QsciLexerSRec, slot: fn (self: QtC.QsciLexerSRec, objectName: []const u8) callconv(.c) void ```
