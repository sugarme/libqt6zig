...
pub const qscilexersrec = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerSRec, slot: fn (self: QtC.QsciLexerSRec, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerSRec, slot: fn (self: QtC.QsciLexerSRec, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
