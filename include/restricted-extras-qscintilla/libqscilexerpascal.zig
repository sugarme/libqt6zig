...
pub const qscilexerpascal = struct {
    ...
    pub fn AutoCompletionWordSeparators(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        const _arr: qtc.struct_libqt_list = qtc.QsciLexerPascal_AutoCompletionWordSeparators(@ptrCast(self));
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QsciLexerPascal, slot: fn (self: QtC.QsciLexerPascal, qs: QtC.QSettings, prefix: []const u8) callconv(.c) bool ```
    ...
    pub fn BlockEnd1(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerPascal_BlockEnd1(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn BlockStart1(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerPascal_BlockStart1(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn BlockStartKeyword1(self: ?*anyopaque, style: ?*anyopaque) []const u8 {
        const _ret = qtc.QsciLexerPascal_BlockStartKeyword1(@ptrCast(self), @intCast(style));
        return std.mem.span(_ret);
    }
    ...
    pub fn DefaultColorWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerPascal_DefaultColorWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultColorWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerPascal_QBaseDefaultColorWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultColorWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerPascal_OnDefaultColorWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DefaultFontWithStyle(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerPascal_DefaultFontWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultFontWithStyle(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerPascal_QBaseDefaultFontWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultFontWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QFont) void {
        qtc.QsciLexerPascal_OnDefaultFontWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DefaultPaperWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerPascal_DefaultPaperWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn QBaseDefaultPaperWithStyle(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerPascal_QBaseDefaultPaperWithStyle(@ptrCast(self), @intCast(style));
    }
    ...
    pub fn OnDefaultPaperWithStyle(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerPascal_OnDefaultPaperWithStyle(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn TextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        const _bytearray: qtc.struct_libqt_string = qtc.QsciLexerPascal_TextAsBytes(@ptrCast(self), text_str);
    ...
    pub fn QBaseTextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        const _bytearray: qtc.struct_libqt_string = qtc.QsciLexerPascal_QBaseTextAsBytes(@ptrCast(self), text_str);
        defer qtc.libqt_string_free(&_bytearray);
        const _ret = allocator.alloc(u8, _bytearray.len) catch @panic("qscilexerpascal.TextAsBytes: Memory allocation failed");
        @memcpy(_ret, _bytearray.data[0.._bytearray.len]);
        return _ret;
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPascal, slot: fn (self: QtC.QsciLexerPascal, text: []const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPascal, slot: fn (self: QtC.QsciLexerPascal, bytes: []const u8, size: i32) callconv(.c) []const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPascal, slot: fn (self: QtC.QsciLexerPascal, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QsciLexerPascal, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
