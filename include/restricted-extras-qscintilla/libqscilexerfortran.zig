...
pub const qscilexerfortran = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerFortran, slot: fn (self: QtC.QsciLexerFortran, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
