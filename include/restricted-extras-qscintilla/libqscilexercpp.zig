...
pub const qscilexercpp = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCPP, slot: fn (self: QtC.QsciLexerCPP, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCPP, slot: fn (self: QtC.QsciLexerCPP, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
