...
pub const qscilexercustom = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerCustom, slot: fn (self: QtC.QsciLexerCustom, prop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCustom, slot: fn (self: QtC.QsciLexerCustom, qs: QtC.QSettings, prefix: [*:0]const u8) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCustom, slot: fn (self: QtC.QsciLexerCustom, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QsciLexerCustom, slot: fn (self: QtC.QsciLexerCustom, objectName: [*:0]const u8) callconv(.c) void ```
