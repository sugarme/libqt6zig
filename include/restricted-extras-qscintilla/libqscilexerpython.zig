...
pub const qscilexerpython = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
