...
pub const qscilexerpython = struct {
    ...
    pub fn OnSetIndentationWarning(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) void) void {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, qs: QtC.QSettings, prefix: [*:0]const u8) callconv(.c) bool ```
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, prop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn () callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, style: *i32) callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, text: [*:0]const u8) callconv(.c) [*:0]u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, bytes: [*:0]const u8, size: i32) callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QsciLexerPython, slot: fn (self: QtC.QsciLexerPython, objectName: [*:0]const u8) callconv(.c) void ```
