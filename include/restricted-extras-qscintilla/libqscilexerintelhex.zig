...
pub const qscilexerintelhex = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIntelHex, slot: fn (self: QtC.QsciLexerIntelHex, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIntelHex, slot: fn (self: QtC.QsciLexerIntelHex, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
