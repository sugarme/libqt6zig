...
pub const qscilexerruby = struct {
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerRuby, slot: fn (self: QtC.QsciLexerRuby, eolfilled: bool, style: i32) callconv(.c) void ```
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerRuby, slot: fn (self: QtC.QsciLexerRuby, prop: []const u8, val: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QsciLexerRuby, slot: fn (self: QtC.QsciLexerRuby) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QsciLexerRuby, slot: fn (self: QtC.QsciLexerRuby, param1: QtC.QObject) callconv(.c) void ```
    ...
    pub fn OnDefaultColor2(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerRuby_OnDefaultColor2(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn OnDefaultFont2(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QFont) void {
        qtc.QsciLexerRuby_OnDefaultFont2(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn OnDefaultPaper2(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) QtC.QColor) void {
        qtc.QsciLexerRuby_OnDefaultPaper2(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    ///
    /// ``` self: QtC.QsciLexerRuby, slot: fn (self: QtC.QsciLexerRuby, objectName: []const u8) callconv(.c) void ```
