...
pub const qscilexeridl = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerIDL, slot: fn (self: QtC.QsciLexerIDL, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
