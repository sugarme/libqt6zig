...
pub const qsciscintilla = struct {
    ...
    pub fn MarkerDefineWithCh(self: ?*anyopaque, ch: i8) i32 {
        return qtc.QsciScintilla_MarkerDefineWithCh(@ptrCast(self), @intCast(ch));
    }
    ...
    pub fn MarkerDefineWithPm(self: ?*anyopaque, pm: ?*anyopaque) i32 {
        return qtc.QsciScintilla_MarkerDefineWithPm(@ptrCast(self), @ptrCast(pm));
    }
    ...
    pub fn MarkerDefineWithIm(self: ?*anyopaque, im: ?*anyopaque) i32 {
        return qtc.QsciScintilla_MarkerDefineWithIm(@ptrCast(self), @ptrCast(im));
    }
    ...
    pub fn TextWithLine(self: ?*anyopaque, line: i32, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QsciScintilla_TextWithLine(@ptrCast(self), @intCast(line));
        defer qtc.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("qsciscintilla.TextWithLine: Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
        }
        return _ret;
    ...
    pub fn Text2(self: ?*anyopaque, start: i32, end: i32, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QsciScintilla_Text2(@ptrCast(self), @intCast(start), @intCast(end));
        defer qtc.libqt_string_free(@constCast(&_str));
    ...
    pub fn MarkerDefine2(self: ?*anyopaque, sym: i64, markerNumber: i32) i32 {
        return qtc.QsciScintilla_MarkerDefine2(@ptrCast(self), @intCast(sym), @intCast(markerNumber));
    }
    ...
    pub fn MarkerDefine22(self: ?*anyopaque, ch: i8, markerNumber: i32) i32 {
        return qtc.QsciScintilla_MarkerDefine22(@ptrCast(self), @intCast(ch), @intCast(markerNumber));
    }
    ...
    pub fn MarkerDefine23(self: ?*anyopaque, pm: ?*anyopaque, markerNumber: i32) i32 {
        return qtc.QsciScintilla_MarkerDefine23(@ptrCast(self), @ptrCast(pm), @intCast(markerNumber));
    }
    ...
    pub fn MarkerDefine24(self: ?*anyopaque, im: ?*anyopaque, markerNumber: i32) i32 {
        return qtc.QsciScintilla_MarkerDefine24(@ptrCast(self), @ptrCast(im), @intCast(markerNumber));
    }
