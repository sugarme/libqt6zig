...
pub const qscilexerproperties = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerProperties, slot: fn (self: QtC.QsciLexerProperties, text: [*:0]const u8) callconv(.c) []u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerProperties, slot: fn (self: QtC.QsciLexerProperties, bytes: [*:0]const u8, size: i32) callconv(.c) []const u8 ```
