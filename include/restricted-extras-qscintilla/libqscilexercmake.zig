...
pub const qscilexercmake = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, qs: QtC.QSettings, prefix: [*:0]const u8) callconv(.c) bool ```
    ...
    /// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, prop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn () callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, style: *i32) callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, text: [*:0]const u8) callconv(.c) [*:0]u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, bytes: [*:0]const u8, size: i32) callconv(.c) [*:0]const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QsciLexerCMake, slot: fn (self: QtC.QsciLexerCMake, objectName: [*:0]const u8) callconv(.c) void ```
