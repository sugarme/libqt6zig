...
pub const qstatusbar = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qstatusbar.html#messageChanged)
    ///
    /// ``` self: QtC.QStatusBar, slot: fn (self: QtC.QStatusBar, text: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setParent)
    ///
    /// ``` self: QtC.QStatusBar, parent: QtC.QWidget, f: i32 ```
    ...
    ///
    /// ``` self: QtC.QStatusBar, typeVal: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: QtC.QStatusBar, target: QtC.QPaintDevice, targetOffset: QtC.QPoint, sourceRegion: QtC.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: QtC.QStatusBar, painter: QtC.QPainter, targetOffset: QtC.QPoint, sourceRegion: QtC.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabGesture)
    ///
    /// ``` self: QtC.QStatusBar, typeVal: qnamespace_enums.GestureType, flags: i32 ```
    ...
    pub fn NativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return qtc.QStatusBar_NativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return qtc.QStatusBar_QBaseNativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QStatusBar, slot: fn (self: QtC.QStatusBar, eventType: []u8, message: ?*anyopaque, result: ?*isize) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QStatusBar, slot: fn (self: QtC.QStatusBar, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QStatusBar, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
