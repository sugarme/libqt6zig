...
pub const qwebengineclienthints = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineClientHints, slot: fn (self: QtC.QWebEngineClientHints) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineClientHints, slot: fn (self: QtC.QWebEngineClientHints, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QWebEngineClientHints, slot: fn (self: QtC.QWebEngineClientHints, objectName: [*:0]const u8) callconv(.c) void ```
