...
pub const qwebenginenotification = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QWebEngineNotification_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.QWebEngineNotification, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QWebEngineNotification_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.QWebEngineNotification, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QWebEngineNotification_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.QWebEngineNotification_Tr(s_Cstring);
    ...
    pub fn Title(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QWebEngineNotification_Title(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Message(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QWebEngineNotification_Message(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tag(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QWebEngineNotification_Tag(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Language(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QWebEngineNotification_Language(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwebenginenotification.html#closed)
    ///
    /// ``` self: QtC.QWebEngineNotification, slot: fn (self: QtC.QWebEngineNotification) callconv(.c) void ```
    pub fn OnClosed(self: ?*anyopaque, slot: fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineNotification_Connect_Closed(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.QWebEngineNotification_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.QWebEngineNotification_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("qwebenginenotification.Children: Memory allocation failed");
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QWebEngineNotification, slot: fn (self: QtC.QWebEngineNotification, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QWebEngineNotification, slot: fn (self: QtC.QWebEngineNotification, objectName: [*:0]const u8) callconv(.c) void ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.QWebEngineNotification_Delete(@ptrCast(self));
    }
};
