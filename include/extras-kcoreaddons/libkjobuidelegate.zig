...
pub const kjobuidelegate = struct {
    ...
    ///
    ///
    pub fn New() QtC.KJobUiDelegate {
        return qtc.KJobUiDelegate_new();
    }
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KJobUiDelegate_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KJobUiDelegate, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KJobUiDelegate_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KJobUiDelegate, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KJobUiDelegate_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32, i32, ?*anyopaque) callconv(.c) i32) void {
        qtc.KJobUiDelegate_OnMetacall(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KJobUiDelegate_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KJobUiDelegate_Tr(s_Cstring);
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, job: QtC.KJob) callconv(.c) bool ```
    pub fn OnSetJob(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KJobUiDelegate_OnSetJob(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn () callconv(.c) QtC.KJob ```
    pub fn OnJob(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.KJob) void {
        qtc.KJobUiDelegate_OnJob(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn () callconv(.c) void ```
    pub fn OnShowErrorMessage(self: ?*anyopaque, callback: *const fn () callconv(.c) void) void {
        qtc.KJobUiDelegate_OnShowErrorMessage(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    pub fn OnSlotWarning(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, [*:0]const u8) callconv(.c) void) void {
        qtc.KJobUiDelegate_OnSlotWarning(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KJobUiDelegate_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KJobUiDelegate_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, b: bool ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KJobUiDelegate, id: qnamespace_enums.TimerId ```
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kjobuidelegate.Children: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KJobUiDelegate, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, name: []const u8, value: QtC.QVariant ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KJobUiDelegate, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KJobUiDelegate, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KJobUiDelegate, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KJobUiDelegate, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KJobUiDelegate_OnEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KJobUiDelegate_OnEventFilter(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, event: QtC.QTimerEvent ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, event: QtC.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KJobUiDelegate_OnTimerEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, event: QtC.QChildEvent ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, event: QtC.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KJobUiDelegate_OnChildEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, event: QtC.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KJobUiDelegate_OnCustomEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, signal: QtC.QMetaMethod ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, signal: QtC.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KJobUiDelegate_OnConnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KJobUiDelegate_OnDisconnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn () callconv(.c) QtC.QObject ```
    pub fn OnSender(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QObject) void {
        qtc.KJobUiDelegate_OnSender(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, callback: *const fn () callconv(.c) i32) void {
        qtc.KJobUiDelegate_OnSenderSignalIndex(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, signal: []const u8 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, signal: [*:0]const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.KJobUiDelegate_OnReceivers(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, signal: QtC.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KJobUiDelegate_OnIsSignalConnected(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    ///
    /// ``` self: QtC.KJobUiDelegate, callback: *const fn (self: QtC.KJobUiDelegate, objectName: [*:0]const u8) callconv(.c) void ```
