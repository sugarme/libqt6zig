...
pub const qinputdialog = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qdialog.html#accepted)
    ///
    /// ``` self: QtC.QInputDialog, slot: fn (self: QtC.QInputDialog) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconChanged)
    ///
    /// ``` self: QtC.QInputDialog, slot: fn (self: QtC.QInputDialog, icon: QtC.QIcon) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#customContextMenuRequested)
    ///
    /// ``` self: QtC.QInputDialog, slot: fn (self: QtC.QInputDialog, pos: QtC.QPoint) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QInputDialog, slot: fn (self: QtC.QInputDialog, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QInputDialog, slot: fn (self: QtC.QInputDialog, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool ```
