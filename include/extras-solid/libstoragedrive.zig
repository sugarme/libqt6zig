...
pub const solid__storagedrive = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.Solid__StorageDrive_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.Solid__StorageDrive, slot: fn (self: QtC.Solid__StorageDrive) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.Solid__StorageDrive, slot: fn (self: QtC.Solid__StorageDrive, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.Solid__StorageDrive, slot: fn (self: QtC.Solid__StorageDrive, objectName: [*:0]const u8) callconv(.c) void ```
