...
pub const knscore__cache = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KNSCore__Cache_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KNSCore__Cache, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KNSCore__Cache_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KNSCore__Cache, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KNSCore__Cache_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KNSCore__Cache_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("knscore::cache.Tr: Memory allocation failed");
    ...
    pub fn RegistryForProvider(self: ?*anyopaque, providerId: []const u8, allocator: std.mem.Allocator) []QtC.KNSCore__Entry {
        ...
        const _arr: qtc.libqt_list = qtc.KNSCore__Cache_RegistryForProvider(@ptrCast(self), providerId_str);
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.KNSCore__Entry, _arr.len) catch @panic("knscore::cache.RegistryForProvider: Memory allocation failed");
    ...
    pub fn Registry(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.KNSCore__Entry {
        const _arr: qtc.libqt_list = qtc.KNSCore__Cache_Registry(@ptrCast(self));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.KNSCore__Entry, _arr.len) catch @panic("knscore::cache.Registry: Memory allocation failed");
        const _data: [*]QtC.KNSCore__Entry = @ptrCast(@alignCast(_arr.data));
        @memcpy(_ret, _data[0.._arr.len]);
        return _ret;
    }
    ...
    pub fn RequestFromCache(self: ?*anyopaque, param1: ?*anyopaque, allocator: std.mem.Allocator) []QtC.KNSCore__Entry {
        const _arr: qtc.libqt_list = qtc.KNSCore__Cache_RequestFromCache(@ptrCast(self), @ptrCast(param1));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.KNSCore__Entry, _arr.len) catch @panic("knscore::cache.RequestFromCache: Memory allocation failed");
        const _data: [*]QtC.KNSCore__Entry = @ptrCast(@alignCast(_arr.data));
        @memcpy(_ret, _data[0.._arr.len]);
        return _ret;
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KNSCore__Cache_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("knscore::cache.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KNSCore__Cache_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("knscore::cache.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("knscore::cache.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("knscore::cache.Children: Memory allocation failed");
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("knscore::cache.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("knscore::cache.DynamicPropertyNames: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KNSCore__Cache, callback: *const fn (self: QtC.KNSCore__Cache, objectName: [*:0]const u8) callconv(.c) void ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.KNSCore__Cache_Delete(@ptrCast(self));
    }
};
