...
pub const kselectionowner = struct {
    /// New constructs a new KSelectionOwner object.
    ///
    /// ``` selection: []const u8 ```
    pub fn New(selection: []const u8) QtC.KSelectionOwner {
        const selection_Cstring = selection.ptr;

        return qtc.KSelectionOwner_new(selection_Cstring);
    }

    /// New2 constructs a new KSelectionOwner object.
    ///
    /// ``` selection: []const u8, screen: i32 ```
    pub fn New2(selection: []const u8, screen: i32) QtC.KSelectionOwner {
        const selection_Cstring = selection.ptr;
    ...
    pub fn New3(selection: []const u8, screen: i32, parent: ?*anyopaque) QtC.KSelectionOwner {
        const selection_Cstring = selection.ptr;
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KSelectionOwner_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KSelectionOwner, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KSelectionOwner_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KSelectionOwner, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KSelectionOwner_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KSelectionOwner_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KSelectionOwner_Tr(s_Cstring);
    ...
    pub fn FilterEvent(self: ?*anyopaque, ev_P: ?*anyopaque) bool {
        return qtc.KSelectionOwner_FilterEvent(@ptrCast(self), ev_P);
    }
    ...
    ///
    /// ``` self: QtC.KSelectionOwner ```
    pub fn QBaseGetAtoms(self: ?*anyopaque) void {
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KSelectionOwner_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KSelectionOwner_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Claim2(self: ?*anyopaque, force: bool, force_kill: bool) void {
        qtc.KSelectionOwner_Claim2(@ptrCast(self), force, force_kill);
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kselectionowner.Children: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KSelectionOwner, event: QtC.QEvent ```
    pub fn Event(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KSelectionOwner_Event(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KSelectionOwner_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KSelectionOwner, watched: QtC.QObject, event: QtC.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KSelectionOwner_EventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KSelectionOwner_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KSelectionOwner, event: QtC.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KSelectionOwner_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KSelectionOwner_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KSelectionOwner_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KSelectionOwner_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KSelectionOwner, signal: QtC.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KSelectionOwner_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KSelectionOwner_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KSelectionOwner_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KSelectionOwner_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn Sender(self: ?*anyopaque) QtC.QObject {
        return qtc.KSelectionOwner_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.KSelectionOwner_QBaseSender(@ptrCast(self));
    }
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KSelectionOwner_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KSelectionOwner_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KSelectionOwner, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KSelectionOwner_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KSelectionOwner_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KSelectionOwner_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KSelectionOwner_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.KSelectionOwner_Delete(@ptrCast(self));
    }
};
