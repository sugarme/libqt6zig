...
pub const qtextedit = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QTextEdit, slot: fn (self: QtC.QTextEdit, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QTextEdit, slot: fn (self: QtC.QTextEdit, iconText: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QTextEdit, slot: fn (self: QtC.QTextEdit, objectName: []const u8) callconv(.c) void ```
