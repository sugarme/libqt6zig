...
pub const qundoview = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QUndoView, slot: fn (self: QtC.QUndoView, title: []const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QUndoView, slot: fn (self: QtC.QUndoView, iconText: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QUndoView, slot: fn (self: QtC.QUndoView, objectName: []const u8) callconv(.c) void ```
