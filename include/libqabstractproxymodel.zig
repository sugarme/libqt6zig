...
pub const qabstractproxymodel = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QAbstractProxyModel, slot: fn (self: QtC.QAbstractProxyModel, index: QtC.QModelIndex) callconv(.c) i32 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QAbstractProxyModel, slot: fn () callconv(.c) [*][*:0]const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractitemmodel.html#dataChanged)
    ///
    /// ``` self: QtC.QAbstractProxyModel, slot: fn (self: QtC.QAbstractProxyModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAbstractProxyModel, slot: fn (self: QtC.QAbstractProxyModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAbstractProxyModel, slot: fn () callconv(.c) [*:null]QtC.QModelIndex ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAbstractProxyModel, slot: fn (self: QtC.QAbstractProxyModel, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QAbstractProxyModel, slot: fn (self: QtC.QAbstractProxyModel, objectName: [*:0]const u8) callconv(.c) void ```
