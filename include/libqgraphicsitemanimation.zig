...
pub const qgraphicsitemanimation = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QGraphicsItemAnimation, slot: fn (self: QtC.QGraphicsItemAnimation, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QGraphicsItemAnimation, slot: fn (self: QtC.QGraphicsItemAnimation, objectName: []const u8) callconv(.c) void ```
