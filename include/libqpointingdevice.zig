...
pub const qpointingdevice = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPointingDevice, slot: fn (self: QtC.QPointingDevice, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QPointingDevice, slot: fn (self: QtC.QPointingDevice, objectName: [*:0]const u8) callconv(.c) void ```
