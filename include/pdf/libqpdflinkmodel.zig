...
pub const qpdflinkmodel = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QPdfLinkModel, slot: fn (self: QtC.QPdfLinkModel, signal: []const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QPdfLinkModel, slot: fn (self: QtC.QPdfLinkModel, objectName: []const u8) callconv(.c) void ```
