...
pub const qtcpserver = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTcpServer, slot: fn (self: QtC.QTcpServer, signal: []const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QTcpServer, slot: fn (self: QtC.QTcpServer, objectName: []const u8) callconv(.c) void ```
