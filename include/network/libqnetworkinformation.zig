...
pub const qnetworkinformation = struct {
    ...
    pub fn LoadWithFeatures(features: i64) bool {
        return qtc.QNetworkInformation_LoadWithFeatures(@intCast(features));
    }
    ...
    ///
    /// ``` self: QtC.QNetworkInformation, slot: fn (self: QtC.QObject, objectName: []const u8) callconv(.c) void ```
