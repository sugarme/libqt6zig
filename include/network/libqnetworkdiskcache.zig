...
pub const qnetworkdiskcache = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QNetworkDiskCache, slot: fn (self: QtC.QNetworkDiskCache) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QNetworkDiskCache, slot: fn (self: QtC.QNetworkDiskCache, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QNetworkDiskCache, slot: fn (self: QtC.QNetworkDiskCache, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QNetworkDiskCache, slot: fn (self: QtC.QNetworkDiskCache, objectName: [*:0]const u8) callconv(.c) void ```
