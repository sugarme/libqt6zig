...
pub const qfilesystemwatcher = struct {
    ...
    pub fn New2(paths: [][]const u8, allocator: std.mem.Allocator) QtC.QFileSystemWatcher {
        var paths_arr = allocator.alloc(qtc.libqt_string, paths.len) catch @panic("qfilesystemwatcher.: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32, i32, ?*anyopaque) callconv(.c) i32) void {
        qtc.QFileSystemWatcher_OnMetacall(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        var _str = qtc.QFileSystemWatcher_Tr(s_Cstring);
    ...
    pub fn AddPaths(self: ?*anyopaque, files: [][]const u8, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _arr: qtc.libqt_list = qtc.QFileSystemWatcher_AddPaths(@ptrCast(self), files_list);
    ...
    pub fn RemovePaths(self: ?*anyopaque, files: [][]const u8, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _arr: qtc.libqt_list = qtc.QFileSystemWatcher_RemovePaths(@ptrCast(self), files_list);
        const _str: [*]qtc.libqt_string = @ptrCast(@alignCast(_arr.data));
        defer {
            for (0.._arr.len) |i| {
                qtc.libqt_string_free(@ptrCast(&_str[i]));
    ...
    pub fn Files(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        const _arr: qtc.libqt_list = qtc.QFileSystemWatcher_Files(@ptrCast(self));
        const _str: [*]qtc.libqt_string = @ptrCast(@alignCast(_arr.data));
        defer {
            for (0.._arr.len) |i| {
                qtc.libqt_string_free(@ptrCast(&_str[i]));
    ...
    pub fn Directories(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        const _arr: qtc.libqt_list = qtc.QFileSystemWatcher_Directories(@ptrCast(self));
        const _str: [*]qtc.libqt_string = @ptrCast(@alignCast(_arr.data));
        defer {
            for (0.._arr.len) |i| {
                qtc.libqt_string_free(@ptrCast(&_str[i]));
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        var _str = qtc.QFileSystemWatcher_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QFileSystemWatcher_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.QFileSystemWatcher, id: qnamespace_enums.TimerId ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.QFileSystemWatcher, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.QFileSystemWatcher_OnEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.QFileSystemWatcher_OnEventFilter(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, event: QtC.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QFileSystemWatcher_OnTimerEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, event: QtC.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QFileSystemWatcher_OnChildEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, event: QtC.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QFileSystemWatcher_OnCustomEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, signal: QtC.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QFileSystemWatcher_OnConnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QFileSystemWatcher_OnDisconnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn () callconv(.c) QtC.QObject ```
    pub fn OnSender(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QObject) void {
        qtc.QFileSystemWatcher_OnSender(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, callback: *const fn () callconv(.c) i32) void {
        qtc.QFileSystemWatcher_OnSenderSignalIndex(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, signal: [*:0]const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.QFileSystemWatcher_OnReceivers(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, signal: QtC.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.QFileSystemWatcher_OnIsSignalConnected(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, path: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QFileSystemWatcher, callback: *const fn (self: QtC.QFileSystemWatcher, objectName: [*:0]const u8) callconv(.c) void ```
