...
pub const qfilesystemwatcher = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QFileSystemWatcher, slot: fn (self: QtC.QFileSystemWatcher) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QFileSystemWatcher, slot: fn (self: QtC.QFileSystemWatcher, param1: QtC.QObject) callconv(.c) void ```
