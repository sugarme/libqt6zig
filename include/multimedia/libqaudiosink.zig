...
pub const qaudiosink = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAudioSink, slot: fn (self: QtC.QAudioSink, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QAudioSink, slot: fn (self: QtC.QAudioSink, objectName: [*:0]const u8) callconv(.c) void ```
