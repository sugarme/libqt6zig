...
pub const qaudiosource = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QAudioSource, slot: fn (self: QtC.QAudioSource) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QAudioSource, slot: fn (self: QtC.QAudioSource, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QAudioSource, slot: fn (self: QtC.QAudioSource, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QAudioSource, slot: fn (self: QtC.QAudioSource, objectName: [*:0]const u8) callconv(.c) void ```
