...
pub const qsharedmemory = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QSharedMemory, slot: fn (self: QtC.QSharedMemory, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QSharedMemory, slot: fn (self: QtC.QSharedMemory, objectName: []const u8) callconv(.c) void ```
