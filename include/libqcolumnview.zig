...
pub const qcolumnview = struct {
    ...
    pub fn ColumnWidths(self: ?*anyopaque, allocator: std.mem.Allocator) []i32 {
        const _arr: qtc.struct_libqt_list = qtc.QColumnView_ColumnWidths(@ptrCast(self));
    ...
    ///
    /// ``` self: QtC.QColumnView, cursorAction: qabstractitemview_enums.CursorAction, modifiers: i32 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QColumnView, slot: fn (self: QtC.QColumnView, cursorAction: qabstractitemview_enums.CursorAction, modifiers: i32) callconv(.c) QtC.QModelIndex ```
    ...
    ///
    /// ``` self: QtC.QColumnView, rect: QtC.QRect, command: i32 ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QColumnView, slot: fn (self: QtC.QColumnView, rect: QtC.QRect, command: i32) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QColumnView, triggers: i32 ```
    ...
    ///
    /// ``` self: QtC.QColumnView, widget: QtC.QWidget, alignment: i32 ```
    ...
    ///
    /// ``` self: QtC.QColumnView, alignment: i32, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.QColumnView, state: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setParent)
    ///
    /// ``` self: QtC.QColumnView, parent: QtC.QWidget, f: i32 ```
    ...
    ///
    /// ``` self: QtC.QColumnView, typeVal: i32 ```
    ...
    ///
    /// ``` self: QtC.QColumnView, hints: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: QtC.QColumnView, target: QtC.QPaintDevice, targetOffset: QtC.QPoint, sourceRegion: QtC.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: QtC.QColumnView, painter: QtC.QPainter, targetOffset: QtC.QPoint, sourceRegion: QtC.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabGesture)
    ///
    /// ``` self: QtC.QColumnView, typeVal: qnamespace_enums.GestureType, flags: i32 ```
    ...
    pub fn SelectedIndexes(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QModelIndex {
        const _arr: qtc.struct_libqt_list = qtc.QColumnView_SelectedIndexes(@ptrCast(self));
        defer qtc.libqt_free(_arr.data);
    ...
    pub fn QBaseSelectedIndexes(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QModelIndex {
        const _arr: qtc.struct_libqt_list = qtc.QColumnView_QBaseSelectedIndexes(@ptrCast(self));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QModelIndex, _arr.len) catch @panic("qcolumnview.SelectedIndexes: Memory allocation failed");
        const _data: [*]QtC.QModelIndex = @ptrCast(@alignCast(_arr.data));
        @memcpy(_ret, _data[0.._arr.len]);
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.QColumnView, supportedActions: i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QColumnView, slot: fn (self: QtC.QColumnView, supportedActions: i32) callconv(.c) void ```
