...
pub const qlineseries = struct {
    ...
    ///
    ///
    pub fn New() ?*C.QLineSeries {
        return C.QLineSeries_new();
    }

    /// New2 constructs a new QLineSeries object.
    ///
    /// ``` parent: ?*C.QObject ```
    pub fn New2(parent: ?*anyopaque) ?*C.QLineSeries {
        return C.QLineSeries_new2(@ptrCast(parent));
    }
    ...
    pub fn MetaObject(self: ?*anyopaque) ?*C.QMetaObject {
        return C.QLineSeries_MetaObject(@ptrCast(self));
    }

    /// ``` self: ?*C.QLineSeries, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = @constCast(param1.ptr);
        return C.QLineSeries_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: ?*C.QLineSeries, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QLineSeries_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, qobjectdefs_enums.Call, i32, ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, slot: fn (?*anyopaque, i64, i32, ?*anyopaque) callconv(.c) i32) void {
        C.QLineSeries_OnMetacall(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QLineSeries_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QLineSeries_Tr(s_Cstring);
    ...
    pub fn Type(self: ?*anyopaque) i64 {
        return C.QLineSeries_Type(@ptrCast(self));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn () callconv(.c) i64 ```
    pub fn OnType(self: ?*anyopaque, slot: fn () callconv(.c) i64) void {
        C.QLineSeries_OnType(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseType(self: ?*anyopaque) i64 {
        return C.QLineSeries_QBaseType(@ptrCast(self));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QLineSeries_Tr2(s_Cstring, c_Cstring);
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = @constCast(s.ptr);
        const c_Cstring = @constCast(c.ptr);
        const _str = C.QLineSeries_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QLineSeries, x: f64, y: f64 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#append)
    ///
    /// ``` self: ?*C.QLineSeries, point: ?*C.QPointF ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#append)
    ///
    /// ``` self: ?*C.QLineSeries, points: []C.QPointF ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, oldX: f64, oldY: f64, newX: f64, newY: f64 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#replace)
    ///
    /// ``` self: ?*C.QLineSeries, oldPoint: ?*C.QPointF, newPoint: ?*C.QPointF ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#replace)
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, newX: f64, newY: f64 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#replace)
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, newPoint: ?*C.QPointF ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, count: i32 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, point: ?*C.QPointF ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, color: ?*C.QColor ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, format: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, font: ?*C.QFont ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, selected: bool ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, indexes: []i32 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, lightMarker: ?*C.QImage ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, selectedLightMarker: ?*C.QImage ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#clearPointConfiguration)
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, key: qxyseries_enums.PointConfiguration ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#clearPointsConfiguration)
    ///
    /// ``` self: ?*C.QLineSeries, key: qxyseries_enums.PointConfiguration ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, configuration: map_i32_cqvariant, allocator: std.mem.Allocator ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#setPointConfiguration)
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, key: qxyseries_enums.PointConfiguration, value: ?*C.QVariant ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, pointsConfiguration: map_i32_mapi32cqvariant, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, index: i32, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, sourceData: []f64, minSize: f64, maxSize: f64 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, sourceData: []f64 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, point: ?*C.QPointF, state: bool ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, visible: bool ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, clipping: bool ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, configuration: map_i32_mapi32cqvariant, allocator: std.mem.Allocator ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#setPointLabelsClipping)
    ///
    /// ``` self: ?*C.QLineSeries, enabled: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qxyseries.html#colorBy)
    ///
    /// ``` self: ?*C.QLineSeries, sourceData: []f64, gradient: ?*C.QLinearGradient ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, name: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, opacity: f64 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, axis: ?*C.QAbstractAxis ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractseries.html#setUseOpenGL)
    ///
    /// ``` self: ?*C.QLineSeries, enable: bool ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, thread: ?*C.QThread ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, interval: i32 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, parent: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, filterObj: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, obj: ?*C.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QLineSeries, sender: ?*C.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, name: []const u8, value: ?*C.QVariant ```
    ...
    ///
    /// ``` self: ?*C.QLineSeries, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: ?*C.QLineSeries, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QLineSeries, sender: ?*C.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: ?*C.QLineSeries, param1: ?*C.QObject ```
    ...
    pub fn SetPen(self: ?*anyopaque, pen: ?*anyopaque) void {
        C.QLineSeries_SetPen(@ptrCast(self), @ptrCast(pen));
    }
    ...
    pub fn QBaseSetPen(self: ?*anyopaque, pen: ?*anyopaque) void {
        C.QLineSeries_QBaseSetPen(@ptrCast(self), @ptrCast(pen));
    }
    ...
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QPen) callconv(.c) void ```
    pub fn OnSetPen(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLineSeries_OnSetPen(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, brush: ?*C.QBrush ```
    pub fn SetBrush(self: ?*anyopaque, brush: ?*anyopaque) void {
        C.QLineSeries_SetBrush(@ptrCast(self), @ptrCast(brush));
    }
    ...
    pub fn QBaseSetBrush(self: ?*anyopaque, brush: ?*anyopaque) void {
        C.QLineSeries_QBaseSetBrush(@ptrCast(self), @ptrCast(brush));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QBrush) callconv(.c) void ```
    pub fn OnSetBrush(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLineSeries_OnSetBrush(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SetColor(self: ?*anyopaque, color: ?*anyopaque) void {
        C.QLineSeries_SetColor(@ptrCast(self), @ptrCast(color));
    }
    ...
    pub fn QBaseSetColor(self: ?*anyopaque, color: ?*anyopaque) void {
        C.QLineSeries_QBaseSetColor(@ptrCast(self), @ptrCast(color));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QColor) callconv(.c) void ```
    pub fn OnSetColor(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLineSeries_OnSetColor(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Color(self: ?*anyopaque) ?*C.QColor {
        return C.QLineSeries_Color(@ptrCast(self));
    }
    ...
    pub fn QBaseColor(self: ?*anyopaque) ?*C.QColor {
        return C.QLineSeries_QBaseColor(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn () callconv(.c) ?*C.QColor ```
    pub fn OnColor(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QColor) void {
        C.QLineSeries_OnColor(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, event: ?*C.QEvent ```
    pub fn Event(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QLineSeries_Event(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QLineSeries_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QLineSeries_OnEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, watched: ?*C.QObject, event: ?*C.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QLineSeries_EventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QLineSeries_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QObject, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QLineSeries_OnEventFilter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, event: ?*C.QTimerEvent ```
    pub fn TimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLineSeries_TimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLineSeries_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLineSeries_OnTimerEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, event: ?*C.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLineSeries_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLineSeries_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLineSeries_OnChildEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLineSeries_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLineSeries_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLineSeries_OnCustomEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, signal: ?*C.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QLineSeries_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QLineSeries_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLineSeries_OnConnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QLineSeries_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QLineSeries_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLineSeries_OnDisconnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Sender(self: ?*anyopaque) ?*C.QObject {
        return C.QLineSeries_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) ?*C.QObject {
        return C.QLineSeries_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn () callconv(.c) ?*C.QObject ```
    pub fn OnSender(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QObject) void {
        C.QLineSeries_OnSender(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QLineSeries_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QLineSeries_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QLineSeries_OnSenderSignalIndex(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QLineSeries_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QLineSeries_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, []const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, slot: fn (?*anyopaque, []const u8) callconv(.c) i32) void {
        C.QLineSeries_OnReceivers(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QLineSeries_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QLineSeries_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLineSeries, slot: fn (?*C.QLineSeries, ?*C.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QLineSeries_OnIsSignalConnected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        C.QLineSeries_Delete(@ptrCast(self));
    }
};
