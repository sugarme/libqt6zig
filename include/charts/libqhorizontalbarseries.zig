...
pub const qhorizontalbarseries = struct {
    ...
    ///
    ///
    pub fn New() ?*C.QHorizontalBarSeries {
        return C.QHorizontalBarSeries_new();
    }

    /// New2 constructs a new QHorizontalBarSeries object.
    ///
    /// ``` parent: ?*C.QObject ```
    pub fn New2(parent: ?*anyopaque) ?*C.QHorizontalBarSeries {
        return C.QHorizontalBarSeries_new2(@ptrCast(parent));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ``` self: ?*C.QHorizontalBarSeries ```
    pub fn MetaObject(self: ?*anyopaque) ?*C.QMetaObject {
        return C.QHorizontalBarSeries_MetaObject(@ptrCast(self));
    }

    /// ``` self: ?*C.QHorizontalBarSeries, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = @constCast(param1.ptr);
        return C.QHorizontalBarSeries_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: ?*C.QHorizontalBarSeries, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QHorizontalBarSeries_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, qobjectdefs_enums.Call, i32, ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, slot: fn (?*anyopaque, i64, i32, ?*anyopaque) callconv(.c) i32) void {
        C.QHorizontalBarSeries_OnMetacall(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QHorizontalBarSeries_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QHorizontalBarSeries_Tr(s_Cstring);
    ...
    pub fn Type(self: ?*anyopaque) i64 {
        return C.QHorizontalBarSeries_Type(@ptrCast(self));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn () callconv(.c) i64 ```
    pub fn OnType(self: ?*anyopaque, slot: fn () callconv(.c) i64) void {
        C.QHorizontalBarSeries_OnType(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseType(self: ?*anyopaque) i64 {
        return C.QHorizontalBarSeries_QBaseType(@ptrCast(self));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QHorizontalBarSeries_Tr2(s_Cstring, c_Cstring);
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = @constCast(s.ptr);
        const c_Cstring = @constCast(c.ptr);
        const _str = C.QHorizontalBarSeries_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, width: f64 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, set: ?*C.QBarSet ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractbarseries.html#append)
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, sets: []?*C.QBarSet ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, index: i32, set: ?*C.QBarSet ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, format: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, angle: f64 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, position: qabstractbarseries_enums.LabelsPosition ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, precision: i32 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, index: i32, barset: ?*C.QBarSet ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, status: bool, index: i32, barset: ?*C.QBarSet ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractbarseries.html#setLabelsVisible)
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, visible: bool ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, name: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, opacity: f64 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, axis: ?*C.QAbstractAxis ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractseries.html#setUseOpenGL)
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, enable: bool ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, b: bool ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, thread: ?*C.QThread ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, interval: i32 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, id: i32 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, parent: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, filterObj: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, obj: ?*C.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, sender: ?*C.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, name: []const u8, value: ?*C.QVariant ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, sender: ?*C.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, param1: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, event: ?*C.QEvent ```
    pub fn Event(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QHorizontalBarSeries_Event(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QHorizontalBarSeries_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QHorizontalBarSeries_OnEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, watched: ?*C.QObject, event: ?*C.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QHorizontalBarSeries_EventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QHorizontalBarSeries_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, ?*C.QObject, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QHorizontalBarSeries_OnEventFilter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, event: ?*C.QTimerEvent ```
    pub fn TimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QHorizontalBarSeries_TimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QHorizontalBarSeries_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, ?*C.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QHorizontalBarSeries_OnTimerEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, event: ?*C.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QHorizontalBarSeries_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QHorizontalBarSeries_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, ?*C.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QHorizontalBarSeries_OnChildEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QHorizontalBarSeries_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QHorizontalBarSeries_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, ?*C.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QHorizontalBarSeries_OnCustomEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, signal: ?*C.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QHorizontalBarSeries_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QHorizontalBarSeries_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, ?*C.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QHorizontalBarSeries_OnConnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QHorizontalBarSeries_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QHorizontalBarSeries_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QHorizontalBarSeries_OnDisconnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Sender(self: ?*anyopaque) ?*C.QObject {
        return C.QHorizontalBarSeries_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) ?*C.QObject {
        return C.QHorizontalBarSeries_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn () callconv(.c) ?*C.QObject ```
    pub fn OnSender(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QObject) void {
        C.QHorizontalBarSeries_OnSender(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QHorizontalBarSeries_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QHorizontalBarSeries_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QHorizontalBarSeries_OnSenderSignalIndex(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QHorizontalBarSeries_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QHorizontalBarSeries_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, []const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, slot: fn (?*anyopaque, []const u8) callconv(.c) i32) void {
        C.QHorizontalBarSeries_OnReceivers(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QHorizontalBarSeries_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QHorizontalBarSeries_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QHorizontalBarSeries, slot: fn (?*C.QHorizontalBarSeries, ?*C.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QHorizontalBarSeries_OnIsSignalConnected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        C.QHorizontalBarSeries_Delete(@ptrCast(self));
    }
};
