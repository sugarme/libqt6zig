...
pub const qstandarditemmodel = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QStandardItemModel, slot: fn () callconv(.c) [*][*:0]const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractitemmodel.html#dataChanged)
    ///
    /// ``` self: QtC.QStandardItemModel, slot: fn (self: QtC.QStandardItemModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QStandardItemModel, slot: fn () callconv(.c) [*:null]QtC.QModelIndex ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QStandardItemModel, slot: fn (self: QtC.QStandardItemModel, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QStandardItemModel, slot: fn (self: QtC.QStandardItemModel, objectName: [*:0]const u8) callconv(.c) void ```
