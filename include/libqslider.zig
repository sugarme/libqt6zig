...
pub const qslider = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
    ///
    /// ``` self: QtC.QSlider, slot: fn (self: QtC.QSlider, title: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconTextChanged)
    ///
    /// ``` self: QtC.QSlider, slot: fn (self: QtC.QSlider, iconText: [*:0]const u8) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QSlider, slot: fn (self: QtC.QSlider, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QSlider, slot: fn (self: QtC.QSlider, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QSlider, slot: fn (self: QtC.QSlider, objectName: [*:0]const u8) callconv(.c) void ```
