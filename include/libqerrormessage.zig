...
pub const qerrormessage = struct {
    ...
    ///
    /// ``` parent: ?*C.QWidget ```
    pub fn New(parent: ?*anyopaque) ?*C.QErrorMessage {
        return C.QErrorMessage_new(@ptrCast(parent));
    }

    /// New2 constructs a new QErrorMessage object.
    ///
    ///
    pub fn New2() ?*C.QErrorMessage {
        return C.QErrorMessage_new2();
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ``` self: ?*C.QErrorMessage ```
    pub fn MetaObject(self: ?*anyopaque) ?*C.QMetaObject {
        return C.QErrorMessage_MetaObject(@ptrCast(self));
    }

    /// ``` self: ?*C.QErrorMessage, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = @constCast(param1.ptr);
        return C.QErrorMessage_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: ?*C.QErrorMessage, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QErrorMessage_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, qobjectdefs_enums.Call, i32, ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, slot: fn (?*anyopaque, i64, i32, ?*anyopaque) callconv(.c) i32) void {
        C.QErrorMessage_OnMetacall(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QErrorMessage_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QErrorMessage_Tr(s_Cstring);
    ...
    ///
    ///
    pub fn QtHandler() ?*C.QErrorMessage {
        return C.QErrorMessage_QtHandler();
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qerrormessage.html#showMessage)
    ///
    /// ``` self: ?*C.QErrorMessage, message: []const u8 ```
    pub fn ShowMessage(self: ?*anyopaque, message: []const u8) void {
        const message_str = C.struct_libqt_string{
            .len = message.len,
            .data = @constCast(message.ptr),
        };
        C.QErrorMessage_ShowMessage(@ptrCast(self), message_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qerrormessage.html#showMessage)
    ///
    /// ``` self: ?*C.QErrorMessage, message: []const u8, typeVal: []const u8 ```
    pub fn ShowMessage2(self: ?*anyopaque, message: []const u8, typeVal: []const u8) void {
        ...
        C.QErrorMessage_ShowMessage2(@ptrCast(self), message_str, typeVal_str);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qerrormessage.html#done)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: i32 ```
    pub fn Done(self: ?*anyopaque, param1: i32) void {
        C.QErrorMessage_Done(@ptrCast(self), @intCast(param1));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, i32) callconv(.c) void ```
    pub fn OnDone(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) void) void {
        C.QErrorMessage_OnDone(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseDone(self: ?*anyopaque, param1: i32) void {
        C.QErrorMessage_QBaseDone(@ptrCast(self), @intCast(param1));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qerrormessage.html#changeEvent)
    ///
    /// ``` self: ?*C.QErrorMessage, e: ?*C.QEvent ```
    pub fn ChangeEvent(self: ?*anyopaque, e: ?*anyopaque) void {
        C.QErrorMessage_ChangeEvent(@ptrCast(self), @ptrCast(e));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QEvent) callconv(.c) void ```
    pub fn OnChangeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnChangeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseChangeEvent(self: ?*anyopaque, e: ?*anyopaque) void {
        C.QErrorMessage_QBaseChangeEvent(@ptrCast(self), @ptrCast(e));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QErrorMessage_Tr2(s_Cstring, c_Cstring);
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = @constCast(s.ptr);
        const c_Cstring = @constCast(c.ptr);
        const _str = C.QErrorMessage_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, sizeGripEnabled: bool ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, modal: bool ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, result: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, style: ?*C.QStyle ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, windowModality: qnamespace_enums.WindowModality ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, enabled: bool ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, disabled: bool ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, windowModified: bool ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, minimumSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMinimumSize)
    ///
    /// ``` self: ?*C.QErrorMessage, minw: i32, minh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, maximumSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMaximumSize)
    ///
    /// ``` self: ?*C.QErrorMessage, maxw: i32, maxh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, sizeIncrement: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setSizeIncrement)
    ///
    /// ``` self: ?*C.QErrorMessage, w: i32, h: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, baseSize: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setBaseSize)
    ///
    /// ``` self: ?*C.QErrorMessage, basew: i32, baseh: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, fixedSize: ?*C.QSize ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QPointF ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#mapToGlobal)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QPoint ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QWidget, param2: ?*C.QPointF ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#mapTo)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QWidget, param2: ?*C.QPoint ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, palette: ?*C.QPalette ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, backgroundRole: qpalette_enums.ColorRole ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, foregroundRole: qpalette_enums.ColorRole ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, font: ?*C.QFont ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, cursor: ?*C.QCursor ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, enable: bool ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, mask: ?*C.QBitmap ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setMask)
    ///
    /// ``` self: ?*C.QErrorMessage, mask: ?*C.QRegion ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, target: ?*C.QPaintDevice ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QErrorMessage, painter: ?*C.QPainter ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, effect: ?*C.QGraphicsEffect ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, typeVal: qnamespace_enums.GestureType ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, windowTitle: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, styleSheet: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, icon: ?*C.QIcon ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, windowIconText: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, windowRole: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, filePath: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, level: f64 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, toolTip: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, statusTip: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, whatsThis: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, name: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, description: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, direction: qnamespace_enums.LayoutDirection ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, locale: ?*C.QLocale ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setFocus)
    ///
    /// ``` self: ?*C.QErrorMessage, reason: qnamespace_enums.FocusReason ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, policy: qnamespace_enums.FocusPolicy ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, focusProxy: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, policy: qnamespace_enums.ContextMenuPolicy ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabMouse)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QCursor ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, key: ?*C.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QErrorMessage, x: i32, y: i32, w: i32, h: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QRect ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#update)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QRegion ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, hidden: bool ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, x: i32, y: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#resize)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QSize ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setGeometry)
    ///
    /// ``` self: ?*C.QErrorMessage, geometry: ?*C.QRect ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, geometry: []u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, state: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, sizePolicy: ?*C.QSizePolicy ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setSizePolicy)
    ///
    /// ``` self: ?*C.QErrorMessage, horizontal: qsizepolicy_enums.Policy, vertical: qsizepolicy_enums.Policy ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, left: i32, top: i32, right: i32, bottom: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setContentsMargins)
    ///
    /// ``` self: ?*C.QErrorMessage, margins: ?*C.QMargins ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, layout: ?*C.QLayout ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, parent: ?*C.QWidget ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setParent)
    ///
    /// ``` self: ?*C.QErrorMessage, parent: ?*C.QWidget, f: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, dx: i32, dy: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#scroll)
    ///
    /// ``` self: ?*C.QErrorMessage, dx: i32, dy: i32, param3: ?*C.QRect ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, action: ?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, actions: []?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, before: ?*C.QAction, actions: []?*C.QAction ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, before: ?*C.QAction, action: ?*C.QAction ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QErrorMessage, text: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QErrorMessage, icon: ?*C.QIcon, text: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QErrorMessage, text: []const u8, shortcut: ?*C.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#addAction)
    ///
    /// ``` self: ?*C.QErrorMessage, icon: ?*C.QIcon, text: []const u8, shortcut: ?*C.QKeySequence ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, typeVal: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, param1: qnamespace_enums.WindowType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#childAt)
    ///
    /// ``` self: ?*C.QErrorMessage, p: ?*C.QPoint ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, param1: qnamespace_enums.WidgetAttribute ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, child: ?*C.QWidget ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, screen: ?*C.QScreen ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, title: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, iconText: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, pos: ?*C.QPoint ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, hints: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QErrorMessage, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QErrorMessage, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QErrorMessage, target: ?*C.QPaintDevice, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QErrorMessage, painter: ?*C.QPainter, targetOffset: ?*C.QPoint ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QErrorMessage, painter: ?*C.QPainter, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#render)
    ///
    /// ``` self: ?*C.QErrorMessage, painter: ?*C.QPainter, targetOffset: ?*C.QPoint, sourceRegion: ?*C.QRegion, renderFlags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grab)
    ///
    /// ``` self: ?*C.QErrorMessage, rectangle: ?*C.QRect ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabGesture)
    ///
    /// ``` self: ?*C.QErrorMessage, typeVal: qnamespace_enums.GestureType, flags: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#grabShortcut)
    ///
    /// ``` self: ?*C.QErrorMessage, key: ?*C.QKeySequence, context: qnamespace_enums.ShortcutContext ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setShortcutEnabled)
    ///
    /// ``` self: ?*C.QErrorMessage, id: i32, enable: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setWindowFlag)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: qnamespace_enums.WindowType, on: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#setAttribute)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: qnamespace_enums.WidgetAttribute, on: bool ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, thread: ?*C.QThread ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, interval: i32 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, filterObj: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, obj: ?*C.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QErrorMessage, sender: ?*C.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, name: []const u8, value: ?*C.QVariant ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: ?*C.QErrorMessage, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QErrorMessage, sender: ?*C.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, visible: bool ```
    pub fn SetVisible(self: ?*anyopaque, visible: bool) void {
        C.QErrorMessage_SetVisible(@ptrCast(self), visible);
    }
    ...
    pub fn QBaseSetVisible(self: ?*anyopaque, visible: bool) void {
        C.QErrorMessage_QBaseSetVisible(@ptrCast(self), visible);
    }
    ...
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, bool) callconv(.c) void ```
    pub fn OnSetVisible(self: ?*anyopaque, slot: fn (?*anyopaque, bool) callconv(.c) void) void {
        C.QErrorMessage_OnSetVisible(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QErrorMessage_SizeHint(@ptrCast(self));
    }
    ...
    pub fn QBaseSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QErrorMessage_QBaseSizeHint(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn () callconv(.c) ?*C.QSize ```
    pub fn OnSizeHint(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QSize) void {
        C.QErrorMessage_OnSizeHint(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MinimumSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QErrorMessage_MinimumSizeHint(@ptrCast(self));
    }
    ...
    pub fn QBaseMinimumSizeHint(self: ?*anyopaque) ?*C.QSize {
        return C.QErrorMessage_QBaseMinimumSizeHint(@ptrCast(self));
    }
    ...
    pub fn OnMinimumSizeHint(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QSize) void {
        C.QErrorMessage_OnMinimumSizeHint(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Open(self: ?*anyopaque) void {
        C.QErrorMessage_Open(@ptrCast(self));
    }
    ...
    pub fn QBaseOpen(self: ?*anyopaque) void {
        C.QErrorMessage_QBaseOpen(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn () callconv(.c) void ```
    pub fn OnOpen(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QErrorMessage_OnOpen(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Exec(self: ?*anyopaque) i32 {
        return C.QErrorMessage_Exec(@ptrCast(self));
    }
    ...
    pub fn QBaseExec(self: ?*anyopaque) i32 {
        return C.QErrorMessage_QBaseExec(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn () callconv(.c) i32 ```
    pub fn OnExec(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QErrorMessage_OnExec(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Accept(self: ?*anyopaque) void {
        C.QErrorMessage_Accept(@ptrCast(self));
    }
    ...
    pub fn QBaseAccept(self: ?*anyopaque) void {
        C.QErrorMessage_QBaseAccept(@ptrCast(self));
    }
    ...
    pub fn OnAccept(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QErrorMessage_OnAccept(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Reject(self: ?*anyopaque) void {
        C.QErrorMessage_Reject(@ptrCast(self));
    }
    ...
    pub fn QBaseReject(self: ?*anyopaque) void {
        C.QErrorMessage_QBaseReject(@ptrCast(self));
    }
    ...
    pub fn OnReject(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QErrorMessage_OnReject(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QKeyEvent ```
    pub fn KeyPressEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_KeyPressEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseKeyPressEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_QBaseKeyPressEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QKeyEvent) callconv(.c) void ```
    pub fn OnKeyPressEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnKeyPressEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QCloseEvent ```
    pub fn CloseEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_CloseEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseCloseEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_QBaseCloseEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QCloseEvent) callconv(.c) void ```
    pub fn OnCloseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnCloseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QShowEvent ```
    pub fn ShowEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_ShowEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseShowEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_QBaseShowEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QShowEvent) callconv(.c) void ```
    pub fn OnShowEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnShowEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QResizeEvent ```
    pub fn ResizeEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_ResizeEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseResizeEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_QBaseResizeEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QResizeEvent) callconv(.c) void ```
    pub fn OnResizeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnResizeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QContextMenuEvent ```
    pub fn ContextMenuEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_ContextMenuEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseContextMenuEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_QBaseContextMenuEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QContextMenuEvent) callconv(.c) void ```
    pub fn OnContextMenuEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnContextMenuEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QObject, param2: ?*C.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, param1: ?*anyopaque, param2: ?*anyopaque) bool {
        return C.QErrorMessage_EventFilter(@ptrCast(self), @ptrCast(param1), @ptrCast(param2));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, param1: ?*anyopaque, param2: ?*anyopaque) bool {
        return C.QErrorMessage_QBaseEventFilter(@ptrCast(self), @ptrCast(param1), @ptrCast(param2));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QObject, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QErrorMessage_OnEventFilter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DevType(self: ?*anyopaque) i32 {
        return C.QErrorMessage_DevType(@ptrCast(self));
    }
    ...
    pub fn QBaseDevType(self: ?*anyopaque) i32 {
        return C.QErrorMessage_QBaseDevType(@ptrCast(self));
    }
    ...
    pub fn OnDevType(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QErrorMessage_OnDevType(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn HeightForWidth(self: ?*anyopaque, param1: i32) i32 {
        return C.QErrorMessage_HeightForWidth(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseHeightForWidth(self: ?*anyopaque, param1: i32) i32 {
        return C.QErrorMessage_QBaseHeightForWidth(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, i32) callconv(.c) i32 ```
    pub fn OnHeightForWidth(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) i32) void {
        C.QErrorMessage_OnHeightForWidth(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn HasHeightForWidth(self: ?*anyopaque) bool {
        return C.QErrorMessage_HasHeightForWidth(@ptrCast(self));
    }
    ...
    pub fn QBaseHasHeightForWidth(self: ?*anyopaque) bool {
        return C.QErrorMessage_QBaseHasHeightForWidth(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn () callconv(.c) bool ```
    pub fn OnHasHeightForWidth(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QErrorMessage_OnHasHeightForWidth(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn PaintEngine(self: ?*anyopaque) ?*C.QPaintEngine {
        return C.QErrorMessage_PaintEngine(@ptrCast(self));
    }
    ...
    pub fn QBasePaintEngine(self: ?*anyopaque) ?*C.QPaintEngine {
        return C.QErrorMessage_QBasePaintEngine(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn () callconv(.c) ?*C.QPaintEngine ```
    pub fn OnPaintEngine(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QPaintEngine) void {
        C.QErrorMessage_OnPaintEngine(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QEvent ```
    pub fn Event(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QErrorMessage_Event(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QErrorMessage_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QErrorMessage_OnEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QMouseEvent ```
    pub fn MousePressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_MousePressEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMousePressEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseMousePressEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QMouseEvent) callconv(.c) void ```
    pub fn OnMousePressEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnMousePressEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_MouseReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseMouseReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseReleaseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnMouseReleaseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseDoubleClickEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_MouseDoubleClickEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseDoubleClickEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseMouseDoubleClickEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseDoubleClickEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnMouseDoubleClickEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MouseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_MouseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMouseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseMouseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnMouseMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnMouseMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QWheelEvent ```
    pub fn WheelEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_WheelEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseWheelEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseWheelEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QWheelEvent) callconv(.c) void ```
    pub fn OnWheelEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnWheelEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QKeyEvent ```
    pub fn KeyReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_KeyReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseKeyReleaseEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseKeyReleaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnKeyReleaseEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnKeyReleaseEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QFocusEvent ```
    pub fn FocusInEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_FocusInEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseFocusInEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseFocusInEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QFocusEvent) callconv(.c) void ```
    pub fn OnFocusInEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnFocusInEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusOutEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_FocusOutEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseFocusOutEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseFocusOutEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnFocusOutEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnFocusOutEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QEnterEvent ```
    pub fn EnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_EnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QEnterEvent) callconv(.c) void ```
    pub fn OnEnterEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnEnterEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn LeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_LeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnLeaveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnLeaveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QPaintEvent ```
    pub fn PaintEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_PaintEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBasePaintEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBasePaintEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QPaintEvent) callconv(.c) void ```
    pub fn OnPaintEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnPaintEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QMoveEvent ```
    pub fn MoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_MoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QMoveEvent) callconv(.c) void ```
    pub fn OnMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QTabletEvent ```
    pub fn TabletEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_TabletEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTabletEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseTabletEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QTabletEvent) callconv(.c) void ```
    pub fn OnTabletEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnTabletEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QActionEvent ```
    pub fn ActionEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_ActionEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseActionEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseActionEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QActionEvent) callconv(.c) void ```
    pub fn OnActionEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnActionEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QDragEnterEvent ```
    pub fn DragEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_DragEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragEnterEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseDragEnterEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QDragEnterEvent) callconv(.c) void ```
    pub fn OnDragEnterEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnDragEnterEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QDragMoveEvent ```
    pub fn DragMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_DragMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragMoveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseDragMoveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QDragMoveEvent) callconv(.c) void ```
    pub fn OnDragMoveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnDragMoveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QDragLeaveEvent ```
    pub fn DragLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_DragLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDragLeaveEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseDragLeaveEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QDragLeaveEvent) callconv(.c) void ```
    pub fn OnDragLeaveEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnDragLeaveEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QDropEvent ```
    pub fn DropEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_DropEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseDropEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseDropEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QDropEvent) callconv(.c) void ```
    pub fn OnDropEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnDropEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QHideEvent ```
    pub fn HideEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_HideEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseHideEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseHideEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QHideEvent) callconv(.c) void ```
    pub fn OnHideEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnHideEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, eventType: []u8, message: ?*anyopaque, result: ?*isize ```
    pub fn NativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return C.QErrorMessage_NativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: ?*anyopaque) bool {
        ...
        return C.QErrorMessage_QBaseNativeEvent(@ptrCast(self), eventType_str, message, @intCast(result));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, []u8, ?*anyopaque, ?*isize) callconv(.c) bool ```
    pub fn OnNativeEvent(self: ?*anyopaque, slot: fn (?*anyopaque, []u8, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QErrorMessage_OnNativeEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: qpaintdevice_enums.PaintDeviceMetric ```
    pub fn Metric(self: ?*anyopaque, param1: i64) i32 {
        return C.QErrorMessage_Metric(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseMetric(self: ?*anyopaque, param1: i64) i32 {
        return C.QErrorMessage_QBaseMetric(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, qpaintdevice_enums.PaintDeviceMetric) callconv(.c) i32 ```
    pub fn OnMetric(self: ?*anyopaque, slot: fn (?*anyopaque, i64) callconv(.c) i32) void {
        C.QErrorMessage_OnMetric(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn InitPainter(self: ?*anyopaque, painter: ?*anyopaque) void {
        C.QErrorMessage_InitPainter(@ptrCast(self), @ptrCast(painter));
    }
    ...
    pub fn QBaseInitPainter(self: ?*anyopaque, painter: ?*anyopaque) void {
        C.QErrorMessage_QBaseInitPainter(@ptrCast(self), @ptrCast(painter));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QPainter) callconv(.c) void ```
    pub fn OnInitPainter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnInitPainter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, offset: ?*C.QPoint ```
    pub fn Redirected(self: ?*anyopaque, offset: ?*anyopaque) ?*C.QPaintDevice {
        return C.QErrorMessage_Redirected(@ptrCast(self), @ptrCast(offset));
    }
    ...
    pub fn QBaseRedirected(self: ?*anyopaque, offset: ?*anyopaque) ?*C.QPaintDevice {
        return C.QErrorMessage_QBaseRedirected(@ptrCast(self), @ptrCast(offset));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QPoint) callconv(.c) ?*C.QPaintDevice ```
    pub fn OnRedirected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) ?*C.QPaintDevice) void {
        C.QErrorMessage_OnRedirected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SharedPainter(self: ?*anyopaque) ?*C.QPainter {
        return C.QErrorMessage_SharedPainter(@ptrCast(self));
    }
    ...
    pub fn QBaseSharedPainter(self: ?*anyopaque) ?*C.QPainter {
        return C.QErrorMessage_QBaseSharedPainter(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn () callconv(.c) ?*C.QPainter ```
    pub fn OnSharedPainter(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QPainter) void {
        C.QErrorMessage_OnSharedPainter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: ?*C.QInputMethodEvent ```
    pub fn InputMethodEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_InputMethodEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseInputMethodEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_QBaseInputMethodEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QInputMethodEvent) callconv(.c) void ```
    pub fn OnInputMethodEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnInputMethodEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, param1: qnamespace_enums.InputMethodQuery ```
    pub fn InputMethodQuery(self: ?*anyopaque, param1: i64) ?*C.QVariant {
        return C.QErrorMessage_InputMethodQuery(@ptrCast(self), @intCast(param1));
    }
    ...
    pub fn QBaseInputMethodQuery(self: ?*anyopaque, param1: i64) ?*C.QVariant {
        return C.QErrorMessage_QBaseInputMethodQuery(@ptrCast(self), @intCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, qnamespace_enums.InputMethodQuery) callconv(.c) ?*C.QVariant ```
    pub fn OnInputMethodQuery(self: ?*anyopaque, slot: fn (?*anyopaque, i64) callconv(.c) ?*C.QVariant) void {
        C.QErrorMessage_OnInputMethodQuery(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, next: bool ```
    pub fn FocusNextPrevChild(self: ?*anyopaque, next: bool) bool {
        return C.QErrorMessage_FocusNextPrevChild(@ptrCast(self), next);
    }
    ...
    pub fn QBaseFocusNextPrevChild(self: ?*anyopaque, next: bool) bool {
        return C.QErrorMessage_QBaseFocusNextPrevChild(@ptrCast(self), next);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, bool) callconv(.c) bool ```
    pub fn OnFocusNextPrevChild(self: ?*anyopaque, slot: fn (?*anyopaque, bool) callconv(.c) bool) void {
        C.QErrorMessage_OnFocusNextPrevChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QTimerEvent ```
    pub fn TimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_TimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnTimerEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, event: ?*C.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnChildEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QErrorMessage_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn OnCustomEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnCustomEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, signal: ?*C.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QErrorMessage_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QErrorMessage_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnConnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QErrorMessage_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QErrorMessage_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnDisconnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn AdjustPosition(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_AdjustPosition(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseAdjustPosition(self: ?*anyopaque, param1: ?*anyopaque) void {
        C.QErrorMessage_QBaseAdjustPosition(@ptrCast(self), @ptrCast(param1));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QWidget) callconv(.c) void ```
    pub fn OnAdjustPosition(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QErrorMessage_OnAdjustPosition(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn UpdateMicroFocus(self: ?*anyopaque) void {
        C.QErrorMessage_UpdateMicroFocus(@ptrCast(self));
    }
    ...
    pub fn QBaseUpdateMicroFocus(self: ?*anyopaque) void {
        C.QErrorMessage_QBaseUpdateMicroFocus(@ptrCast(self));
    }
    ...
    pub fn OnUpdateMicroFocus(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QErrorMessage_OnUpdateMicroFocus(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Create(self: ?*anyopaque) void {
        C.QErrorMessage_Create(@ptrCast(self));
    }
    ...
    pub fn QBaseCreate(self: ?*anyopaque) void {
        C.QErrorMessage_QBaseCreate(@ptrCast(self));
    }
    ...
    pub fn OnCreate(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QErrorMessage_OnCreate(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Destroy(self: ?*anyopaque) void {
        C.QErrorMessage_Destroy(@ptrCast(self));
    }
    ...
    pub fn QBaseDestroy(self: ?*anyopaque) void {
        C.QErrorMessage_QBaseDestroy(@ptrCast(self));
    }
    ...
    pub fn OnDestroy(self: ?*anyopaque, slot: fn () callconv(.c) void) void {
        C.QErrorMessage_OnDestroy(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusNextChild(self: ?*anyopaque) bool {
        return C.QErrorMessage_FocusNextChild(@ptrCast(self));
    }
    ...
    pub fn QBaseFocusNextChild(self: ?*anyopaque) bool {
        return C.QErrorMessage_QBaseFocusNextChild(@ptrCast(self));
    }
    ...
    pub fn OnFocusNextChild(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QErrorMessage_OnFocusNextChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn FocusPreviousChild(self: ?*anyopaque) bool {
        return C.QErrorMessage_FocusPreviousChild(@ptrCast(self));
    }
    ...
    pub fn QBaseFocusPreviousChild(self: ?*anyopaque) bool {
        return C.QErrorMessage_QBaseFocusPreviousChild(@ptrCast(self));
    }
    ...
    pub fn OnFocusPreviousChild(self: ?*anyopaque, slot: fn () callconv(.c) bool) void {
        C.QErrorMessage_OnFocusPreviousChild(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Sender(self: ?*anyopaque) ?*C.QObject {
        return C.QErrorMessage_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) ?*C.QObject {
        return C.QErrorMessage_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn () callconv(.c) ?*C.QObject ```
    pub fn OnSender(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QObject) void {
        C.QErrorMessage_OnSender(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QErrorMessage_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QErrorMessage_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn OnSenderSignalIndex(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QErrorMessage_OnSenderSignalIndex(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QErrorMessage_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QErrorMessage_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, []const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, slot: fn (?*anyopaque, []const u8) callconv(.c) i32) void {
        C.QErrorMessage_OnReceivers(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QErrorMessage_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QErrorMessage_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QErrorMessage, slot: fn (?*C.QErrorMessage, ?*C.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QErrorMessage_OnIsSignalConnected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        C.QErrorMessage_Delete(@ptrCast(self));
    }
};
