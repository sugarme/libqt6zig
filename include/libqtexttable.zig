...
pub const qtexttable = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextTable, slot: fn (self: QtC.QTextTable, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QTextTable, slot: fn (self: QtC.QTextTable, objectName: [*:0]const u8) callconv(.c) void ```
