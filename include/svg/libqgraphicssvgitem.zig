...
pub const qgraphicssvgitem = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QGraphicsSvgItem, slot: fn (self: QtC.QGraphicsSvgItem, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QGraphicsSvgItem, slot: fn (self: QtC.QGraphicsSvgItem, objectName: []const u8) callconv(.c) void ```
