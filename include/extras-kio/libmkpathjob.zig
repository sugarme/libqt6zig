...
pub const kio__mkpathjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KIO__MkpathJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    /// [Qt documentation](https://api.kde.org/kio-mkpathjob.html#directoryCreated)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, url: QtC.QUrl) callconv(.c) void ```
    pub fn OnDirectoryCreated(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__MkpathJob_Connect_DirectoryCreated(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#connected)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KIO__Job) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, job: QtC.KJob, title: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, title: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#infoMessage)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#totalSize)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, size: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#speed)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__MkpathJob, job: QtC.KJob, title: []const u8, field1: struct_constu8_constu8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__MkpathJob, job: QtC.KJob, title: []const u8, field1: struct_constu8_constu8, field2: struct_constu8_constu8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8, field2: struct_constu8_constu8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, percent: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkpathJob, slot: fn (self: QtC.KIO__MkpathJob, objectName: [*:0]const u8) callconv(.c) void ```
