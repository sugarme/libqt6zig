...
pub const kpropertiesdialogplugin = struct {
    ...
    /// ``` self: QtC.KPropertiesDialogPlugin, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KPropertiesDialogPlugin_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KPropertiesDialogPlugin, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KPropertiesDialogPlugin_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KPropertiesDialogPlugin_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KPropertiesDialogPlugin_Tr(s_Cstring);
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin ```
    pub fn QBaseApplyChanges(self: ?*anyopaque) void {
        qtc.KPropertiesDialogPlugin_QBaseApplyChanges(@ptrCast(self));
    }

    /// [Qt documentation](https://api.kde.org/kpropertiesdialogplugin.html#setDirty)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin ```
    ...
    /// [Qt documentation](https://api.kde.org/kpropertiesdialogplugin.html#isDirty)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin ```
    pub fn QBaseFontHeight(self: ?*anyopaque) i32 {
        return qtc.KPropertiesDialogPlugin_QBaseFontHeight(@ptrCast(self));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KPropertiesDialogPlugin_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KPropertiesDialogPlugin_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// [Qt documentation](https://api.kde.org/kpropertiesdialogplugin.html#setDirty)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, b: bool ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, id: qnamespace_enums.TimerId ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, name: []const u8, value: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, param1: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, event: QtC.QEvent ```
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KPropertiesDialogPlugin_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KPropertiesDialogPlugin_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, event: QtC.QTimerEvent ```
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KPropertiesDialogPlugin_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, event: QtC.QChildEvent ```
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KPropertiesDialogPlugin_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KPropertiesDialogPlugin_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, signal: QtC.QMetaMethod ```
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KPropertiesDialogPlugin_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KPropertiesDialogPlugin_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.KPropertiesDialogPlugin_QBaseSender(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KPropertiesDialogPlugin_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KPropertiesDialogPlugin, signal: []const u8 ```
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KPropertiesDialogPlugin_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KPropertiesDialogPlugin_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
