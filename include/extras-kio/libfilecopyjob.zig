...
pub const kio__filecopyjob = struct {
    ...
    /// [Qt documentation](https://api.kde.org/kio-filecopyjob.html#mimeTypeFound)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KIO__Job, mimeType: [*:0]const u8) callconv(.c) void ```
    pub fn OnMimeTypeFound(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque, [*:0]const u8) callconv(.c) void) void {
        qtc.KIO__FileCopyJob_Connect_MimeTypeFound(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#connected)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KIO__Job) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, title: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#infoMessage)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#totalSize)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, size: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#speed)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#description)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, title: [*:0]const u8, field1: struct_constu8_constu8, field2: struct_constu8_constu8) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, percent: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__FileCopyJob, slot: fn (self: QtC.KIO__FileCopyJob, objectName: [*:0]const u8) callconv(.c) void ```
