...
pub const qdatawidgetmapper = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QDataWidgetMapper, slot: fn (self: QtC.QDataWidgetMapper) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QDataWidgetMapper, slot: fn (self: QtC.QDataWidgetMapper, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QDataWidgetMapper, slot: fn (self: QtC.QDataWidgetMapper, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QDataWidgetMapper, slot: fn (self: QtC.QDataWidgetMapper, objectName: [*:0]const u8) callconv(.c) void ```
