...
pub const qxylegendmarker = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QXYLegendMarker, slot: fn () callconv(.c) i64 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QXYLegendMarker, slot: fn (self: QtC.QXYLegendMarker, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QXYLegendMarker, slot: fn (self: QtC.QXYLegendMarker, objectName: []const u8) callconv(.c) void ```
