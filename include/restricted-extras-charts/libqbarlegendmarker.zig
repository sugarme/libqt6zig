...
pub const qbarlegendmarker = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QBarLegendMarker, slot: fn () callconv(.c) i64 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QBarLegendMarker, slot: fn (self: QtC.QBarLegendMarker, signal: []const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QBarLegendMarker, slot: fn (self: QtC.QBarLegendMarker, objectName: []const u8) callconv(.c) void ```
