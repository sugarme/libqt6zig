...
pub const qboxplotlegendmarker = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QBoxPlotLegendMarker, slot: fn (self: QtC.QBoxPlotLegendMarker, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QBoxPlotLegendMarker, slot: fn (self: QtC.QBoxPlotLegendMarker, objectName: [*:0]const u8) callconv(.c) void ```
