...
pub const qpercentbarseries = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractbarseries.html#labelsFormatChanged)
    ///
    /// ``` self: QtC.QPercentBarSeries, slot: fn (self: QtC.QPercentBarSeries, format: []const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QPercentBarSeries, slot: fn (self: QtC.QPercentBarSeries, objectName: []const u8) callconv(.c) void ```
