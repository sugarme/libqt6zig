...
pub const qvxymodelmapper = struct {
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QVXYModelMapper, slot: fn (self: QtC.QVXYModelMapper, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QVXYModelMapper, slot: fn (self: QtC.QVXYModelMapper, objectName: [*:0]const u8) callconv(.c) void ```
