...
pub const qlogvalueaxis = struct {
    ...
    ///
    ///
    pub fn New() ?*C.QLogValueAxis {
        return C.QLogValueAxis_new();
    }

    /// New2 constructs a new QLogValueAxis object.
    ///
    /// ``` parent: ?*C.QObject ```
    pub fn New2(parent: ?*anyopaque) ?*C.QLogValueAxis {
        return C.QLogValueAxis_new2(@ptrCast(parent));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ``` self: ?*C.QLogValueAxis ```
    pub fn MetaObject(self: ?*anyopaque) ?*C.QMetaObject {
        return C.QLogValueAxis_MetaObject(@ptrCast(self));
    }

    /// ``` self: ?*C.QLogValueAxis, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = @constCast(param1.ptr);
        return C.QLogValueAxis_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: ?*C.QLogValueAxis, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QLogValueAxis_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, qobjectdefs_enums.Call, i32, ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, slot: fn (?*anyopaque, i64, i32, ?*anyopaque) callconv(.c) i32) void {
        C.QLogValueAxis_OnMetacall(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i64, param2: i32, param3: ?*anyopaque) i32 {
        return C.QLogValueAxis_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QLogValueAxis_Tr(s_Cstring);
    ...
    pub fn Type(self: ?*anyopaque) i64 {
        return C.QLogValueAxis_Type(@ptrCast(self));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn () callconv(.c) i64 ```
    pub fn OnType(self: ?*anyopaque, slot: fn () callconv(.c) i64) void {
        C.QLogValueAxis_OnType(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QBaseType(self: ?*anyopaque) i64 {
        return C.QLogValueAxis_QBaseType(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qlogvalueaxis.html#setMin)
    ///
    /// ``` self: ?*C.QLogValueAxis, min: f64 ```
    pub fn SetMin(self: ?*anyopaque, min: f64) void {
        C.QLogValueAxis_SetMin(@ptrCast(self), @floatCast(min));
    }
    ...
    pub fn Min(self: ?*anyopaque) f64 {
        return C.QLogValueAxis_Min(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qlogvalueaxis.html#setMax)
    ///
    /// ``` self: ?*C.QLogValueAxis, max: f64 ```
    pub fn SetMax(self: ?*anyopaque, max: f64) void {
        C.QLogValueAxis_SetMax(@ptrCast(self), @floatCast(max));
    }
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, base: f64 ```
    pub fn SetBase(self: ?*anyopaque, base: f64) void {
        C.QLogValueAxis_SetBase(@ptrCast(self), @floatCast(base));
    }
    ...
    pub fn Base(self: ?*anyopaque) f64 {
        return C.QLogValueAxis_Base(@ptrCast(self));
    }
    ...
    pub fn TickCount(self: ?*anyopaque) i32 {
        return C.QLogValueAxis_TickCount(@ptrCast(self));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qlogvalueaxis.html#setMinorTickCount)
    ///
    /// ``` self: ?*C.QLogValueAxis, minorTickCount: i32 ```
    pub fn SetMinorTickCount(self: ?*anyopaque, minorTickCount: i32) void {
        C.QLogValueAxis_SetMinorTickCount(@ptrCast(self), @intCast(minorTickCount));
    }
    ...
    pub fn MinorTickCount(self: ?*anyopaque) i32 {
        return C.QLogValueAxis_MinorTickCount(@ptrCast(self));
    }
    ...
    pub fn MinChanged(self: ?*anyopaque, min: f64) void {
        C.QLogValueAxis_MinChanged(@ptrCast(self), @floatCast(min));
    }

    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, f64) callconv(.c) void ```
    pub fn OnMinChanged(self: ?*anyopaque, slot: fn (?*anyopaque, f64) callconv(.c) void) void {
        C.QLogValueAxis_Connect_MinChanged(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MaxChanged(self: ?*anyopaque, max: f64) void {
        C.QLogValueAxis_MaxChanged(@ptrCast(self), @floatCast(max));
    }

    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, f64) callconv(.c) void ```
    pub fn OnMaxChanged(self: ?*anyopaque, slot: fn (?*anyopaque, f64) callconv(.c) void) void {
        C.QLogValueAxis_Connect_MaxChanged(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn RangeChanged(self: ?*anyopaque, min: f64, max: f64) void {
        C.QLogValueAxis_RangeChanged(@ptrCast(self), @floatCast(min), @floatCast(max));
    }

    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, f64, f64) callconv(.c) void ```
    pub fn OnRangeChanged(self: ?*anyopaque, slot: fn (?*anyopaque, f64, f64) callconv(.c) void) void {
        C.QLogValueAxis_Connect_RangeChanged(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn LabelFormatChanged(self: ?*anyopaque, format: []const u8) void {
        ...
        C.QLogValueAxis_LabelFormatChanged(@ptrCast(self), format_str);
    }

    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, []const u8) callconv(.c) void ```
    pub fn OnLabelFormatChanged(self: ?*anyopaque, slot: fn (?*anyopaque, []const u8) callconv(.c) void) void {
        C.QLogValueAxis_Connect_LabelFormatChanged(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn BaseChanged(self: ?*anyopaque, base: f64) void {
        C.QLogValueAxis_BaseChanged(@ptrCast(self), @floatCast(base));
    }

    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, f64) callconv(.c) void ```
    pub fn OnBaseChanged(self: ?*anyopaque, slot: fn (?*anyopaque, f64) callconv(.c) void) void {
        C.QLogValueAxis_Connect_BaseChanged(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qlogvalueaxis.html#tickCountChanged)
    ///
    /// ``` self: ?*C.QLogValueAxis, tickCount: i32 ```
    pub fn TickCountChanged(self: ?*anyopaque, tickCount: i32) void {
        C.QLogValueAxis_TickCountChanged(@ptrCast(self), @intCast(tickCount));
    }

    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, i32) callconv(.c) void ```
    pub fn OnTickCountChanged(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) void) void {
        C.QLogValueAxis_Connect_TickCountChanged(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn MinorTickCountChanged(self: ?*anyopaque, minorTickCount: i32) void {
        C.QLogValueAxis_MinorTickCountChanged(@ptrCast(self), @intCast(minorTickCount));
    }

    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, i32) callconv(.c) void ```
    pub fn OnMinorTickCountChanged(self: ?*anyopaque, slot: fn (?*anyopaque, i32) callconv(.c) void) void {
        C.QLogValueAxis_Connect_MinorTickCountChanged(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = C.QLogValueAxis_Tr2(s_Cstring, c_Cstring);
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = @constCast(s.ptr);
        const c_Cstring = @constCast(c.ptr);
        const _str = C.QLogValueAxis_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer C.libqt_string_free(@constCast(&_str));
        const _ret = allocator.alloc(u8, _str.len) catch @panic("Memory allocation failed");
        for (0.._str.len) |_i| {
            _ret[_i] = _str.data[_i];
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, pen: ?*C.QPen ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, color: C.QColor ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, brush: ?*C.QBrush ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, font: ?*C.QFont ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, angle: i32 ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, title: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, visible: bool ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, pen: ?*C.QFont ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, reverse: bool ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, editable: bool ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, labelsTruncated: bool ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, truncateLabels: bool ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, name: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, thread: ?*C.QThread ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, interval: i32 ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, parent: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, filterObj: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, obj: ?*C.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QLogValueAxis, sender: ?*C.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, name: []const u8, value: ?*C.QVariant ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: ?*C.QLogValueAxis, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: ?*C.QLogValueAxis, sender: ?*C.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: ?*C.QLogValueAxis, param1: ?*C.QObject ```
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, event: ?*C.QEvent ```
    pub fn Event(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QLogValueAxis_Event(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QLogValueAxis_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QLogValueAxis_OnEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, watched: ?*C.QObject, event: ?*C.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QLogValueAxis_EventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return C.QLogValueAxis_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, ?*C.QObject, ?*C.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QLogValueAxis_OnEventFilter(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, event: ?*C.QTimerEvent ```
    pub fn TimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLogValueAxis_TimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLogValueAxis_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, ?*C.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLogValueAxis_OnTimerEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, event: ?*C.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLogValueAxis_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLogValueAxis_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, ?*C.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLogValueAxis_OnChildEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLogValueAxis_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        C.QLogValueAxis_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, ?*C.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLogValueAxis_OnCustomEvent(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, signal: ?*C.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QLogValueAxis_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QLogValueAxis_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, ?*C.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLogValueAxis_OnConnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QLogValueAxis_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        C.QLogValueAxis_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        C.QLogValueAxis_OnDisconnectNotify(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn Sender(self: ?*anyopaque) ?*C.QObject {
        return C.QLogValueAxis_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) ?*C.QObject {
        return C.QLogValueAxis_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn () callconv(.c) ?*C.QObject ```
    pub fn OnSender(self: ?*anyopaque, slot: fn () callconv(.c) ?*C.QObject) void {
        C.QLogValueAxis_OnSender(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QLogValueAxis_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return C.QLogValueAxis_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, slot: fn () callconv(.c) i32) void {
        C.QLogValueAxis_OnSenderSignalIndex(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QLogValueAxis_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = @constCast(signal.ptr);
        return C.QLogValueAxis_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, []const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, slot: fn (?*anyopaque, []const u8) callconv(.c) i32) void {
        C.QLogValueAxis_OnReceivers(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QLogValueAxis_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return C.QLogValueAxis_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: ?*C.QLogValueAxis, slot: fn (?*C.QLogValueAxis, ?*C.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, slot: fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        C.QLogValueAxis_OnIsSignalConnected(@ptrCast(self), @as(isize, @bitCast(@intFromPtr(&slot))));
    }
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        C.QLogValueAxis_Delete(@ptrCast(self));
    }
};
