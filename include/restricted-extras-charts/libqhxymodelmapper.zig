...
pub const qhxymodelmapper = struct {
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QHXYModelMapper, slot: fn (self: QtC.QHXYModelMapper, param1: QtC.QObject) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QHXYModelMapper, slot: fn (self: QtC.QHXYModelMapper, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QHXYModelMapper, slot: fn (self: QtC.QHXYModelMapper, objectName: [*:0]const u8) callconv(.c) void ```
