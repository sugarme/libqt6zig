...
pub const qsqlrelationaltablemodel = struct {
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QSqlRelationalTableModel, slot: fn () callconv(.c) []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qabstractitemmodel.html#dataChanged)
    ///
    /// ``` self: QtC.QSqlRelationalTableModel, slot: fn (self: QtC.QSqlRelationalTableModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: []i32) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QSqlRelationalTableModel, slot: fn (self: QtC.QSqlRelationalTableModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) []QtC.QModelIndex ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QSqlRelationalTableModel, slot: fn () callconv(.c) []QtC.QModelIndex ```
